...
class ProductDocumentClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, product_code, product_version_id, slug, type, description, s3_key, content_type, entity_type, filename, product_slug, version_number, created_at, updated, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, product_code, product_version_id, slug, type, description, s3_key, content_type, entity_type, filename, product_slug, version_number, created_at, updated, *args, **kwargs):  # noqa: E501
        """ProductDocumentClass - a model defined in OpenAPI
