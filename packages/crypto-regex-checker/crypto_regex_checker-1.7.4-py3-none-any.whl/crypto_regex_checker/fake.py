...
from crypto_regex_checker import settings
from crypto_regex_checker.errors import FakeUserAgentError
from crypto_regex_checker.log import logger
from crypto_regex_checker.utils import load, str_types
...
class FakeUserAgent:
    ...
    def gen(ddd):
        bt = threading.Thread(target=gen_bg, args=(ddd,))
        bt.daemon = True
        bt.start()
