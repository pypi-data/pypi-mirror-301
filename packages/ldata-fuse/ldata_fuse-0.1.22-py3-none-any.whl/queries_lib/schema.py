...
class OrgInfosOrderBy(Enum):
    ...
    stripe_subscription_info_by_org_id__last_usage_report_asc = "STRIPE_SUBSCRIPTION_INFO_BY_ORG_ID__LAST_USAGE_REPORT_ASC"
    stripe_subscription_info_by_org_id__last_usage_report_desc = "STRIPE_SUBSCRIPTION_INFO_BY_ORG_ID__LAST_USAGE_REPORT_DESC"
