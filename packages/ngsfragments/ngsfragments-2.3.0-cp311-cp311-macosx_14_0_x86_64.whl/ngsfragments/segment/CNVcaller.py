...
from .cnv_utilities import merge_segments, train_hmm, hmm_classify, validate_distributions
...
class CNVcaller(object):
    ...
    def bin_data(self,
        ...
        if isinstance(data, Fragments):
            ...
            if use_hmm_bins:
                ...
                bins = IntervalFrame(intervals=bins)
            #bins = merge_data_bins(intervals = bins)
    ...
    def predict_cnvs(self,
        ...
        for sample in bins.df.columns:
            ...
            cnv_segments = merge_segments(cnv_segments, bins, column = sample)
