...
def brush_select(
    ...
    *,
    ...
    curves_sculpt_tool: typing.Literal[
        "COMB", "DELETE", "SNAKE_HOOK", "ADD", "GROW_SHRINK"
    ]
    | None = "COMB",
    ...
    """Select a paint mode's brush by tool type
        ...
        :type sculpt_tool: typing.Literal['DRAW','DRAW_SHARP','CLAY','CLAY_STRIPS','CLAY_THUMB','LAYER','INFLATE','BLOB','CREASE','SMOOTH','FLATTEN','FILL','SCRAPE','MULTIPLANE_SCRAPE','PINCH','GRAB','ELASTIC_DEFORM','SNAKE_HOOK','THUMB','POSE','NUDGE','ROTATE','TOPOLOGY','BOUNDARY','CLOTH','SIMPLIFY','MASK','DRAW_FACE_SETS','DISPLACEMENT_ERASER','DISPLACEMENT_SMEAR','PAINT','SMEAR'] | None
    ...
    Weight -- Weight Paint for Vertex Groups.
        ...
        :type curves_sculpt_tool: typing.Literal['COMB','DELETE','SNAKE_HOOK','ADD','GROW_SHRINK'] | None
