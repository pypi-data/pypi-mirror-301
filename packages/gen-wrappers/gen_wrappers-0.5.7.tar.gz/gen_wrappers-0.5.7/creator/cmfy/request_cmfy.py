...
class CmfyWorkflow(BaseRequest):
    workflow_json: str = Field(default_factory=str, examples=[json.dumps(default_workflow_json)])


class CmfyWorkflowFcus(BaseRequest):
    workflow_json: str = Field(default_factory=str, examples=[json.dumps(default_workflow_json_2)])
