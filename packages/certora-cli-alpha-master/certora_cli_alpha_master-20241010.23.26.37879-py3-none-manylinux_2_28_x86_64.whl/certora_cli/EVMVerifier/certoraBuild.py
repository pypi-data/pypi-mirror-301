...
class CertoraBuildGenerator:
    ...
    def standard_json(self,
        ...
        if compiler_collector_lang == CompilerLangSol() or compiler_collector_lang == CompilerLangYul():
            ...
            output_selection = ["transientStorageLayout", "storageLayout", "abi", "evm.bytecode", "evm.deployedBytecode", "evm.methodIdentifiers",
                                "evm.assembly"]
    ...
    def get_contract_in_sdc(self,
        ...
        transient_storage_layout = self.annotate_storage(self.collect_transient_storage_layout(contract_data), build_arg_contract_file)
