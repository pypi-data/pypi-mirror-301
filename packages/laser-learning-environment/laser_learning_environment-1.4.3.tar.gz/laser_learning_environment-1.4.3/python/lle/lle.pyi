...
class WorldState:
    ...
    **Inheritance:**
    ...
    def __new__(cls,agents_positions:typing.Sequence[tuple[int, int]], gems_collected:typing.Sequence[bool], agents_alive: typing.Optional[list[bool]]=None): ...
    def __init__(self, agents_positions:typing.Sequence[tuple[int, int]], gems_collected:typing.Sequence[bool], agents_alive: typing.Optional[list[bool]]=None) -> None:
        ...
