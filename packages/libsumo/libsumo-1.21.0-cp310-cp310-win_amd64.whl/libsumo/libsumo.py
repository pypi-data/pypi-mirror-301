...
class chargingstation(object):
    ...
    @staticmethod
    def setChargingPower(stopID, chargingpower):
        return _libsumo.chargingstation_setChargingPower(stopID, chargingpower)
    ...
    @staticmethod
    def setChargeInTransit(stopID, value):
        return _libsumo.chargingstation_setChargeInTransit(stopID, value)
...
def chargingstation_setChargingPower(stopID, chargingpower):
    return _libsumo.chargingstation_setChargingPower(stopID, chargingpower)
...
def chargingstation_setChargeInTransit(stopID, value):
    return _libsumo.chargingstation_setChargeInTransit(stopID, value)
