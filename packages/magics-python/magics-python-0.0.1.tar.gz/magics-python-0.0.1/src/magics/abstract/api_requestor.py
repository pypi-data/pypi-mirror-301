...
import magics
from magics import error, utils
from magics.constants import (
    BASE_URL,
    INITIAL_RETRY_DELAY,
...
from magics.types import MagicsClient, MagicsRequest
...
def _make_session(max_retries: int | None = None) -> requests.Session:
    if magics.requestssession:
        if isinstance(magics.requestssession, requests.Session):
            return magics.requestssession
        return magics.requestssession()
    s = requests.Session()
    s.mount(
        "https://",
...
class APIRequestor:
    def __init__(self, client: MagicsClient):
    ...
    ) -> Tuple[Iterator[MagicsResponse], bool, str]:
        pass
    ...
    def request(
        ...
        remaining_retries: int | None = ...,
        request_timeout: float | Tuple[float, float] | None = ...,
    ) -> Tuple[MagicsResponse | Iterator[MagicsResponse], bool, str]:
        pass
    ...
    def request(
        ...
        MagicsResponse | Iterator[MagicsResponse],
        bool,
        str | None,
    ]:
    ...
    async def arequest(
        ...
        stream: Literal[True],
        request_timeout: float | Tuple[float, float] | None = ...,
    ) -> Tuple[AsyncGenerator[MagicsResponse, None], bool, str]:
        pass
    ...
    async def arequest(
        ...
        stream: bool = ...,
        request_timeout: float | Tuple[float, float] | None = ...,
    ) -> Tuple[MagicsResponse | AsyncGenerator[MagicsResponse, None], bool, str]:
        pass
    ...
    async def arequest(
        ...
        if got_stream:
            ...
            async def wrap_resp() -> AsyncGenerator[MagicsResponse, None]:
    ...
    def handle_error_response(
        ...
        try:
            ...
            if error_resp is None:
                error_resp = str(resp.data)
            assert isinstance(
                error_resp, dict
            ), f"Unexpected error response {error_resp}"
            error_data = MagicsErrorResponse(**(error_resp))
    ...
    def _prepare_request_raw(
        ...
        if options.method.lower() == "get" or options.method.lower() == "delete":
            ...
            raise error.APIConnectionError(
                ...
                "Magics SDK. Please contact us by filling out https://www.magics.ai/contact for "
    ...
    async def arequest_raw(
        ...
        *,
        ...
        try:
            ...
            raise error.APIConnectionError("Error communicating with Magics") from e

    def _interpret_response(
        self, result: requests.Response, stream: bool
    ) -> Tuple[MagicsResponse | Iterator[MagicsResponse], bool]:
    ...
    async def _interpret_async_response(
        ...
        tuple[AsyncGenerator[MagicsResponse, None], bool]
        | tuple[MagicsResponse, bool]
    ):
        """Returns the response(s) and a bool indicating whether it is a stream."""
        if stream and "text/event-stream" in result.headers.get("Content-Type", ""):
            return (
    ...
    def _interpret_response_line(
        ...
        if rcode == 204:
            return MagicsResponse({}, rheaders)
        ...
        resp = MagicsResponse(data, rheaders)
...
class AioHTTPSession(AsyncContextManager[aiohttp.ClientSession]):
    ...
    async def __aenter__(self) -> aiohttp.ClientSession:
        self._session = magics.aiosession.get()
