...
from magics.types.resources import PrivateLLMResource
...
class ChatCompletions:
    ...
    def create(
        ...
        *,
        ...
        private_resource: PrivateLLMResource | None = None,
        **kwargs: Any,
        ...
        Args:
            messages (List[Dict[str, str]]): A list of messages in the format
                `[{"role": magics.types.chat_completions.MessageRole, "content": TEXT}, ...]`
            ...
            safety_model (str, optional): A moderation model to validate tokens. Choice between available moderation
                    models found [here](https://docs.magics.ai/docs/inference-models#moderation-models).
                Defaults to None.
        ...
        response, _, _ = requestor.request(
            options=MagicsRequest(
                ...
                headers={"Private-Resource": private_resource.resource_id} if private_resource else {},
            ),
            stream=stream,
        )
        ...
        if stream:
            # must be an iterator
            assert not isinstance(response, MagicsResponse)
