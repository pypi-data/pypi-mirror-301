...
def stack(input_files, output_file, band_names=None):
    """
    ...
    Example usage:
    output_file = stack(['raster1.tif', 'raster2.tif', 'raster3.tif'], 
                         'stacked_output.tif', 
...
def clip(raster_file, shapefile, output_file, epsg_code=4326):
    """
    ...
    2. **Get Geometries**: It retrieves the geometries from the GeoDataFrame.
    ...
    Example usage:
    clip('input_raster.tif', 'clip_shape.shp', 'clipped_output.tif', epsg_code=2193)
    """
