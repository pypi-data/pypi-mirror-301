...
def ndvi(red_band, nir_band):
    ...
    Parameters:
    red_band (numpy array): The red band values of the raster.
    nir_band (numpy array): The near-infrared (NIR) band values of the raster.
    
    Returns:
    numpy array: The NDVI values.
    """
    ...
    # Handle NaN values by setting them to 0 (optional)
