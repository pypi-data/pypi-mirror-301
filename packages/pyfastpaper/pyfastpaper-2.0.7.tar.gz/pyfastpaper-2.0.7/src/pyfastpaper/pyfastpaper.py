...
def data_lines(data,
    ...
    ax.set_ylabel(y_name, fontsize=fsize, fontweight='bold', rotation=yrotation, labelpad=ylabelpad, fontname=y_font)
    ax.set_xlabel(x_name, fontsize=fsize, fontweight='bold', rotation=xrotation, labelpad=xlabelpad, fontname=x_font)
...
def draw_3D(expressions,
    ...
    ax.set_ylabel(y_name, fontsize=fsize, fontweight='bold', rotation=yrotation, labelpad=ylabelpad, fontname=y_font)
    ax.set_xlabel(x_name, fontsize=fsize, fontweight='bold', rotation=xrotation, labelpad=xlabelpad, fontname=x_font)
    ax.set_zlabel(z_name, fontsize=fsize, fontweight='bold', rotation=zrotation, labelpad=zlabelpad, fontname=z_font)
...
def draw_detail_area(expressions=None,
    ...
    plt.text(1.05, 0.5, legend_texts, fontsize=fsize - 2, ha='left', va='center', transform=plt.gca().transAxes, fontname=legend_text_font)
