...
Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 72-152
...
class SetupDT(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 75-134
    ...
    def __init__(self, nd, handle=None):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 137-146
    ...
    def ntime_step(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 121
...
def setupdt_copy(self):
    ...
    Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 148-152
