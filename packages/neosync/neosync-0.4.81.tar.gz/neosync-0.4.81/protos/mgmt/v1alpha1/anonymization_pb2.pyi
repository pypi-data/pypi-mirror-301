...
class AnonymizeManyRequest(_message.Message):
    __slots__ = ("input_data", "transformer_mappings", "default_transformers", "halt_on_failure")
    ...
    def __init__(self, input_data: _Optional[_Iterable[str]] = ..., transformer_mappings: _Optional[_Iterable[_Union[TransformerMapping, _Mapping]]] = ..., default_transformers: _Optional[_Union[DefaultTransformersConfig, _Mapping]] = ..., halt_on_failure: bool = ...) -> None: ...
...
class AnonymizeSingleRequest(_message.Message):
    __slots__ = ("input_data", "transformer_mappings", "default_transformers")
    INPUT_DATA_FIELD_NUMBER: _ClassVar[int]
    TRANSFORMER_MAPPINGS_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_TRANSFORMERS_FIELD_NUMBER: _ClassVar[int]
    input_data: str
    transformer_mappings: _containers.RepeatedCompositeFieldContainer[TransformerMapping]
    default_transformers: DefaultTransformersConfig
    def __init__(self, input_data: _Optional[str] = ..., transformer_mappings: _Optional[_Iterable[_Union[TransformerMapping, _Mapping]]] = ..., default_transformers: _Optional[_Union[DefaultTransformersConfig, _Mapping]] = ...) -> None: ...
