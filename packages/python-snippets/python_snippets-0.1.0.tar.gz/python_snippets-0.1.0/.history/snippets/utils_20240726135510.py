...
import pandas as pd
from typing import Any, Callable, Dict, Generator, Iterable, Iterator, List, Sequence, Tuple, _GenericAlias, Union
...
def add_callback2gen(gen: Iterator, callback: Callable) -> Iterator:
    for item in gen:
        callback(item)
        yield item