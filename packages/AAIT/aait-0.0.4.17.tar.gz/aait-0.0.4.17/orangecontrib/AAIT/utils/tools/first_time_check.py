...
if "site-packages/Orange/widgets" in os.path.dirname(os.path.abspath(__file__)).replace("\\","/"):
    ...
    from Orange.widgets.orangecontrib.AAIT.utils.tools import concat_splitted_pypi,change_owcorpus
else:
    from orangecontrib.AAIT.utils import MetManagement
    from Oorangecontrib.AAIT.utils.tools import concat_splitted_pypi,change_owcorpus
