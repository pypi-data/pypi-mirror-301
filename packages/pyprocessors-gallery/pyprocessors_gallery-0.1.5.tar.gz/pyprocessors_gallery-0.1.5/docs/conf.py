...
import pyprocessors_gallery


# -- Project information -----------------------------------------------------

project = "pyprocessors_gallery"
copyright = "2022, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_gallery.__version__
release = pyprocessors_gallery.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_gallery.__file__)
