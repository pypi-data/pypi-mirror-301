...
class OrmWorkloadEdges(object):
    ...
    def __init__(self, artifacts=None, billing_histories=None, experiment=None, histories=None, kernel_cluster=None, kernel_cluster_node=None, kernel_image=None, kernel_resource_spec=None, model_service_revision=None, organization=None, pipeline_step_execution=None, run_exec=None, volumes=None, withdraw_history_workloads=None, workspace=None, local_vars_configuration=None):  # noqa: E501
