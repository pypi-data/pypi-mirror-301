...
class ResponsePipelineSpec(object):
    ...
    def __init__(self, created_dt=None, outputs=None, parameter_specs=None, published=None, revision=None, step_dependencies=None, steps=None, local_vars_configuration=None):  # noqa: E501
