...
def sort_numbers(numbers: List[int], algorithm: str, output_format: str, output_path: str = None) -> List[int]:
    algorithms = {
        'merge': merge_sort,
        'quick': quick_sort,
        'bubble': bubble_sort,
...
def main():
    ...
    try:
        numbers = read_numbers(args.input_file)
        sorted_numbers = sort_numbers(numbers, args.algorithm, args.output_format, args.output_file)
        
        if not args.output_file:
            formatted_output = format_output(sorted_numbers, args.output_format)
