...
class ObjectStorageApi(object):
    ...
    def delete_object_storage_key(self, project_id, id, access_key, **kwargs):  # noqa: E501
        """Delete object storage user key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_object_storage_key(project_id, id, access_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_object_storage_key_with_http_info(project_id, id, access_key, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_object_storage_key_with_http_info(project_id, id, access_key, **kwargs)  # noqa: E501
            return data

    def delete_object_storage_key_with_http_info(self, project_id, id, access_key, **kwargs):  # noqa: E501
        """Delete object storage user key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_object_storage_key_with_http_info(project_id, id, access_key, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/object-storage/users/{id}/keys/{accessKey}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def generate_object_storage_key(self, project_id, id, **kwargs):  # noqa: E501
        """Generate access key for storage buckets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_object_storage_key(project_id, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_object_storage_key_with_http_info(project_id, id, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_object_storage_key_with_http_info(project_id, id, **kwargs)  # noqa: E501
            return data

    def generate_object_storage_key_with_http_info(self, project_id, id, **kwargs):  # noqa: E501
        """Generate access key for storage buckets  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_object_storage_key_with_http_info(project_id, id, async_req=True)
        >>> result = thread.get()
