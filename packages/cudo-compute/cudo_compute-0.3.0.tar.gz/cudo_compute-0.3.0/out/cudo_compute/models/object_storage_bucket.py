...
class ObjectStorageBucket(object):
    ...
    def __init__(self, project_id=None, id=None, data_center_id=None, endpoint=None, object_count=None, size_bytes=None, billable_bytes=None, _configuration=None):  # noqa: E501
