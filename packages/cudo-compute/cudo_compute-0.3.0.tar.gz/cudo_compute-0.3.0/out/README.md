...
*ObjectStorageApi* | [**delete_object_storage_key**](docs/ObjectStorageApi.md#delete_object_storage_key) | **DELETE** /v1/projects/{projectId}/object-storage/users/{id}/keys/{accessKey} | Delete object storage user key
...
## Documentation For Models
 ...
 - [MachineTypePrice](docs/MachineTypePrice.md)
 ...
 - [VMMachineType](docs/VMMachineType.md)
