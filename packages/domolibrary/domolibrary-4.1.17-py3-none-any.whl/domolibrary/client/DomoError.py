...
# %% auto 0
__all__ = ['DomoError', 'ClassError', 'AuthNotProvidedError', 'DatasetNotProvidedError']

# %% ../../nbs/client/DomoError.ipynb 2
from typing import Optional

# %% ../../nbs/client/DomoError.ipynb 4
...
class ClassError(DomoError):
    ...
    def __init__(
        ...
        instance_str = f" @ {(res and res.auth.domo_instance) or auth.domo_instance}" if res else ""
