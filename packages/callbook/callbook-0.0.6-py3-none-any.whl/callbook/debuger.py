...
class BreakPointHit:
    ...
    def __repr__(self):
        return f"<common.BreakPointHit startOffset:{self.startOffset}, functionName:{self.functionName}, isStart:{self.isStart}>"
    ...
    def pairWith(self, hit) -> bool:
        return self.startOffset == hit.startOffset and \
