...
class PlayerService(BaseService):
    ...
    @cast_models
    def list_players(self, project_id: int) -> PlayerList:
    ...
    @cast_models
    def create_player(self, request_body: PlayerCreate, project_id: int) -> Player:
        """Create a player for your videos.
    ...
    @cast_models
    def get_player(self, project_id: int, player_id: int) -> Player:
        ...
        Validator(int).min(1).max(9223372036854776000).validate(project_id)
        Validator(int).min(1).max(9223372036854776000).validate(player_id)
    ...
    @cast_models
    def edit_player(
        self, request_body: PlayerEdit, project_id: int, player_id: int
    ) -> Player:
