...
class EvaluationSetClient:
    ...
    def create_evaluation_set(
        self, name: str = None, description: str = None, scheduler: str = None, request_options: typing.Optional[RequestOptions] = None
        ...
        client.evaluation_set.create_evaluation_set(
            ...
            description="Description of Evaluation Set 1",
            scheduler="daily",
        )
        """
