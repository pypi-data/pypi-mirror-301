...
# Fixme: Erst support dicts as dofs einbauen!
# Fixme: try to identify sparsity pattern from connectivity 
# and use the pattern for efficient computation of tangent matrix
...
(x_int, w_int, n_int, connectivity) = seeder.int_pts_in_tri_mesh(x_nodes, elements, order=1)
max_neighbors_1 = connectivity.shape[-1]
...
### Construct sparsity pattern from connectivity
# element connectivity
# dofs
# global connectivity (including dofs for certain domains?!)
# in the end: take derivative of assembled residual over all sets at once

# Flatte alls DOFs
# Identifiziere DOF-Nummern für jedes Element
# Entferne Duplicate und sortiere gleichzeitig (wie JAX-transformable?!)
