...
from spacetower_orbit_extrapolation_python_client.models.celestial_body_relative_position_ephemerides import CelestialBodyRelativePositionEphemerides
...
class EphemerisWithAttitude(BaseModel):
    ...
    celestial_body_relative_position_ephemerides: Optional[CelestialBodyRelativePositionEphemerides] = Field(default=None, alias="celestialBodyRelativePositionEphemerides")
    __properties: ClassVar[List[str]] = ["cartesianEphemeris", "geodeticEphemeris", "meanOrbitEphemeris", "osculatingOrbitEphemeris", "tleEphemeris", "cartesianCovarianceEphemeris", "massEphemeris", "orbitalCovarianceEphemeris", "thrustVectorEphemeris", "batteryPowerEphemeris", "attitudeEphemeris", "celestialBodyRelativePositionEphemerides"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of celestial_body_relative_position_ephemerides
        if self.celestial_body_relative_position_ephemerides:
            _dict['celestialBodyRelativePositionEphemerides'] = self.celestial_body_relative_position_ephemerides.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "celestialBodyRelativePositionEphemerides": CelestialBodyRelativePositionEphemerides.from_dict(obj["celestialBodyRelativePositionEphemerides"]) if obj.get("celestialBodyRelativePositionEphemerides") is not None else None
        })
        return _obj
