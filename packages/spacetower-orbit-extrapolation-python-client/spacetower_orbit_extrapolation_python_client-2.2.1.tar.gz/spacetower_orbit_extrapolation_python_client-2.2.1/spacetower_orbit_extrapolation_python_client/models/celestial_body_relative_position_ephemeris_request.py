...
class CelestialBodyRelativePositionEphemerisRequest(BaseModel):
    """
    Options for exporting the relative position of a target body in the SpaceObject frame. 
    """ # noqa: E501
    ...
    target_celestial_bodies: Annotated[List[TargetCelestialBody], Field(min_length=1)] = Field(description="The list of celestial bodies for which the relative position vector is computed ", alias="targetCelestialBodies")
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "targetCelestialBodies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CelestialBodyRelativePositionEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CelestialBodyRelativePositionEphemerisRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "targetCelestialBodies": obj.get("targetCelestialBodies")
        })
        return _obj
