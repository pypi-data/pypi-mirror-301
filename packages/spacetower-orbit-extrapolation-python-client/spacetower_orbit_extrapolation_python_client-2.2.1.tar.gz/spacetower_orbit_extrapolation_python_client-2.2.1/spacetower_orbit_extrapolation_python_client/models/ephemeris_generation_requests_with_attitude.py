...
from spacetower_orbit_extrapolation_python_client.models.celestial_body_relative_position_ephemeris_request import CelestialBodyRelativePositionEphemerisRequest
...
class EphemerisGenerationRequestsWithAttitude(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of celestial_body_relative_position_ephemeris_request
        if self.celestial_body_relative_position_ephemeris_request:
            _dict['celestialBodyRelativePositionEphemerisRequest'] = self.celestial_body_relative_position_ephemeris_request.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "celestialBodyRelativePositionEphemerisRequest": CelestialBodyRelativePositionEphemerisRequest.from_dict(obj["celestialBodyRelativePositionEphemerisRequest"]) if obj.get("celestialBodyRelativePositionEphemerisRequest") is not None else None
        })
        return _obj
