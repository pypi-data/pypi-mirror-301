...
def scrape_insultes():
    ...
    Returns:
    - list of tuples: A list containing tuples of insult titles and their respective URLs.
    """
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if insultes_section:
                ...
                # Extract insults (link text and URL)
                insultes = [(link.get('title'), link.get('href')) for link in insultes_links if "title" in link.attrs]
                return insultes
            else:
