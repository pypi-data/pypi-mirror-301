...
cheers_manager_email_ru = """
    <tr>
        <td style="padding: 0 0 40px">
            Искренне Ваш,
            <p style="margin: 0px">{name}</p>
            <p style="margin: 0px"><a href="{tg_link}" style="color: #3BD0BC; font-weight: bold">Telegram</a> <a href="{wa_link}" style="color: #3BD0BC; font-weight: bold">WhatsApp</a></p>
        </td>
    </tr>
"""

cheers_manager_email_en = """
    <tr>
        <td style="padding: 0 0 40px">
            Искренне Ваш,
            <p style="margin: 0px">{name}</p>
