...
from leibniz.nn.layer.hyperbolic2 import (
    HyperBasic as HyperBasic2,
    HyperBottleneck as HyperBottleneck2,
)
...
class TestUnet(unittest.TestCase):
    ...
    def test3D(self):
        ...
        net = resunet3(
            ...
            1,
            spatial=(4, 16, 32),
            scales=[[0, -1, -1], [-1, -1, -1], [0, -1, -1], [-1, -1, -1]],
        )
    ...
    def testHyp1D2(self):
        ...
        net(th.rand(1, 1, 16))
        net = resunet3(
            1, 1, spatial=(32,), normalizor="instance", block=HyperBottleneck2
        )
        net(th.rand(1, 1, 16))
