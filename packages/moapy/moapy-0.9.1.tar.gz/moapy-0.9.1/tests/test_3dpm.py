...
def test_3dpm_conc_rebar():
    ...
    geom = Geometry()
    lcb = Lcb
    lcb.uls = Lcoms(lcoms=[Lcom(name="uls1", f=MemberForce(Nz=Force(value=100.0, unit=enUnitForce.N),
                                                           Mx=Moment(value=10.0, unit=enUnitMoment.Nmm),
                                                           My=Moment(value=50.0, unit=enUnitMoment.Nmm))),
                           Lcom(name="uls2", f=MemberForce(Nz=Force(value=100.0, unit=enUnitForce.N),
                                                           Mx=Moment(value=15.0, unit=enUnitMoment.Nmm),
                                                           My=Moment(value=50.0, unit=enUnitMoment.Nmm))),
                           Lcom(name="uls3", f=MemberForce(Nz=Force(value=100.0, unit=enUnitForce.N),
                                                           Mx=Moment(value=0.0, unit=enUnitMoment.Nmm),
                                                           My=Moment(value=0.0, unit=enUnitMoment.Nmm))),
                           Lcom(name="uls4", f=MemberForce(Nz=Force(value=-100.0, unit=enUnitForce.N),
                                                           Mx=Moment(value=0.0, unit=enUnitMoment.Nmm),
                                                           My=Moment(value=0.0, unit=enUnitMoment.Nmm)))])
    opt = PMOptions()
    ...
    assert pytest.approx(res.strength[0].f.Nz.value) == 4951522.118669571
    ...
    assert pytest.approx(res.strength[1].f.Nz.value) == 4951522.118669571
    ...
    assert pytest.approx(res.strength[2].f.Nz.value) == 4951522.118669571
    ...
    assert pytest.approx(res.strength[3].f.Nz.value) == -574000.0435605047
