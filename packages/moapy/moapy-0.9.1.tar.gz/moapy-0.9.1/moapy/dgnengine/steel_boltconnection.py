...
from moapy.steel_pre import SteelConnectMember_EC, SteelPlateMember, ConnectType, SteelBolt, Welding
from moapy.dgnengine.base import generate_report, load_dll

@auto_schema
def report_ec3_bolt_connection(conn: SteelConnectMember_EC, plate: SteelPlateMember, conType: ConnectType, Bolt: SteelBolt, weld: Welding) -> ResultMD:
    dll = load_dll()
