...
@auto_schema
def report_ec3_beam_column(matl: SteelMaterial_EC, sect: SteelSection_EN10365, load: MemberForce, length: SteelLength_EC, eff_len: EffectiveLength, factor: SteelMomentModificationFactor_EC) -> ResultMD:
    dll = load_dll()
...
# res = report_ec3_beam_column(SteelMaterial_EC(), SteelSection_EN10365(),
