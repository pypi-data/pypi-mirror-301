...
from moapy.steel_pre import SteelMaterial_EC, SteelSection_EN10365, SteelConnectMember_EC, SteelPlateMember, ConnectType, SteelBolt, Welding, SteelMember_EC, ShearConnector, SteelLength_EC, SteelMomentModificationFactor_EC
...
def test_report_boltconnection():
    res = steel_boltconnection.report_ec3_bolt_connection(SteelConnectMember_EC(), SteelPlateMember(), ConnectType(), SteelBolt(), Welding())
