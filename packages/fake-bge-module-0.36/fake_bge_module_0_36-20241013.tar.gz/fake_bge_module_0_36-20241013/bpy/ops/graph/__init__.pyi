...
def duplicate(
    ...
    undo: bool | None = None,
    *,
    mode: bpy.typing.TransformModeTypes | None = "TRANSLATION",
):
    ...
    :type undo: bool | None
    :param mode: Mode
    :type mode: bpy.typing.TransformModeTypes | None
    """
...
def paste(
    ...
    *,
    ...
    value_offset: bpy.typing.KeyframePasteOffsetValue | None = "NONE",
    ...
    :type value_offset: bpy.typing.KeyframePasteOffsetValue | None
