...
class HomeAssistantSensor:
    ...
    def __init__(
        ...
        self.value_function: callable = None
        self.value = None
        self.fn_parms: any  = None
        self.isvip: bool = False
        self.sendsolo: bool = False
        self.update_suffix(uidsuffix)

        self.value_function = self.get_value_function()
