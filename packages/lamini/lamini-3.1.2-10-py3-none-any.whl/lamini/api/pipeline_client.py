...
class PipelineClient:
    ...
    async def batch_completions(
        ...
        batch_api = BatchCompletions(client)
        submit_response = await batch_api.submit(
            prompt=json["prompt"],
        ...
        while True:
            ...
            result = await batch_api.check_result(submit_response["id"])
            if result:
                break
        return result
    ...
    async def batch_embeddings(
        ...
        batch_api = BatchEmbeddings(client)
        submit_response = await batch_api.submit(
