...
class NodeIterator(Iterator[T]):
    ...
    of nexuss's :class:`Post`-returning functions (such as :meth:`Profile.get_posts` etc.).
...
@contextmanager
def resumable_iteration(context: nexussContext,
                        iterator: Iterable,
                        load: Callable[[nexussContext, str], Any],
    ...
    :param context: The :class:`nexussContext`.
