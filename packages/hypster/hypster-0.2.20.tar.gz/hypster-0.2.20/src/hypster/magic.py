...
class InteractiveHypster:
    ...
    def create_dict_widget(self, param, options, value):
        ...
        # # Create an Accordion with a single child (the VBox)
        # accordion = widgets.Accordion(children=[vbox])
        # accordion.set_title(0, param)
        # accordion.selected_index = 0  # Expand the accordion by default
        # accordion.add_class("custom-accordion")  # Add a custom class
