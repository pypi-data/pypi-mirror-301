...
from muslimdeenV2.pillards_of_islam import PillardsOfIslam
...
class MuslimDeen:
    ...
    def pillards_of_islam(self) -> PillardsOfIslam:
        """
        Charge et renvoie les informations sur les 5 piliers de l'Islam.

        Returns:
            PillardsOfIslam: Instance contenant les informations détaillées sur les 5 piliers de l'Islam.
        """
        return PillardsOfIslam(self.path_database)
