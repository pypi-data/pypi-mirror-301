...
class Evaluations:
    ...
    def create(self, name: str=None, api_key_name: str=None, model_hub: str="openai", model_url: str=None, model_name: str="gpt-3.5-turbo", model_params={}, harness_params={}, harnesses=[]):
