...
class OutlineEbookGenerator:
    ...
    """
    def __init__(self, json_file_path: str, book_title: str = 'Book Outline', book_author: str = 'Outline Generator', generate_cover: bool = False, force_kindle_compatibility: bool = False, override_image_prompt: str = '', openai_api_key: str = ""):
        """
...
class BookOutlineGenerator:
    ...
    def __init__(self, working_dir: str = 'outline_steps', use_gpt4all: bool = False, openai_api_key: str = ""):
        ...
        Args:
            ...
            use_gpt4all (bool): Whether to use GPT4All instead of OpenAI.
        """
        self.phrases_to_avoid = ['delves',
        'showcasing',
        'underscores',
...
class BookWriter:
    def __init__(self, title: str, use_gpt4all: bool = False, working_dir: str = 'outline_steps',
                 openai_api_key: str=""):
        self.title = title
        self.openai_api_key = openai_api_key
        self.generator = BookOutlineGenerator(use_gpt4all=use_gpt4all, working_dir=working_dir,
...
if __name__ == "__main__":
    title = 'How to get grateful'
    
    book_writer = BookWriter(title, use_gpt4all=False,
                             openai_api_key="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")
    book_writer.generate_outline(num_chapters=3, sections_per_chapter=2, subsections_per_section=2, paras_per_subsection=2)
