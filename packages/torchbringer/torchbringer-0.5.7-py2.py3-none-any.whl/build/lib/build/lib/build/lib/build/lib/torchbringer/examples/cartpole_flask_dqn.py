...
from torchbringer.servers.flask.torchbringer_flask_client import TorchBringerFlaskAgentClient
...
dqn = TorchBringerFlaskAgentClient()
dqn.initialize(config)
run = Run(experiment="Flask DQN Cartpole")
