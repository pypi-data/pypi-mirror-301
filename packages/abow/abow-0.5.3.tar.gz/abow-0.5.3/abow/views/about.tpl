...
<h2>{{_('License')}}</h2>
<p>Copyright (C) 2019-2024 <a href="mailto:benoit.monin@gmx.fr">Benoît Monin</a></p>
% #_ Do not translate A Bottle of Wiki
...
<ul>
<li><a href="https://getbootstrap.com/">Bootstrap</a> {{_('version')}} 5.3.3. {{_('Released under MIT license.')}}</li>
