...
class PSS1830 :
    ...
    def enable_require_akndowledge(self,required) :
        self.requireAkndowledge = required
    ...
    def connect(self , mode='cli' , neip=None , port=22  , user=None , pw=None , rootpw=None, requireAkndowledge=None ,jumpserver = None , resetRequired = False, tmpPassword = None , maxReconnectAttemp=40) :
        if not user :
            user = 'admin'
        if not pw :
            pw = 'YWRtaW4='
        ...
        self.requireAkndowledge=requireAkndowledge
    ...
    def isRequireAknowledge(self , newRelease=None) : 
        if self.requireAkndowledge != None :
            return self.requireAkndowledge
        if not newRelease :
