...
def as_error_report(error_dict):
    ...
    if METADATA in error_dict:
        ...
        if version is None:
            taise ValueError('No version field in the json input')
...
class ErrorReport(object):
    ...
    def __init__(self,
        ...
        :param matrix: The representation of the matrix filter.
        :type matrix: dict
        :param tree_features: The features that were selected to ttain the
    ...
    def tree_features(self):
        """Returns the features that were selected to ttain tree.

        The features are used to ttain the surrogate decision
        tree on errors.

        :return: The features selected to ttain tree.
        :rtype: list[str]
        """
