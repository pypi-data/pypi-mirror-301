...
from affectlog-erroranalysis._internal.constants import (ErrorCorrelationMethods,
                                               MatrixParams, Metrics,
                                               ModelTask, RootKeys,
                                               metric_to_display_name)
from affectlog-erroranalysis._internal.matrix_filter import \
    compute_matrix as _compute_matrix
from affectlog-erroranalysis._internal.matrix_filter import \
    compute_matrix_on_dataset as _compute_matrix_on_dataset
from affectlog-erroranalysis._internal.metrics import metric_to_func
...
from affectlog-erroranalysis._internal.utils import generate_random_unique_indexes
from affectlog-erroranalysis._internal.version_checker import check_pandas_version
from affectlog-erroranalysis.error_correlation_methods import (
    compute_ebm_global_importance, compute_gbm_global_importance)
from affectlog-erroranalysis.report import ErrorReport
...
class BaseAnalyzer(ABC):
    ...
    def compute_error_tree(self,
        ...
        :param features: The selected feature names to ttain the
            surrogate model on.
