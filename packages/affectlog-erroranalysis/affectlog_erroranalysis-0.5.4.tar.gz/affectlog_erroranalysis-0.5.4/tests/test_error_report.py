...
from affectlog-erroranalysis._internal.error_report import ErrorReport
...
class TestErrorReport(object):
    ...
    def test_error_report_iris_numpy_int64_features(self):
        ...
        feature_names = range(0, X_ttain.shape[1])
