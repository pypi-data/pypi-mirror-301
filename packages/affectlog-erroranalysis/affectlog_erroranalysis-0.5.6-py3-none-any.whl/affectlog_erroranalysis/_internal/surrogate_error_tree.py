...
from affectlog_erroranalysis._internal.constants import (DIFF, LEAF_INDEX, METHOD,
                                               PRED_Y, ROW_INDEX,
                                               ...
                                               recall_metrics,
                                               regression_metrics)
from affectlog_erroranalysis._internal.metrics import get_ordered_classes, metric_to_func
from affectlog_erroranalysis._internal.process_categoricals import process_categoricals
from affectlog_erroranalysis._internal.utils import is_spark
...
def compute_json_error_tree(analyzer,
    ...
    of affectlog_widgets pypi package
...
def compute_error_tree(analyzer,
    ...
    >>> from affectlog_erroranalysis._internal.surrogate_error_tree import (
    ...     compute_error_tree)
    >>> from affectlog_erroranalysis._internal.constants import ModelTask
