...
class Progress(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["compute_memory", b"compute_memory", "compute_retention", b"compute_retention", "compute_weights", b"compute_weights", "database_check", b"database_check", "exporting", b"exporting", "full_sync", b"full_sync", "importing", b"importing", "media_check", b"media_check", "media_sync", b"media_sync", "none", b"none", "normal_sync", b"normal_sync", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["compute_memory", b"compute_memory", "compute_retention", b"compute_retention", "compute_weights", b"compute_weights", "database_check", b"database_check", "exporting", b"exporting", "full_sync", b"full_sync", "importing", b"importing", "media_check", b"media_check", "media_sync", b"media_sync", "none", b"none", "normal_sync", b"normal_sync", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["none", "media_sync", "media_check", "full_sync", "normal_sync", "database_check", "importing", "exporting", "compute_weights", "compute_retention", "compute_memory"] | None: ...
