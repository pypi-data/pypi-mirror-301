...
class ComputeFsrsWeightsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["current_weights", b"current_weights", "ignore_revlogs_before_ms", b"ignore_revlogs_before_ms", "search", b"search"]) -> None: ...
...
class ComputeFsrsWeightsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["fsrs_items", b"fsrs_items", "weights", b"weights"]) -> None: ...
...
class SimulateFsrsReviewRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["days_to_simulate", b"days_to_simulate", "deck_size", b"deck_size", "desired_retention", b"desired_retention", "max_interval", b"max_interval", "new_limit", b"new_limit", "review_limit", b"review_limit", "search", b"search", "weights", b"weights"]) -> None: ...
...
class ComputeOptimalRetentionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["days_to_simulate", b"days_to_simulate", "loss_aversion", b"loss_aversion", "max_interval", b"max_interval", "search", b"search", "weights", b"weights"]) -> None: ...
...
class EvaluateWeightsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["ignore_revlogs_before_ms", b"ignore_revlogs_before_ms", "search", b"search", "weights", b"weights"]) -> None: ...
