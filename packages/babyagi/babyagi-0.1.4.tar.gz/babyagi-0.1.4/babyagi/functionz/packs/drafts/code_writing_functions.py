...
Now, analyze the user's request and provide the JSON response, and only the JSON (nothing before or after).
"""
...
Now, provide the breakdown for the user's request. Only the JSON (nothing before or after)
"""
...
Now, analyze the context and provide the JSON response, and only the JSON (nothing before or after).
"""
...
Now, please provide the JSON output for the function '{function['name']}, and only the JSON'.
"""
