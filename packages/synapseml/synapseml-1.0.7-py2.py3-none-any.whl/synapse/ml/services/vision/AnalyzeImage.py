...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_f2144aea11a5_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_f2144aea11a5_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_f2144aea11a5_error")
        self._setDefault(outputCol="AnalyzeImage_f2144aea11a5_output")
