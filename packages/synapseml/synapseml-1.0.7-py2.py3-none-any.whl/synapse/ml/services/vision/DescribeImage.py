...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_154fb1e30d31_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_154fb1e30d31_output",
        ...
        self._setDefault(errorCol="DescribeImage_154fb1e30d31_error")
        self._setDefault(outputCol="DescribeImage_154fb1e30d31_output")
