...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_8ac25bd53590_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_8ac25bd53590_output",
        ...
        self._setDefault(errorCol="TagImage_8ac25bd53590_error")
        self._setDefault(outputCol="TagImage_8ac25bd53590_output")
