...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_9f2444fffeff_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_9f2444fffeff_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_9f2444fffeff_error")
        self._setDefault(outputCol="GenerateThumbnails_9f2444fffeff_output")
