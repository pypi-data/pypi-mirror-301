...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_63da2ed56990_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_63da2ed56990_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_63da2ed56990_error")
        self._setDefault(outputCol="AnalyzeText_63da2ed56990_output")
