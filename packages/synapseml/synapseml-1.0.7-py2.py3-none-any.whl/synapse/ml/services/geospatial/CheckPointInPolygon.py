...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_bb038eef0674_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_bb038eef0674_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_bb038eef0674_error")
        self._setDefault(outputCol="CheckPointInPolygon_bb038eef0674_output")
