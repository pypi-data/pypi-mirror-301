...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_290278f210f7_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_290278f210f7_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_290278f210f7_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_290278f210f7_error")
        self._setDefault(messagesCol="OpenAIPrompt_290278f210f7_messages")
        self._setDefault(outputCol="OpenAIPrompt_290278f210f7_output")
