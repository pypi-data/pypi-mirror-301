...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_8a078f57e58a_error",
        handler=None,
        outputCol="OpenAIEmbedding_8a078f57e58a_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_8a078f57e58a_error")
        self._setDefault(outputCol="OpenAIEmbedding_8a078f57e58a_output")
