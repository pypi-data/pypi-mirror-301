...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_6bbad42c8678_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_6bbad42c8678_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_6bbad42c8678_error")
        self._setDefault(outputCol="OpenAIChatCompletion_6bbad42c8678_output")
