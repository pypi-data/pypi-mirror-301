...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_763e4cd41b3b_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_763e4cd41b3b_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_763e4cd41b3b_error")
        self._setDefault(outputCol="AddDocuments_763e4cd41b3b_output")
