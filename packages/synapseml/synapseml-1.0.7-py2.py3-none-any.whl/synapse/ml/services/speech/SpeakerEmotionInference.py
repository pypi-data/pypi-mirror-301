...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_0b77bd6e1c89_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_0b77bd6e1c89_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_0b77bd6e1c89_error")
        self._setDefault(outputCol="SpeakerEmotionInference_0b77bd6e1c89_output")
