...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeechToText_d29bf6baab4b_error",
        format=None,
        formatCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="SpeechToText_d29bf6baab4b_output",
        profanity=None,
        profanityCol=None,
        ...
        self._setDefault(errorCol="SpeechToText_d29bf6baab4b_error")
        self._setDefault(outputCol="SpeechToText_d29bf6baab4b_output")
