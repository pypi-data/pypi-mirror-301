...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_ff2a5b541731_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_ff2a5b541731_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_ff2a5b541731_error")
        self._setDefault(outputCol="DictionaryExamples_ff2a5b541731_output")
