...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_0a88c04cf214_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_0a88c04cf214_output",
        ...
        self._setDefault(errorCol="Transliterate_0a88c04cf214_error")
        self._setDefault(outputCol="Transliterate_0a88c04cf214_output")
