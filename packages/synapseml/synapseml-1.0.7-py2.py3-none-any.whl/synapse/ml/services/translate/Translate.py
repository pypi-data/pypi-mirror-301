...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_b4569cfc6cdb_error",
        fromLanguage=None,
        ...
        outputCol="Translate_b4569cfc6cdb_output",
        ...
        self._setDefault(errorCol="Translate_b4569cfc6cdb_error")
        self._setDefault(outputCol="Translate_b4569cfc6cdb_output")
