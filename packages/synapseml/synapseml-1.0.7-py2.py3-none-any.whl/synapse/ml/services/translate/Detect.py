...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_daa3d7e5dbe8_error",
        handler=None,
        outputCol="Detect_daa3d7e5dbe8_output",
        ...
        self._setDefault(errorCol="Detect_daa3d7e5dbe8_error")
        self._setDefault(outputCol="Detect_daa3d7e5dbe8_output")
