...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_c478d81a9e7c_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_c478d81a9e7c_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_c478d81a9e7c_error")
        self._setDefault(outputCol="NER_c478d81a9e7c_output")
