...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_6ead0034b55f_error",
        ...
        outputCol="TextAnalyze_6ead0034b55f_output",
        ...
        self._setDefault(errorCol="TextAnalyze_6ead0034b55f_error")
        ...
        self._setDefault(outputCol="TextAnalyze_6ead0034b55f_output")
