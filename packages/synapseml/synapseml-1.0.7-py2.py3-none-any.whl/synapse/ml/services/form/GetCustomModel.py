...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_fd05d3aebe94_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_fd05d3aebe94_output",
        ...
        self._setDefault(errorCol="GetCustomModel_fd05d3aebe94_error")
        self._setDefault(outputCol="GetCustomModel_fd05d3aebe94_output")
