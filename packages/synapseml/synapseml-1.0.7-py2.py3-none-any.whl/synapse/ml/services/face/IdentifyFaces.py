...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_6cd610295494_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_6cd610295494_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_6cd610295494_error")
        self._setDefault(outputCol="IdentifyFaces_6cd610295494_output")
