...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_cda299a8470c_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_cda299a8470c_output",
        ...
        self._setDefault(errorCol="DetectFace_cda299a8470c_error")
        self._setDefault(outputCol="DetectFace_cda299a8470c_output")
