...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_e18044993cc4_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_e18044993cc4_output",
        ...
        self._setDefault(errorCol="GroupFaces_e18044993cc4_error")
        self._setDefault(outputCol="GroupFaces_e18044993cc4_output")
