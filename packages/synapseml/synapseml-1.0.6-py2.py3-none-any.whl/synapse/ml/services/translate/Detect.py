...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_3b58a0b0d58f_error",
        handler=None,
        outputCol="Detect_3b58a0b0d58f_output",
        ...
        self._setDefault(errorCol="Detect_3b58a0b0d58f_error")
        self._setDefault(outputCol="Detect_3b58a0b0d58f_output")
