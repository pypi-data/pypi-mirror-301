...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_6cfcc6f0bf2c_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_6cfcc6f0bf2c_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_6cfcc6f0bf2c_error")
        self._setDefault(outputCol="DictionaryExamples_6cfcc6f0bf2c_output")
