...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_08ca36ac9e55_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_08ca36ac9e55_output",
        ...
        self._setDefault(errorCol="Transliterate_08ca36ac9e55_error")
        self._setDefault(outputCol="Transliterate_08ca36ac9e55_output")
