...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_44aec1ce5fa2_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_44aec1ce5fa2_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_44aec1ce5fa2_error")
        self._setDefault(outputCol="AnalyzeText_44aec1ce5fa2_output")
