...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_246fcb2c2305_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_246fcb2c2305_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_246fcb2c2305_error")
        self._setDefault(outputCol="PII_246fcb2c2305_output")
