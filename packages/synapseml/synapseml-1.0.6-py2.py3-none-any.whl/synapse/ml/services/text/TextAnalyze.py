...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_b458b6d508b9_error",
        ...
        outputCol="TextAnalyze_b458b6d508b9_output",
        ...
        self._setDefault(errorCol="TextAnalyze_b458b6d508b9_error")
        ...
        self._setDefault(outputCol="TextAnalyze_b458b6d508b9_output")
