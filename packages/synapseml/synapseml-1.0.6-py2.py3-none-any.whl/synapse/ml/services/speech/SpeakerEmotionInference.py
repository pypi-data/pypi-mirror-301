...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_007ccc634b24_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_007ccc634b24_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_007ccc634b24_error")
        self._setDefault(outputCol="SpeakerEmotionInference_007ccc634b24_output")
