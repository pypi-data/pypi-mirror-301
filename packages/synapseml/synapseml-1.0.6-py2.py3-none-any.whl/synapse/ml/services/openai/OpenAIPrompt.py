...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_a4f78dfcb17f_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_a4f78dfcb17f_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_a4f78dfcb17f_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_a4f78dfcb17f_error")
        self._setDefault(messagesCol="OpenAIPrompt_a4f78dfcb17f_messages")
        self._setDefault(outputCol="OpenAIPrompt_a4f78dfcb17f_output")
