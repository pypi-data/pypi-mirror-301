...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_f8c7043c1583_error",
        handler=None,
        outputCol="OpenAIEmbedding_f8c7043c1583_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_f8c7043c1583_error")
        self._setDefault(outputCol="OpenAIEmbedding_f8c7043c1583_output")
