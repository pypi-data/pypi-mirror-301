...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_0a561bb6085e_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_0a561bb6085e_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_0a561bb6085e_error")
        self._setDefault(outputCol="OpenAIChatCompletion_0a561bb6085e_output")
