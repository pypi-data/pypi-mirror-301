...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_84d0b3376b4a_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_84d0b3376b4a_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_84d0b3376b4a_error")
        self._setDefault(outputCol="OpenAICompletion_84d0b3376b4a_output")
