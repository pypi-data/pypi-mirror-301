...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_246bd81068e7_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_246bd81068e7_output",
        ...
        self._setDefault(errorCol="GetCustomModel_246bd81068e7_error")
        self._setDefault(outputCol="GetCustomModel_246bd81068e7_output")
