...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_e2faa2719260_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_e2faa2719260_output",
        ...
        self._setDefault(errorCol="ListCustomModels_e2faa2719260_error")
        self._setDefault(outputCol="ListCustomModels_e2faa2719260_output")
