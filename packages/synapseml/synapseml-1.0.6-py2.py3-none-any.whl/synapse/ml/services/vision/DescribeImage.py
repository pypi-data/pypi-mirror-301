...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_e1a89965829f_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_e1a89965829f_output",
        ...
        self._setDefault(errorCol="DescribeImage_e1a89965829f_error")
        self._setDefault(outputCol="DescribeImage_e1a89965829f_output")
