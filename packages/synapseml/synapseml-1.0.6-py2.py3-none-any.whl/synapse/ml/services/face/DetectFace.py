...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_b834f5cc66cf_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_b834f5cc66cf_output",
        ...
        self._setDefault(errorCol="DetectFace_b834f5cc66cf_error")
        self._setDefault(outputCol="DetectFace_b834f5cc66cf_output")
