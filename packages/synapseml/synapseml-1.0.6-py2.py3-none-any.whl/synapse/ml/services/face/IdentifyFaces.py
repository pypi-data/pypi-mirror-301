...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_478459393306_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_478459393306_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_478459393306_error")
        self._setDefault(outputCol="IdentifyFaces_478459393306_output")
