...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_866618b8a743_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_866618b8a743_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_866618b8a743_error")
        self._setDefault(outputCol="VerifyFaces_866618b8a743_output")
