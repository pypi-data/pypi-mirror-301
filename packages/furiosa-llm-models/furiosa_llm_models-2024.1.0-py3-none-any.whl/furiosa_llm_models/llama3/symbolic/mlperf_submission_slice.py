...
class NewLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if causal_mask is not None:
            causal_mask = make_causal_mask(causal_mask, self.dtype, inputs_embeds.device)
        if attention_mask is not None:
            attention_mask = make_attention_mask(attention_mask, self.dtype, inputs_embeds.device)
