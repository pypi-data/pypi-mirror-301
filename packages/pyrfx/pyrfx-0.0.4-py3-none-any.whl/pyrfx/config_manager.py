...
class ConfigManager:
    ...
    def __init__(
        ...
        self.data_path: Path | None = Path(output_data_folder) if output_data_folder else None
        if (self.save_to_json or self.save_to_csv) and not self.data_path:
    ...
    def _initialize_rpc_url(rpc_url: str | None, defaults: dict[str, str | int]) -> str:
        ...
        if not rpc_url:
            logging.error("No RPC URL was specified.")
    ...
    def _initialize_chain_id(chain_id: int | None, defaults: dict[str, str | int]) -> int:
        ...
        if not chain_id:
            logging.error("No chain ID was specified.")
    ...
    def _initialize_block_explorer_url(block_explorer_url: str | None, defaults: dict[str, str | int]) -> str:
        ...
        if not block_explorer_url:
            logging.error("No block explorer URL was specified.")
    ...
    def _initialize_oracle_url(oracle_url: str | None, defaults: dict[str, str | int]) -> str:
        ...
        if not oracle_url:
            logging.error("No oracle URL was specified.")
    ...
    def _initialize_tokens_url(tokens_url: str | None, defaults: dict[str, str | int]) -> str:
        ...
        if not tokens_url:
            logging.error("No tokens URL was specified.")
