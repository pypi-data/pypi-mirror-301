...
class SQLAgent:
	def __init__(self, llm_api_url: str, model: str, database_driver: str, database_username: str, database_password: str, database_host: str, database_port: str, database_name: str, debug: bool = False):
		self.debug = debug
		...
		while retry < max_retry:
			try:
				...
				if "response" in response:
					...
					if sql_query.split()[0] not in allowed_statements:
						return None
	...
	def build_prompts(self, user_request: str, database_schema: str) -> str:
		system_prompt = """
