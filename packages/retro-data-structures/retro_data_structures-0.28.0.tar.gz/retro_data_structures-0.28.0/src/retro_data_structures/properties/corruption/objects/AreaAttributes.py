...
class AreaAttributes(BaseObjectType):
    ...
    environment_effects: enums.EnvironmentEffects = dataclasses.field(default=enums.EnvironmentEffects.Unknown1, metadata={
        'reflection': FieldReflection[enums.EnvironmentEffects](
            enums.EnvironmentEffects, id=0xea2700e9, original_name='EnvironmentEffects', from_json=enums.EnvironmentEffects.from_json, to_json=enums.EnvironmentEffects.to_json
        ),
    })
    ...
    phazon_damage: enums.PhazonDamage = dataclasses.field(default=enums.PhazonDamage.Unknown1, metadata={
        'reflection': FieldReflection[enums.PhazonDamage](
            enums.PhazonDamage, id=0x4e08b984, original_name='PhazonDamage', from_json=enums.PhazonDamage.from_json, to_json=enums.PhazonDamage.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            environment_effects=enums.EnvironmentEffects.from_json(json_data['environment_effects']),
            ...
            phazon_damage=enums.PhazonDamage.from_json(json_data['phazon_damage']),
