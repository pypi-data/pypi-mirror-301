...
class EffectRepulsor(BaseObjectType):
    ...
    item: enums.PlayerItem = dataclasses.field(default=enums.PlayerItem.PowerBeam, metadata={
        'reflection': FieldReflection[enums.PlayerItem](
            enums.PlayerItem, id=0xa169d424, original_name='Item', from_json=enums.PlayerItem.from_json, to_json=enums.PlayerItem.to_json
        ),
    })
