...
class CinematicCamera(BaseObjectType):
    ...
    camera_mode: enums.CameraMode = dataclasses.field(default=enums.CameraMode.Unknown1, metadata={
        'reflection': FieldReflection[enums.CameraMode](
            enums.CameraMode, id=0xcc08ef1b, original_name='CameraMode', from_json=enums.CameraMode.from_json, to_json=enums.CameraMode.to_json
        ),
    })
    ...
    cinematic_start_type: enums.CinematicStartType = dataclasses.field(default=enums.CinematicStartType.Unknown1, metadata={
        'reflection': FieldReflection[enums.CinematicStartType](
            enums.CinematicStartType, id=0xb1ac9176, original_name='CinematicStartType', from_json=enums.CinematicStartType.from_json, to_json=enums.CinematicStartType.to_json
        ),
    })
    ...
    cinematic_ends_type: enums.CinematicEndsType = dataclasses.field(default=enums.CinematicEndsType.Unknown1, metadata={
        'reflection': FieldReflection[enums.CinematicEndsType](
            enums.CinematicEndsType, id=0x974a961f, original_name='CinematicEndsType', from_json=enums.CinematicEndsType.from_json, to_json=enums.CinematicEndsType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            camera_mode=enums.CameraMode.from_json(json_data['camera_mode']),
            ...
            cinematic_start_type=enums.CinematicStartType.from_json(json_data['cinematic_start_type']),
            blend=CinematicBlend.from_json(json_data['blend']),
            cinematic_ends_type=enums.CinematicEndsType.from_json(json_data['cinematic_ends_type']),
