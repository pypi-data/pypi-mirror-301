...
class SteamLord(BaseObjectType):
    ...
    steam_lord_data: SteamLordData = dataclasses.field(default_factory=SteamLordData, metadata={
        'reflection': FieldReflection[SteamLordData](
            SteamLordData, id=0x01d5823c, original_name='SteamLordData', from_json=SteamLordData.from_json, to_json=SteamLordData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x1d5823c: ('steam_lord_data', SteamLordData.from_stream),
}
