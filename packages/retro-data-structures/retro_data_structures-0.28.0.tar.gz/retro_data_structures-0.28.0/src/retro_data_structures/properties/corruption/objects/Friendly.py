...
class Friendly(BaseObjectType):
    ...
    friendly_properties: FriendlyData = dataclasses.field(default_factory=FriendlyData, metadata={
        'reflection': FieldReflection[FriendlyData](
            FriendlyData, id=0xbf9ba6cc, original_name='FriendlyProperties', from_json=FriendlyData.from_json, to_json=FriendlyData.to_json
        ),
    })
    federation_properties: FederationData = dataclasses.field(default_factory=FederationData, metadata={
        'reflection': FieldReflection[FederationData](
            FederationData, id=0xbcc2fddf, original_name='FederationProperties', from_json=FederationData.from_json, to_json=FederationData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xbf9ba6cc: ('friendly_properties', FriendlyData.from_stream),
    0xbcc2fddf: ('federation_properties', FederationData.from_stream),
}
