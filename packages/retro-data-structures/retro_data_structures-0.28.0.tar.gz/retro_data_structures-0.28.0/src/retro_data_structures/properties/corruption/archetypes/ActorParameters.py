...
class ActorParameters(BaseProperty):
    ...
    actor_material_type: enums.ActorMaterialType = dataclasses.field(default=enums.ActorMaterialType.kMT_Unknown, metadata={
        'reflection': FieldReflection[enums.ActorMaterialType](
            enums.ActorMaterialType, id=0xe315ee72, original_name='ActorMaterialType', from_json=enums.ActorMaterialType.from_json, to_json=enums.ActorMaterialType.to_json
        ),
    })
    actor_collision_response: enums.ActorCollisionResponse = dataclasses.field(default=enums.ActorCollisionResponse.kACR_Default, metadata={
        'reflection': FieldReflection[enums.ActorCollisionResponse](
            enums.ActorCollisionResponse, id=0x583895fa, original_name='ActorCollisionResponse', from_json=enums.ActorCollisionResponse.from_json, to_json=enums.ActorCollisionResponse.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            actor_material_type=enums.ActorMaterialType.from_json(json_data['actor_material_type']),
            actor_collision_response=enums.ActorCollisionResponse.from_json(json_data['actor_collision_response']),
