...
class CableProperties(BaseProperty):
    ...
    cable_bloom: enums.CableBloom = dataclasses.field(default=enums.CableBloom.Unknown1, metadata={
        'reflection': FieldReflection[enums.CableBloom](
            enums.CableBloom, id=0xd4b4b3d2, original_name='CableBloom', from_json=enums.CableBloom.from_json, to_json=enums.CableBloom.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            cable_bloom=enums.CableBloom.from_json(json_data['cable_bloom']),
