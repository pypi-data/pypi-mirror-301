...
class PlayerProxy(BaseObjectType):
    ...
    proxy_type: enums.ProxyType = dataclasses.field(default=enums.ProxyType.Unknown1, metadata={
        'reflection': FieldReflection[enums.ProxyType](
            enums.ProxyType, id=0x9654af0e, original_name='ProxyType', from_json=enums.ProxyType.from_json, to_json=enums.ProxyType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            proxy_type=enums.ProxyType.from_json(json_data['proxy_type']),
