...
class Steam(BaseObjectType):
    ...
    filter_shape: enums.FilterShape = dataclasses.field(default=enums.FilterShape.Unknown1, metadata={
        'reflection': FieldReflection[enums.FilterShape](
            enums.FilterShape, id=0x92869052, original_name='FilterShape', from_json=enums.FilterShape.from_json, to_json=enums.FilterShape.to_json
        ),
    })
