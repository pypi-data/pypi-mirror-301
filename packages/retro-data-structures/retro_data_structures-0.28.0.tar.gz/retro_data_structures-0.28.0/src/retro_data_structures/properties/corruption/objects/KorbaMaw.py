...
class KorbaMaw(BaseObjectType):
    ...
    korba_maw_properties: KorbaMawData = dataclasses.field(default_factory=KorbaMawData, metadata={
        'reflection': FieldReflection[KorbaMawData](
            KorbaMawData, id=0x33d8ede3, original_name='KorbaMawProperties', from_json=KorbaMawData.from_json, to_json=KorbaMawData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x33d8ede3: ('korba_maw_properties', KorbaMawData.from_stream),
