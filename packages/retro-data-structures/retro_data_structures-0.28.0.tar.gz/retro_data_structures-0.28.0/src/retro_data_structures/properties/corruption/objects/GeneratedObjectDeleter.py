...
class GeneratedObjectDeleter(BaseObjectType):
    ...
    generated_object_deleter_properties: GeneratedObjectDeleterProperties = dataclasses.field(default_factory=GeneratedObjectDeleterProperties, metadata={
        'reflection': FieldReflection[GeneratedObjectDeleterProperties](
            GeneratedObjectDeleterProperties, id=0x2013052b, original_name='GeneratedObjectDeleterProperties', from_json=GeneratedObjectDeleterProperties.from_json, to_json=GeneratedObjectDeleterProperties.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            generated_object_deleter_properties=GeneratedObjectDeleterProperties.from_json(json_data['generated_object_deleter_properties']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x2013052b: ('generated_object_deleter_properties', GeneratedObjectDeleterProperties.from_stream),
}
