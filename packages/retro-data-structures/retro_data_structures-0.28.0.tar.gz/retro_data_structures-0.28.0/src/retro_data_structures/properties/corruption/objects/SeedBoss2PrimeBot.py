...
class SeedBoss2PrimeBot(BaseObjectType):
    ...
    unknown_struct58: UnknownStruct58 = dataclasses.field(default_factory=UnknownStruct58, metadata={
        'reflection': FieldReflection[UnknownStruct58](
            UnknownStruct58, id=0x96782873, original_name='UnknownStruct58', from_json=UnknownStruct58.from_json, to_json=UnknownStruct58.to_json
        ),
    })
    seed_boss2_prime_bot_data_0xb1461bc0: SeedBoss2PrimeBotData = dataclasses.field(default_factory=SeedBoss2PrimeBotData, metadata={
        'reflection': FieldReflection[SeedBoss2PrimeBotData](
            SeedBoss2PrimeBotData, id=0xb1461bc0, original_name='SeedBoss2PrimeBotData', from_json=SeedBoss2PrimeBotData.from_json, to_json=SeedBoss2PrimeBotData.to_json
        ),
    })
    ...
    seed_boss2_prime_bot_data_0xd578f188: SeedBoss2PrimeBotData = dataclasses.field(default_factory=SeedBoss2PrimeBotData, metadata={
        'reflection': FieldReflection[SeedBoss2PrimeBotData](
            SeedBoss2PrimeBotData, id=0xd578f188, original_name='SeedBoss2PrimeBotData', from_json=SeedBoss2PrimeBotData.from_json, to_json=SeedBoss2PrimeBotData.to_json
        ),
    })
    ...
    seed_boss2_prime_bot_data_0xe3585b48: SeedBoss2PrimeBotData = dataclasses.field(default_factory=SeedBoss2PrimeBotData, metadata={
        'reflection': FieldReflection[SeedBoss2PrimeBotData](
            SeedBoss2PrimeBotData, id=0xe3585b48, original_name='SeedBoss2PrimeBotData', from_json=SeedBoss2PrimeBotData.from_json, to_json=SeedBoss2PrimeBotData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct58, seed_boss2_prime_bot_data_0xb1461bc0, patterned, seed_boss2_prime_bot_data_0xd578f188, patterned_ai_0x1464ae05, seed_boss2_prime_bot_data_0xe3585b48, patterned_ai_0x24d00673, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            seed_boss2_prime_bot_data_0xb1461bc0=SeedBoss2PrimeBotData.from_json(json_data['seed_boss2_prime_bot_data_0xb1461bc0']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            seed_boss2_prime_bot_data_0xd578f188=SeedBoss2PrimeBotData.from_json(json_data['seed_boss2_prime_bot_data_0xd578f188']),
            patterned_ai_0x1464ae05=PatternedAITypedef.from_json(json_data['patterned_ai_0x1464ae05']),
            seed_boss2_prime_bot_data_0xe3585b48=SeedBoss2PrimeBotData.from_json(json_data['seed_boss2_prime_bot_data_0xe3585b48']),
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x96782873: ('unknown_struct58', UnknownStruct58.from_stream),
    0xb1461bc0: ('seed_boss2_prime_bot_data_0xb1461bc0', SeedBoss2PrimeBotData.from_stream),
    0xb3774750: ('patterned', PatternedAITypedef.from_stream),
    0xd578f188: ('seed_boss2_prime_bot_data_0xd578f188', SeedBoss2PrimeBotData.from_stream),
    0x1464ae05: ('patterned_ai_0x1464ae05', PatternedAITypedef.from_stream),
    0xe3585b48: ('seed_boss2_prime_bot_data_0xe3585b48', SeedBoss2PrimeBotData.from_stream),
