...
class SteamBot(BaseObjectType):
    ...
    steam_bot_data: SteamBotData = dataclasses.field(default_factory=SteamBotData, metadata={
        'reflection': FieldReflection[SteamBotData](
            SteamBotData, id=0x11375ec0, original_name='SteamBotData', from_json=SteamBotData.from_json, to_json=SteamBotData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, steam_bot_data, patterned, actor_information)
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x11375ec0: ('steam_bot_data', SteamBotData.from_stream),
