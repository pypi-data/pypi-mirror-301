...
class CombatTrooper(BaseObjectType):
    ...
    unknown_struct25: UnknownStruct25 = dataclasses.field(default_factory=UnknownStruct25, metadata={
        'reflection': FieldReflection[UnknownStruct25](
            UnknownStruct25, id=0x7f4eaa5e, original_name='UnknownStruct25', from_json=UnknownStruct25.from_json, to_json=UnknownStruct25.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x7f4eaa5e: ('unknown_struct25', UnknownStruct25.from_stream),
}
