...
class BeastRider(BaseObjectType):
    ...
    beast_rider_properties: BeastRiderData = dataclasses.field(default_factory=BeastRiderData, metadata={
        'reflection': FieldReflection[BeastRiderData](
            BeastRiderData, id=0x56c48141, original_name='BeastRiderProperties', from_json=BeastRiderData.from_json, to_json=BeastRiderData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x56c48141: ('beast_rider_properties', BeastRiderData.from_stream),
