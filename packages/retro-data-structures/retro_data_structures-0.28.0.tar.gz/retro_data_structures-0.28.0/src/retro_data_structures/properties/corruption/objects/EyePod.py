...
class EyePod(BaseObjectType):
    ...
    eye_pod_properties: EyePodData = dataclasses.field(default_factory=EyePodData, metadata={
        'reflection': FieldReflection[EyePodData](
            EyePodData, id=0x9214a518, original_name='EyePodProperties', from_json=EyePodData.from_json, to_json=EyePodData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, wall_crawler_properties, eye_pod_properties, patterned, actor_information)
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x9214a518: ('eye_pod_properties', EyePodData.from_stream),
