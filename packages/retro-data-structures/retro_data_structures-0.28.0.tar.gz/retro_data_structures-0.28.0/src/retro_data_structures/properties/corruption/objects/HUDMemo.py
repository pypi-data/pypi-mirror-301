...
class HUDMemo(BaseObjectType):
    ...
    message_type: enums.MessageType = dataclasses.field(default=enums.MessageType.Unknown1, metadata={
        'reflection': FieldReflection[enums.MessageType](
            enums.MessageType, id=0x2b4e290c, original_name='MessageType', from_json=enums.MessageType.from_json, to_json=enums.MessageType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            message_type=enums.MessageType.from_json(json_data['message_type']),
