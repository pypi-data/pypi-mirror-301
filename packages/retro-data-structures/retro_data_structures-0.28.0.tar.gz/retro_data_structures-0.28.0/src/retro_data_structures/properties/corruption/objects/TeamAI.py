...
class TeamAI(BaseObjectType):
    ...
    max_special_attackers: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0x1c3a365c, original_name='MaxSpecialAttackers'
        ),
    })
    ...
    unknown_0x69cde528: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0x69cde528, original_name='Unknown'
        ),
    })
    ...
    unknown_0x9856e6f0: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x9856e6f0, original_name='Unknown'
        ),
    })
    max_hypermode_members: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0x46b94e2c, original_name='MaxHypermodeMembers'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, max_team_size, max_melee_attackers, max_ranged_attackers, max_special_attackers, unknown_0x9fa9c457, unknown_0x54cd2755, unknown_0xc36ed15c, unknown_0x69cde528, team_formation, unknown_0xd3ad55b6, unknown_0x8d00b839, unknown_0x9856e6f0, max_hypermode_members)
