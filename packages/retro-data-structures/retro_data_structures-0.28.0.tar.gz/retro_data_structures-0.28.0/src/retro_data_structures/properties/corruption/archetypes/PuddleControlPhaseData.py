...
class PuddleControlPhaseData(BaseProperty):
    generation_rate: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x23e91e15, original_name='GenerationRate'
        ),
    })
    effect_rate: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x82403cbd, original_name='EffectRate'
        ),
    })
    move_rate: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x7ec9e6d9, original_name='MoveRate'
        ),
    })
