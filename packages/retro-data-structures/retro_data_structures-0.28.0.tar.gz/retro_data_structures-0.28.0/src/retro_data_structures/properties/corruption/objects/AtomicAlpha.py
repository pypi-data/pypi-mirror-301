...
class AtomicAlpha(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, bomb_weapon, bomb_model, bomb_damage, bomb_drop_delay, bomb_reappear_delay, bomb_reappear_time, invisible, home_while_charging)
