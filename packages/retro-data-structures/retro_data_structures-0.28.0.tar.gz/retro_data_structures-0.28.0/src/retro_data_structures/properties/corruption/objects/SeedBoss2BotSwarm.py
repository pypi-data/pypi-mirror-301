...
class SeedBoss2BotSwarm(BaseObjectType):
    ...
    unknown_struct59: UnknownStruct59 = dataclasses.field(default_factory=UnknownStruct59, metadata={
        'reflection': FieldReflection[UnknownStruct59](
            UnknownStruct59, id=0xd6cc62cb, original_name='UnknownStruct59', from_json=UnknownStruct59.from_json, to_json=UnknownStruct59.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xd6cc62cb: ('unknown_struct59', UnknownStruct59.from_stream),
}
