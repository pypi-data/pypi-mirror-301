...
class Phaazoid(BaseObjectType):
    ...
    phaazoid_data: PhaazoidData = dataclasses.field(default_factory=PhaazoidData, metadata={
        'reflection': FieldReflection[PhaazoidData](
            PhaazoidData, id=0xa92bfe03, original_name='PhaazoidData', from_json=PhaazoidData.from_json, to_json=PhaazoidData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa92bfe03: ('phaazoid_data', PhaazoidData.from_stream),
}
