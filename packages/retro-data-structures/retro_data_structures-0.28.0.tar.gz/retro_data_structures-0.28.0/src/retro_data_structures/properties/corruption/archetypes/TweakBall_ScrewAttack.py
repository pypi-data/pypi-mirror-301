...
class TweakBall_ScrewAttack(BaseProperty):
    ...
    unknown_0x315df4d7: float = dataclasses.field(default=30.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x315df4d7, original_name='Unknown'
        ),
    })
    ...
    unknown_0xc5b758f5: float = dataclasses.field(default=30.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xc5b758f5, original_name='Unknown'
        ),
    })
