...
class SpecialFunction(BaseObjectType):
    ...
    inventory_item_parm: enums.PlayerItem = dataclasses.field(default=enums.PlayerItem.PowerBeam, metadata={
    ...
    extra_info: enums.ExtraInfo = dataclasses.field(default=enums.ExtraInfo.Unknown1, metadata={
        'reflection': FieldReflection[enums.ExtraInfo](
            enums.ExtraInfo, id=0x825e1e14, original_name='ExtraInfo', from_json=enums.ExtraInfo.from_json, to_json=enums.ExtraInfo.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            extra_info=enums.ExtraInfo.from_json(json_data['extra_info']),
        )
