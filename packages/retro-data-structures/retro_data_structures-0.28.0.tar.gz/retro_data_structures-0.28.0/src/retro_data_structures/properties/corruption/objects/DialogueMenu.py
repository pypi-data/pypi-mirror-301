...
class DialogueMenu(BaseObjectType):
    ...
    default_selection: enums.DefaultSelection = dataclasses.field(default=enums.DefaultSelection.Unknown1, metadata={
        'reflection': FieldReflection[enums.DefaultSelection](
            enums.DefaultSelection, id=0x58cbcbca, original_name='DefaultSelection', from_json=enums.DefaultSelection.from_json, to_json=enums.DefaultSelection.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            default_selection=enums.DefaultSelection.from_json(json_data['default_selection']),
