...
class PathControl(BaseObjectType):
    ...
    path_curve_type: enums.PathCurveType = dataclasses.field(default=enums.PathCurveType.Unknown1, metadata={
        'reflection': FieldReflection[enums.PathCurveType](
            enums.PathCurveType, id=0xf25ffdff, original_name='PathCurveType', from_json=enums.PathCurveType.from_json, to_json=enums.PathCurveType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            path_curve_type=enums.PathCurveType.from_json(json_data['path_curve_type']),
