...
class ActorContraption(BaseObjectType):
    ...
    unnamed_0x0000000b: ActorParameters = dataclasses.field(default_factory=ActorParameters, metadata={
        'reflection': FieldReflection[ActorParameters](
            ActorParameters, id=0x0000000b, original_name=None, from_json=ActorParameters.from_json, to_json=ActorParameters.to_json
        ),
    })
    ...
    unnamed_0x0000000d: DamageInfo = dataclasses.field(default_factory=DamageInfo, metadata={
        'reflection': FieldReflection[DamageInfo](
            DamageInfo, id=0x0000000d, original_name=None, from_json=DamageInfo.from_json, to_json=DamageInfo.to_json
        ),
    })
