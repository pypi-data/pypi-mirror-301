...
class DamageableTrigger(BaseObjectType):
    ...
    unnamed_0x00000003: HealthInfo = dataclasses.field(default_factory=HealthInfo, metadata={
        'reflection': FieldReflection[HealthInfo](
            HealthInfo, id=0x00000003, original_name=None, from_json=HealthInfo.from_json, to_json=HealthInfo.to_json
        ),
    })
    unnamed_0x00000004: DamageVulnerability = dataclasses.field(default_factory=DamageVulnerability, metadata={
        'reflection': FieldReflection[DamageVulnerability](
            DamageVulnerability, id=0x00000004, original_name=None, from_json=DamageVulnerability.from_json, to_json=DamageVulnerability.to_json
        ),
    })
    render_side: enums.RenderSide = dataclasses.field(default=enums.RenderSide._None, metadata={
        'reflection': FieldReflection[enums.RenderSide](
            enums.RenderSide, id=0x00000005, original_name='Render Side', from_json=enums.RenderSide.from_json, to_json=enums.RenderSide.to_json
        ),
    })
    ...
    unnamed_0x0000000b: VisorParameters = dataclasses.field(default_factory=VisorParameters, metadata={
        'reflection': FieldReflection[VisorParameters](
            VisorParameters, id=0x0000000b, original_name=None, from_json=VisorParameters.from_json, to_json=VisorParameters.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            render_side=enums.RenderSide.from_json(json_data['render_side']),
