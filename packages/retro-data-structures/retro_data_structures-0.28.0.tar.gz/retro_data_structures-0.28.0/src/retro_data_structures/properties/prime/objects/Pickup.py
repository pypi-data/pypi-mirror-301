...
class Pickup(BaseObjectType):
    ...
    unnamed_0x00000006: enums.PlayerItem = dataclasses.field(default=enums.PlayerItem.PowerBeam, metadata={
        'reflection': FieldReflection[enums.PlayerItem](
            enums.PlayerItem, id=0x00000006, original_name=None, from_json=enums.PlayerItem.from_json, to_json=enums.PlayerItem.to_json
        ),
    })
    ...
    unnamed_0x0000000e: ActorParameters = dataclasses.field(default_factory=ActorParameters, metadata={
        'reflection': FieldReflection[ActorParameters](
            ActorParameters, id=0x0000000e, original_name=None, from_json=ActorParameters.from_json, to_json=ActorParameters.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unnamed_0x00000006=enums.PlayerItem.from_json(json_data['unnamed_0x00000006']),
