...
class SpacePirate(BaseObjectType):
    ...
    flags: enums.Flags = dataclasses.field(default=enums.Flags(0), metadata={
        'reflection': FieldReflection[enums.Flags](
            enums.Flags, id=0x0000000c, original_name='Flags', from_json=enums.Flags.from_json, to_json=enums.Flags.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            flags=enums.Flags.from_json(json_data['flags']),
