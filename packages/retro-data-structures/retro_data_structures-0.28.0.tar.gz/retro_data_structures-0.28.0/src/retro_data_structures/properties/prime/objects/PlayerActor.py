...
class PlayerActor(BaseObjectType):
    ...
    unnamed_0x00000008: HealthInfo = dataclasses.field(default_factory=HealthInfo, metadata={
        'reflection': FieldReflection[HealthInfo](
            HealthInfo, id=0x00000008, original_name=None, from_json=HealthInfo.from_json, to_json=HealthInfo.to_json
        ),
    })
    unnamed_0x00000009: DamageVulnerability = dataclasses.field(default_factory=DamageVulnerability, metadata={
        'reflection': FieldReflection[DamageVulnerability](
            DamageVulnerability, id=0x00000009, original_name=None, from_json=DamageVulnerability.from_json, to_json=DamageVulnerability.to_json
        ),
    })
    ...
    unnamed_0x0000000c: ActorParameters = dataclasses.field(default_factory=ActorParameters, metadata={
        'reflection': FieldReflection[ActorParameters](
            ActorParameters, id=0x0000000c, original_name=None, from_json=ActorParameters.from_json, to_json=ActorParameters.to_json
        ),
    })
    ...
    unnamed_0x00000011: PlayerActorStruct = dataclasses.field(default_factory=PlayerActorStruct, metadata={
        'reflection': FieldReflection[PlayerActorStruct](
            PlayerActorStruct, id=0x00000011, original_name=None, from_json=PlayerActorStruct.from_json, to_json=PlayerActorStruct.to_json
        ),
    })
