...
if typing.TYPE_CHECKING:
    class ForestBossJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct95: json_util.JsonObject
...
class ForestBoss(BaseObjectType):
    ...
    unknown_struct95: UnknownStruct95 = dataclasses.field(default_factory=UnknownStruct95, metadata={
        'reflection': FieldReflection[UnknownStruct95](
            UnknownStruct95, id=0x4acc5921, original_name='UnknownStruct95', from_json=UnknownStruct95.from_json, to_json=UnknownStruct95.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, unknown_struct95)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ForestBossJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct95=UnknownStruct95.from_json(json_data['unknown_struct95']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x4acc5921: ('unknown_struct95', UnknownStruct95.from_stream),
}
