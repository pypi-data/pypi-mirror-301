...
class CameraShakerEnvelope(BaseProperty):
    shake_shape: enums.ShakeShape = dataclasses.field(default=enums.ShakeShape.Unknown1, metadata={
        'reflection': FieldReflection[enums.ShakeShape](
            enums.ShakeShape, id=0xc6089a3f, original_name='ShakeShape', from_json=enums.ShakeShape.from_json, to_json=enums.ShakeShape.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            shake_shape=enums.ShakeShape.from_json(json_data['shake_shape']),
