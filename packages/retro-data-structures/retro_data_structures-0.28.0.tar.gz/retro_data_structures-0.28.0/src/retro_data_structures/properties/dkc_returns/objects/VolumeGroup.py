...
if typing.TYPE_CHECKING:
    class VolumeGroupJson(typing_extensions.TypedDict):
...
class VolumeGroup(BaseObjectType):
    ...
    inverted: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x70fdfcc4, original_name='Inverted'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, group_name, volume, inverted)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("VolumeGroupJson", data)
        return cls(
