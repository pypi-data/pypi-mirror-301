...
if typing.TYPE_CHECKING:
    class PlayerActorJson(typing_extensions.TypedDict):
        ...
        unknown_struct6_0xe1bcef23: json_util.JsonObject
        unknown_struct6_0x963e45f6: json_util.JsonObject
...
class PlayerActor(BaseObjectType):
    ...
    unknown_struct6_0xe1bcef23: PlayerType = dataclasses.field(default_factory=PlayerType, metadata={
        'reflection': FieldReflection[PlayerType](
            PlayerType, id=0xe1bcef23, original_name='UnknownStruct6', from_json=PlayerType.from_json, to_json=PlayerType.to_json
        ),
    })
    unknown_struct6_0x963e45f6: PlayerType = dataclasses.field(default_factory=PlayerType, metadata={
        'reflection': FieldReflection[PlayerType](
            PlayerType, id=0x963e45f6, original_name='UnknownStruct6', from_json=PlayerType.from_json, to_json=PlayerType.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, collision_box, collision_offset, mass, gravity, health, vulnerability, model, character_animation_information, shadow_data, actor_information, is_loop, unknown_0x87613768, unknown_0xe2ddc4c1, is_camera_through, render_texture_set, render_push, render_first_sorted, render_in_foreground, ignore_fog, scale_animation, unknown_0xc1b9c601, unknown_0x27e50799, animation_offset, animation_time_scale, unknown_struct6_0xe1bcef23, unknown_struct6_0x963e45f6, unknown_struct8, alternate_skins)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_struct6_0xe1bcef23=PlayerType.from_json(json_data['unknown_struct6_0xe1bcef23']),
            unknown_struct6_0x963e45f6=PlayerType.from_json(json_data['unknown_struct6_0x963e45f6']),
