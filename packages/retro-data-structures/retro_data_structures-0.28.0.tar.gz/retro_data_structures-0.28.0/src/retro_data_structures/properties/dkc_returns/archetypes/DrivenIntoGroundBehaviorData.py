...
if typing.TYPE_CHECKING:
    class DrivenIntoGroundBehaviorDataJson(typing_extensions.TypedDict):
        placeholder: bool
...
class DrivenIntoGroundBehaviorData(BaseProperty):
    placeholder: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xbb0e924c, original_name='Placeholder'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("DrivenIntoGroundBehaviorDataJson", data)
        return cls(
