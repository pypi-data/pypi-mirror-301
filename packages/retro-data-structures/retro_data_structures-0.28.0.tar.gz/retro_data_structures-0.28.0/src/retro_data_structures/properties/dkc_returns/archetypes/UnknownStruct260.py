...
if typing.TYPE_CHECKING:
    class UnknownStruct260Json(typing_extensions.TypedDict):
...
class UnknownStruct260(BaseProperty):
    ...
    caud_0xb0c2f5f6: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['CAUD'], 'reflection': FieldReflection[AssetId](
    ...
    caud_0xc8b23273: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['CAUD'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0xc8b23273, original_name='CAUD'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(unknown_0x348c9d90, flight_sound_deceleration_k, flight_sound, flight_sound_low_pass_filter, flight_sound_pitch, flight_sound_volume, caud_0xb0c2f5f6, unknown_0xbd894993, flight_sound2_pitch, flight_sound2_volume, hit_player_sound, caud_0xc8b23273, swoop_interrupted_sound)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct260Json", data)
        return cls(
            ...
            caud_0xb0c2f5f6=json_data['caud_0xb0c2f5f6'],
            ...
            caud_0xc8b23273=json_data['caud_0xc8b23273'],
