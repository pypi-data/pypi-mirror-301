...
if typing.TYPE_CHECKING:
    class CameraHintJson(typing_extensions.TypedDict):
        ...
        tracking_behavior: json_util.JsonObject
        position_behavior: json_util.JsonObject
        camera_position: json_util.JsonObject
        ...
        framing_behavior: json_util.JsonObject
        interpolation_behavior: json_util.JsonObject
        clip_behavior: json_util.JsonObject
...
class CameraHint(BaseObjectType):
    ...
    flags_camera_hint: int = dataclasses.field(default=1610905732, metadata={
        'reflection': FieldReflection[int](
    ...
    tracking_behavior: CameraTracking = dataclasses.field(default_factory=CameraTracking, metadata={
        'reflection': FieldReflection[CameraTracking](
            CameraTracking, id=0xe8eaaf0e, original_name='TrackingBehavior', from_json=CameraTracking.from_json, to_json=CameraTracking.to_json
        ),
    })
    ...
    camera_position: CameraPosition = dataclasses.field(default_factory=CameraPosition, metadata={
        'reflection': FieldReflection[CameraPosition](
            CameraPosition, id=0x4f2ca324, original_name='CameraPosition', from_json=CameraPosition.from_json, to_json=CameraPosition.to_json
        ),
    })
    ...
    framing_behavior: CameraFraming = dataclasses.field(default_factory=CameraFraming, metadata={
        'reflection': FieldReflection[CameraFraming](
            CameraFraming, id=0xe389796e, original_name='FramingBehavior', from_json=CameraFraming.from_json, to_json=CameraFraming.to_json
        ),
    })
    ...
    clip_behavior: CameraClip = dataclasses.field(default_factory=CameraClip, metadata={
        'reflection': FieldReflection[CameraClip](
            CameraClip, id=0xd3696c11, original_name='ClipBehavior', from_json=CameraClip.from_json, to_json=CameraClip.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, priority, timer, flags_camera_hint, constraints, tracking_behavior, position_behavior, camera_position, navigation_behavior, motion_behavior, orientation_behavior, rotation_behavior, field_of_view_behavior, framing_behavior, interpolation_behavior, clip_behavior, control_frame_interpolation)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            tracking_behavior=CameraTracking.from_json(json_data['tracking_behavior']),
            position_behavior=CameraPosition.from_json(json_data['position_behavior']),
            camera_position=CameraPosition.from_json(json_data['camera_position']),
            ...
            framing_behavior=CameraFraming.from_json(json_data['framing_behavior']),
            interpolation_behavior=CameraInterpolation.from_json(json_data['interpolation_behavior']),
            clip_behavior=CameraClip.from_json(json_data['clip_behavior']),
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xe8eaaf0e: ('tracking_behavior', CameraTracking.from_stream),
    0xd1bd5c40: ('position_behavior', CameraPosition.from_stream),
    0x4f2ca324: ('camera_position', CameraPosition.from_stream),
    ...
    0xe389796e: ('framing_behavior', CameraFraming.from_stream),
    0x764827d4: ('interpolation_behavior', CameraInterpolation.from_stream),
    0xd3696c11: ('clip_behavior', CameraClip.from_stream),
