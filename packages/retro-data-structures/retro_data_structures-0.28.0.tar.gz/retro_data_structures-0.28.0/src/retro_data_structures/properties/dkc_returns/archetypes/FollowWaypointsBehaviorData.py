...
if typing.TYPE_CHECKING:
    class FollowWaypointsBehaviorDataJson(typing_extensions.TypedDict):
        turn_speed: float
...
class FollowWaypointsBehaviorData(BaseProperty):
    turn_speed: float = dataclasses.field(default=720.0, metadata={
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("FollowWaypointsBehaviorDataJson", data)
        return cls(
