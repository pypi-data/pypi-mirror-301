...
if typing.TYPE_CHECKING:
    class UnknownStruct145Json(typing_extensions.TypedDict):
...
class UnknownStruct145(BaseProperty):
    ...
    move_left: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['STRG'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x6d4029d0, original_name='MoveLeft'
        ),
    })
    move_right: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['STRG'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x601838ab, original_name='MoveRight'
        ),
    })
    run_grab: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['STRG'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0xecc78b13, original_name='RunGrab'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(unknown_struct29, title, how_to, back, back_core, move_left, move_right, run_grab, jump, pause, crouch, ground_pound, blow, mount, dismount, roll, blow_input, strg, mount_input, dismount_input, roll_input, text_background)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct145Json", data)
        return cls(
            ...
            move_left=json_data['move_left'],
            move_right=json_data['move_right'],
            run_grab=json_data['run_grab'],
            jump=json_data['jump'],
