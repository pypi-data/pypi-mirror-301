...
if typing.TYPE_CHECKING:
    class MEATJson(typing_extensions.TypedDict):
...
class MEAT(BaseObjectType):
    ...
    audio_memory: int = dataclasses.field(default=5000, metadata={
        'reflection': FieldReflection[int](
            int, id=0xaf287a20, original_name='AudioMemory'
        ),
    })
    particle_memory: int = dataclasses.field(default=5000, metadata={
        'reflection': FieldReflection[int](
            int, id=0xd7bd9904, original_name='ParticleMemory'
        ),
    })
    unknown: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0xbef177d6, original_name='Unknown'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, audio_memory, particle_memory, unknown)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("MEATJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            audio_memory=json_data['audio_memory'],
            particle_memory=json_data['particle_memory'],
