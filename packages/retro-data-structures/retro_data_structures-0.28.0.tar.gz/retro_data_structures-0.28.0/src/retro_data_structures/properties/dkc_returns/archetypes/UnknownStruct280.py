...
if typing.TYPE_CHECKING:
    class UnknownStruct280Json(typing_extensions.TypedDict):
        unknown_0x968337ab: int
        unknown_0x8308e359: int
        unknown_0x5f86d272: float
        unknown_0xbd50eb30: float
...
class UnknownStruct280(BaseProperty):
    unknown_0x968337ab: int = dataclasses.field(default=2, metadata={
        'reflection': FieldReflection[int](
            int, id=0x968337ab, original_name='Unknown'
        ),
    })
    unknown_0x8308e359: int = dataclasses.field(default=4, metadata={
        'reflection': FieldReflection[int](
            int, id=0x8308e359, original_name='Unknown'
        ),
    })
    unknown_0x5f86d272: float = dataclasses.field(default=2.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x5f86d272, original_name='Unknown'
        ),
    })
    unknown_0xbd50eb30: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xbd50eb30, original_name='Unknown'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct280Json", data)
        return cls(
            unknown_0x968337ab=json_data['unknown_0x968337ab'],
            unknown_0x8308e359=json_data['unknown_0x8308e359'],
            unknown_0x5f86d272=json_data['unknown_0x5f86d272'],
            unknown_0xbd50eb30=json_data['unknown_0xbd50eb30'],
