...
if typing.TYPE_CHECKING:
    class SuspensionBridgeJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        collision_model: int
        animation: json_util.JsonObject
        fsmc: int
        suspension_bridge_data: json_util.JsonObject
...
class SuspensionBridge(BaseObjectType):
    ...
    suspension_bridge_data: SuspensionBridgeData = dataclasses.field(default_factory=SuspensionBridgeData, metadata={
        'reflection': FieldReflection[SuspensionBridgeData](
            SuspensionBridgeData, id=0xe5999965, original_name='SuspensionBridgeData', from_json=SuspensionBridgeData.from_json, to_json=SuspensionBridgeData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, collision_model, animation, fsmc, suspension_bridge_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SuspensionBridgeJson", data)
        return cls(
            ...
            fsmc=json_data['fsmc'],
            suspension_bridge_data=SuspensionBridgeData.from_json(json_data['suspension_bridge_data']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xe5999965: ('suspension_bridge_data', SuspensionBridgeData.from_stream),
}
