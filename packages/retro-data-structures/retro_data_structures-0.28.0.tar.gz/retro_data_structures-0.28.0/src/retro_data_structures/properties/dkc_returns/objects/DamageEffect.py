...
if typing.TYPE_CHECKING:
    class DamageEffectJson(typing_extensions.TypedDict):
...
class DamageEffect(BaseObjectType):
    ...
    damage_effect_data: DamageEffectData = dataclasses.field(default_factory=DamageEffectData, metadata={
        'reflection': FieldReflection[DamageEffectData](
            DamageEffectData, id=0xeaf272dd, original_name='DamageEffectData', from_json=DamageEffectData.from_json, to_json=DamageEffectData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, damage_effect_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("DamageEffectJson", data)
        return cls(
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xeaf272dd: ('damage_effect_data', DamageEffectData.from_stream),
}
