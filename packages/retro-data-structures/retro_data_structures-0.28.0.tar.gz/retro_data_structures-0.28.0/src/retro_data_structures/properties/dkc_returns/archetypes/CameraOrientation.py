...
class CameraOrientation(BaseProperty):
    ...
    look_at_type: enums.LookAtType = dataclasses.field(default=enums.LookAtType.Unknown1, metadata={
        'reflection': FieldReflection[enums.LookAtType](
            enums.LookAtType, id=0x44191fb8, original_name='LookAtType', from_json=enums.LookAtType.from_json, to_json=enums.LookAtType.to_json
        ),
    })
    ...
    distance_direction_method: enums.DistanceDirectionMethod = dataclasses.field(default=enums.DistanceDirectionMethod.Unknown1, metadata={
        'reflection': FieldReflection[enums.DistanceDirectionMethod](
            enums.DistanceDirectionMethod, id=0x10e7121b, original_name='DistanceDirectionMethod', from_json=enums.DistanceDirectionMethod.from_json, to_json=enums.DistanceDirectionMethod.to_json
        ),
    })
    ...
    unknown_struct13: UnknownStruct13 = dataclasses.field(default_factory=UnknownStruct13, metadata={
        'reflection': FieldReflection[UnknownStruct13](
            UnknownStruct13, id=0x0e1f2094, original_name='UnknownStruct13', from_json=UnknownStruct13.from_json, to_json=UnknownStruct13.to_json
        ),
    })
    ...
    unknown_struct74: UnknownStruct74 = dataclasses.field(default_factory=UnknownStruct74, metadata={
        'reflection': FieldReflection[UnknownStruct74](
            UnknownStruct74, id=0xf6bb44ea, original_name='UnknownStruct74', from_json=UnknownStruct74.from_json, to_json=UnknownStruct74.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(orientation_type, flags_orientation, look_at_type, locator_name, pitch_angle, target_path_determination, distance, distance_direction_method, look_at_motion, look_at_offset, target_control_spline, unknown_struct13, spindle_orientation, surface_orientation, unknown_struct74)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            look_at_type=enums.LookAtType.from_json(json_data['look_at_type']),
            ...
            distance_direction_method=enums.DistanceDirectionMethod.from_json(json_data['distance_direction_method']),
            ...
            unknown_struct74=UnknownStruct74.from_json(json_data['unknown_struct74']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xe1f2094: ('unknown_struct13', UnknownStruct13.from_stream),
    ...
    0xf6bb44ea: ('unknown_struct74', UnknownStruct74.from_stream),
}
