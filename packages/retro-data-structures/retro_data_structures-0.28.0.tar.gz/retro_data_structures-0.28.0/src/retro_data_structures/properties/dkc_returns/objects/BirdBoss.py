...
if typing.TYPE_CHECKING:
    class BirdBossJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        bird_boss_data: json_util.JsonObject
...
class BirdBoss(BaseObjectType):
    ...
    bird_boss_data: BirdBossData = dataclasses.field(default_factory=BirdBossData, metadata={
        'reflection': FieldReflection[BirdBossData](
            BirdBossData, id=0x552f7242, original_name='BirdBossData', from_json=BirdBossData.from_json, to_json=BirdBossData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, bird_boss_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("BirdBossJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            bird_boss_data=BirdBossData.from_json(json_data['bird_boss_data']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x552f7242: ('bird_boss_data', BirdBossData.from_stream),
}
