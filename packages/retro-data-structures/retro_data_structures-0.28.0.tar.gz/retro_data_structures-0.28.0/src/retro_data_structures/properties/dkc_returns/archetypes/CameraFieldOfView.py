...
class CameraFieldOfView(BaseProperty):
    ...
    unknown_0x69acc94a: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0x69acc94a, original_name='Unknown'
        ),
    })
    fov_path_object: enums.FOVPathObject = dataclasses.field(default=enums.FOVPathObject.Unknown1, metadata={
        'reflection': FieldReflection[enums.FOVPathObject](
            enums.FOVPathObject, id=0xd1e91886, original_name='FOVPathObject', from_json=enums.FOVPathObject.from_json, to_json=enums.FOVPathObject.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(fov_type, unknown_0x69acc94a, fov_path_object, desired_fov, unknown_0x972c0e20, unknown_0x812cf888)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0x69acc94a=json_data['unknown_0x69acc94a'],
            fov_path_object=enums.FOVPathObject.from_json(json_data['fov_path_object']),
