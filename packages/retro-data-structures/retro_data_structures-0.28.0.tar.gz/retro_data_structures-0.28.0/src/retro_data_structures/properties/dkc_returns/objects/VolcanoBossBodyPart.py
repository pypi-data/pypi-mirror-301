...
if typing.TYPE_CHECKING:
    class VolcanoBossBodyPartJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        shadow_data: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct296: json_util.JsonObject
...
class VolcanoBossBodyPart(BaseObjectType):
    ...
    unknown_struct296: UnknownStruct296 = dataclasses.field(default_factory=UnknownStruct296, metadata={
        'reflection': FieldReflection[UnknownStruct296](
            UnknownStruct296, id=0x84506963, original_name='UnknownStruct296', from_json=UnknownStruct296.from_json, to_json=UnknownStruct296.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, shadow_data, actor_information, patterned, unknown_struct296)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("VolcanoBossBodyPartJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            shadow_data=ShadowData.from_json(json_data['shadow_data']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct296=UnknownStruct296.from_json(json_data['unknown_struct296']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x84506963: ('unknown_struct296', UnknownStruct296.from_stream),
}
