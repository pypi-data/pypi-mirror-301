...
if typing.TYPE_CHECKING:
    class UnknownStruct279Json(typing_extensions.TypedDict):
        unknown_0x8a58a7f8: int
        unknown_0x6f51c96b: float
...
class UnknownStruct279(BaseProperty):
    ...
    unknown_0x6f51c96b: float = dataclasses.field(default=2.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x6f51c96b, original_name='Unknown'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct279Json", data)
        return cls(
            unknown_0x8a58a7f8=json_data['unknown_0x8a58a7f8'],
            unknown_0x6f51c96b=json_data['unknown_0x6f51c96b'],
