...
if typing.TYPE_CHECKING:
    class UnknownStruct173Json(typing_extensions.TypedDict):
...
class UnknownStruct173(BaseProperty):
    ...
    music_names: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['STRG'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x1bd63859, original_name='MusicNames'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(unknown_struct29, title_strings, instruction, instruction_core, music_names, back, back_core, text_background)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct173Json", data)
        return cls(
            ...
            music_names=json_data['music_names'],
            back=json_data['back'],
