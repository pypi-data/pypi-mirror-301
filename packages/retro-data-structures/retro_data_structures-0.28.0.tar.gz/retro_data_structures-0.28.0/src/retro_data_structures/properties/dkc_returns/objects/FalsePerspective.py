...
class FalsePerspective(BaseObjectType):
    ...
    percentage_of_depth_range: float = dataclasses.field(default=0.0010000000474974513, metadata={
    ...
    unknown: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xa9d5ff48, original_name='Unknown'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, percentage_of_depth_range, near_clip_plane, far_clip_plane, unknown)
