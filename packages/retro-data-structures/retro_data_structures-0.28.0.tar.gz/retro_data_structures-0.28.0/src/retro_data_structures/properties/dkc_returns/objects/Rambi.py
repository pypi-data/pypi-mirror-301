...
if typing.TYPE_CHECKING:
    class RambiJson(typing_extensions.TypedDict):
...
class Rambi(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, shadow_data, actor_information, unknown_struct, patterned_info, kong_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("RambiJson", data)
        return cls(
