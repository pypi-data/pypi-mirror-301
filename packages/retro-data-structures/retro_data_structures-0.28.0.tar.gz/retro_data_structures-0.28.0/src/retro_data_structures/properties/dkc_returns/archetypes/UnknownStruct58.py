...
if typing.TYPE_CHECKING:
    class UnknownStruct58Json(typing_extensions.TypedDict):
        ...
        unknown_0x72d0dc87: float
        unknown_0x8686fda9: int
        unknown_0xdd6a10b1: int
        wait_time0: float
        wait_time1: float
        wait_time2: float
        wait_time3: float
...
class UnknownStruct58(BaseProperty):
    ...
    unknown_0x72d0dc87: float = dataclasses.field(default=30.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x72d0dc87, original_name='Unknown'
        ),
    })
    unknown_0x8686fda9: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0x8686fda9, original_name='Unknown'
        ),
    })
    unknown_0xdd6a10b1: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0xdd6a10b1, original_name='Unknown'
        ),
    })
    wait_time0: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x9d45fa96, original_name='WaitTime0'
        ),
    })
    wait_time1: float = dataclasses.field(default=1.5, metadata={
        'reflection': FieldReflection[float](
            float, id=0x56192933, original_name='WaitTime1'
        ),
    })
    wait_time2: float = dataclasses.field(default=2.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xd08d5b9d, original_name='WaitTime2'
        ),
    })
    wait_time3: float = dataclasses.field(default=3.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x1bd18838, original_name='WaitTime3'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0x72d0dc87=json_data['unknown_0x72d0dc87'],
            unknown_0x8686fda9=json_data['unknown_0x8686fda9'],
            unknown_0xdd6a10b1=json_data['unknown_0xdd6a10b1'],
            wait_time0=json_data['wait_time0'],
            wait_time1=json_data['wait_time1'],
            wait_time2=json_data['wait_time2'],
            wait_time3=json_data['wait_time3'],
        )
