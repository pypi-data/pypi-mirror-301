...
if typing.TYPE_CHECKING:
    class UnknownStruct109Json(typing_extensions.TypedDict):
...
class UnknownStruct109(BaseProperty):
    close_distance: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xb5d2e300, original_name='CloseDistance'
        ),
    })
    far_distance: float = dataclasses.field(default=5.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xad5b3894, original_name='FarDistance'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct109Json", data)
        return cls(
            close_distance=json_data['close_distance'],
            far_distance=json_data['far_distance'],
        )
