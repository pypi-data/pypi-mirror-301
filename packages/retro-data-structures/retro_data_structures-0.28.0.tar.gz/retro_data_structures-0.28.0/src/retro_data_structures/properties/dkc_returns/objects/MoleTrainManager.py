...
if typing.TYPE_CHECKING:
    class MoleTrainManagerJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        fsmc: int
        unknown_struct240: json_util.JsonObject
...
class MoleTrainManager(BaseObjectType):
    ...
    unknown_struct240: UnknownStruct240 = dataclasses.field(default_factory=UnknownStruct240, metadata={
        'reflection': FieldReflection[UnknownStruct240](
            UnknownStruct240, id=0xeacc7ed2, original_name='UnknownStruct240', from_json=UnknownStruct240.from_json, to_json=UnknownStruct240.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, fsmc, unknown_struct240)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("MoleTrainManagerJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            fsmc=json_data['fsmc'],
            unknown_struct240=UnknownStruct240.from_json(json_data['unknown_struct240']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xeacc7ed2: ('unknown_struct240', UnknownStruct240.from_stream),
}
