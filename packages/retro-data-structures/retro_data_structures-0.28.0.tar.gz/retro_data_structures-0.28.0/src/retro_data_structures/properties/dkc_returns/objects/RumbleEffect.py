...
class RumbleEffect(BaseObjectType):
    ...
    flags_rumble: int = dataclasses.field(default=240, metadata={
        'reflection': FieldReflection[int](
            int, id=0x4f7fec39, original_name='FlagsRumble'
        ),
    })
    effect: enums.Effect = dataclasses.field(default=enums.Effect.Unknown1, metadata={
        'reflection': FieldReflection[enums.Effect](
            enums.Effect, id=0x295d238b, original_name='Effect', from_json=enums.Effect.from_json, to_json=enums.Effect.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, flags_rumble, effect, unknown, radius)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            effect=enums.Effect.from_json(json_data['effect']),
