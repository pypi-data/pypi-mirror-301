...
class RagDollData(BaseProperty):
    ...
    damp_rotation: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xa99a0e33, original_name='DampRotation'
        ),
    })
    ignore_max_time: bool = dataclasses.field(default=True, metadata={
        'reflection': FieldReflection[bool](
    ...
    ignore_all_collision: bool = dataclasses.field(default=True, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xe1107c4a, original_name='IgnoreAllCollision'
        ),
    })
    collision_type: int = dataclasses.field(default=2418955086, metadata={
