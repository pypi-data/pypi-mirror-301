...
if typing.TYPE_CHECKING:
    class UnknownStruct88Json(typing_extensions.TypedDict):
...
class UnknownStruct88(BaseProperty):
    transition_time: float = dataclasses.field(default=0.5, metadata={
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct88Json", data)
        return cls(
