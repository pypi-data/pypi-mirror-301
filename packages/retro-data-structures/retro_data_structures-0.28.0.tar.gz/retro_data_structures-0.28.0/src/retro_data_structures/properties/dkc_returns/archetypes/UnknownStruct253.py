...
if typing.TYPE_CHECKING:
    class UnknownStruct253Json(typing_extensions.TypedDict):
        dummy: float
...
class UnknownStruct253(BaseProperty):
    dummy: float = dataclasses.field(default=2.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xb335db07, original_name='Dummy'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct253Json", data)
        return cls(
