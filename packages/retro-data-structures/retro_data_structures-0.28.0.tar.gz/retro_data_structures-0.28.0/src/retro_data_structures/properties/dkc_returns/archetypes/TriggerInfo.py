...
if typing.TYPE_CHECKING:
    class TriggerInfoJson(typing_extensions.TypedDict):
        ...
        near_visible_range: float
    

@dataclasses.dataclass()
class TriggerInfo(BaseProperty):
    unknown_0x97c0611f: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0x97c0611f, original_name='Unknown'
        ),
    })
    unknown_0x50224907: int = dataclasses.field(default=128, metadata={
        'reflection': FieldReflection[int](
            int, id=0x50224907, original_name='Unknown'
        ),
    })
    unknown_0x7150d7f8: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x7150d7f8, original_name='Unknown'
        ),
    })
    ...
    max_target_speed: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xcb28e973, original_name='MaxTargetSpeed'
        ),
    })
    near_visible_range: float = dataclasses.field(default=10.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x9979f60b, original_name='NearVisibleRange'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(unknown_0x97c0611f, unknown_0x50224907, unknown_0x7150d7f8, unknown_0x46cc1b48, damage_spline, damage, force_field, max_target_speed, near_visible_range)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0x7150d7f8=json_data['unknown_0x7150d7f8'],
            ...
            max_target_speed=json_data['max_target_speed'],
            near_visible_range=json_data['near_visible_range'],
        )
