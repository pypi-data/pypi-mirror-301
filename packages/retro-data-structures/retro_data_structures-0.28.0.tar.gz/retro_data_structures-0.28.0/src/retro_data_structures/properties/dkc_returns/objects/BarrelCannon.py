...
if typing.TYPE_CHECKING:
    class BarrelCannonJson(typing_extensions.TypedDict):
...
class BarrelCannon(BaseObjectType):
    ...
    barrel_cannon_data: BarrelCannonData = dataclasses.field(default_factory=BarrelCannonData, metadata={
        'reflection': FieldReflection[BarrelCannonData](
            BarrelCannonData, id=0xf04c61f3, original_name='BarrelCannonData', from_json=BarrelCannonData.from_json, to_json=BarrelCannonData.to_json
        ),
    })
    unknown_0xfaf13d08: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xfaf13d08, original_name='Unknown'
        ),
    })
    unknown_struct22: UnknownStruct22 = dataclasses.field(default_factory=UnknownStruct22, metadata={
        'reflection': FieldReflection[UnknownStruct22](
            UnknownStruct22, id=0xc9d225c7, original_name='UnknownStruct22', from_json=UnknownStruct22.from_json, to_json=UnknownStruct22.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, collision_box, collision_offset, model, animation, fsmc, actor_information, collision_model, health, maximum_splashes, splash_generation_rate, render_rain_splashes, unknown_0xf203bc81, motion_properties, unknown_0x24fdeea1, random_animation_offset, unknown_0x6b5e87a7, look_at_velocity, barrel_cannon_data, unknown_0xfaf13d08, unknown_struct22)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("BarrelCannonJson", data)
        return cls(
            ...
            barrel_cannon_data=BarrelCannonData.from_json(json_data['barrel_cannon_data']),
            unknown_0xfaf13d08=json_data['unknown_0xfaf13d08'],
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xf04c61f3: ('barrel_cannon_data', BarrelCannonData.from_stream),
    0xfaf13d08: ('unknown_0xfaf13d08', _decode_unknown_0xfaf13d08),
    0xc9d225c7: ('unknown_struct22', UnknownStruct22.from_stream),
}
