...
class PathPosition(BaseProperty):
    ...
    initial_position: enums.InitialPosition = dataclasses.field(default=enums.InitialPosition.Unknown1, metadata={
        'reflection': FieldReflection[enums.InitialPosition](
            enums.InitialPosition, id=0x340e4ca3, original_name='InitialPosition', from_json=enums.InitialPosition.from_json, to_json=enums.InitialPosition.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(flags_path_position, initial_position, path_determination, distance, dampen_distance, convergence, motion_control_spline, unknown, unknown_struct13)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            initial_position=enums.InitialPosition.from_json(json_data['initial_position']),
