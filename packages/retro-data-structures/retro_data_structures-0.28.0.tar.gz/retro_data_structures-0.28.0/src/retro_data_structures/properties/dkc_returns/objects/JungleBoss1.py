...
if typing.TYPE_CHECKING:
    class JungleBoss1Json(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        shadow_data: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct208: json_util.JsonObject
...
class JungleBoss1(BaseObjectType):
    ...
    unknown_struct208: UnknownStruct208 = dataclasses.field(default_factory=UnknownStruct208, metadata={
        'reflection': FieldReflection[UnknownStruct208](
            UnknownStruct208, id=0x16212198, original_name='UnknownStruct208', from_json=UnknownStruct208.from_json, to_json=UnknownStruct208.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, shadow_data, actor_information, patterned, unknown_struct208)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("JungleBoss1Json", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            shadow_data=ShadowData.from_json(json_data['shadow_data']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct208=UnknownStruct208.from_json(json_data['unknown_struct208']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x16212198: ('unknown_struct208', UnknownStruct208.from_stream),
}
