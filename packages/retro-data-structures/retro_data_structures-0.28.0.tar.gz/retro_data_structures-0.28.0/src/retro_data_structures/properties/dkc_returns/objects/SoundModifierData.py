...
if typing.TYPE_CHECKING:
    class SoundModifierDataJson(typing_extensions.TypedDict):
        ...
        auto_start: bool
        loop: bool
        loop_platform_contribution: bool
        invert_platform_contribution: bool
...
class SoundModifierData(BaseObjectType):
    ...
    loop_platform_contribution: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xa0939845, original_name='LoopPlatformContribution'
        ),
    })
    invert_platform_contribution: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x562d6122, original_name='InvertPlatformContribution'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, time, fade_in_time, fade_out_time, auto_start, loop, loop_platform_contribution, invert_platform_contribution, volume, pan, surround_pan, pitch, low_pass)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SoundModifierDataJson", data)
        return cls(
            ...
            loop=json_data['loop'],
            loop_platform_contribution=json_data['loop_platform_contribution'],
            invert_platform_contribution=json_data['invert_platform_contribution'],
