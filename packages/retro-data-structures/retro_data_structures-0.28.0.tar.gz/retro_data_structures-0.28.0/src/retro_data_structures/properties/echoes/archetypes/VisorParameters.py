...
class VisorParameters(BaseProperty):
    ...
    visor_flags: enums.VisorFlags = dataclasses.field(default=enums.VisorFlags(15), metadata={
        'reflection': FieldReflection[enums.VisorFlags](
            enums.VisorFlags, id=0xca19e8c6, original_name='VisorFlags', from_json=enums.VisorFlags.from_json, to_json=enums.VisorFlags.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            visor_flags=enums.VisorFlags.from_json(json_data['visor_flags']),
        )
