...
class DarkCommando(BaseObjectType):
    ...
    dark_commando_properties: DarkCommandoData = dataclasses.field(default_factory=DarkCommandoData, metadata={
        'reflection': FieldReflection[DarkCommandoData](
            DarkCommandoData, id=0x89400baa, original_name='DarkCommandoProperties', from_json=DarkCommandoData.from_json, to_json=DarkCommandoData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x89400baa: ('dark_commando_properties', DarkCommandoData.from_stream),
}
