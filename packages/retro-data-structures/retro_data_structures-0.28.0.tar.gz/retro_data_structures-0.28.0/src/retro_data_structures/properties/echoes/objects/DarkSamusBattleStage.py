...
class DarkSamusBattleStage(BaseObjectType):
    ...
    unknown_struct17: UnknownStruct17 = dataclasses.field(default_factory=UnknownStruct17, metadata={
        'reflection': FieldReflection[UnknownStruct17](
            UnknownStruct17, id=0xd83caab6, original_name='UnknownStruct17', from_json=UnknownStruct17.from_json, to_json=UnknownStruct17.to_json
        ),
    })
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct17.dependencies_for, "unknown_struct17", "UnknownStruct17"),
        ]:
            try:
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xd83caab6: ('unknown_struct17', UnknownStruct17.from_stream),
}
