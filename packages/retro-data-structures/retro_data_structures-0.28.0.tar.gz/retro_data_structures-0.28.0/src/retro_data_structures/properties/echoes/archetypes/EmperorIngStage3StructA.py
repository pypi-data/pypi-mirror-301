...
class EmperorIngStage3StructA(BaseProperty):
    ...
    beam_sound: int = dataclasses.field(default=0, metadata={
        'sound': True, 'reflection': FieldReflection[int](
            int, id=0xf6f185d6, original_name='BeamSound'
        ),
    })
    ...
    def _dependencies_for_beam_sound(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
