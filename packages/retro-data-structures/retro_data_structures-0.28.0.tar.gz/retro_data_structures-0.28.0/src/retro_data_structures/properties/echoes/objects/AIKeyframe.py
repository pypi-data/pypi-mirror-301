...
class AIKeyframe(BaseObjectType):
    ...
    unknown_0x58810503: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0x58810503, original_name='Unknown'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, animation_index, loop, loop_duration, unknown_0x58810503, unknown_0x6d62ef74, playback_rate)
