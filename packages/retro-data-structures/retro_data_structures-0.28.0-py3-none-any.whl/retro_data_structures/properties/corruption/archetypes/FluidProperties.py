...
class FluidProperties(BaseProperty):
    fluid_type: enums.FluidType = dataclasses.field(default=enums.FluidType.Unknown1, metadata={
        'reflection': FieldReflection[enums.FluidType](
            enums.FluidType, id=0xbe253b54, original_name='FluidType', from_json=enums.FluidType.from_json, to_json=enums.FluidType.to_json
        ),
    })
    ...
    bloom: enums.Bloom = dataclasses.field(default=enums.Bloom.Unknown1, metadata={
        'reflection': FieldReflection[enums.Bloom](
            enums.Bloom, id=0xa4d23616, original_name='Bloom', from_json=enums.Bloom.from_json, to_json=enums.Bloom.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            fluid_type=enums.FluidType.from_json(json_data['fluid_type']),
            ...
            bloom=enums.Bloom.from_json(json_data['bloom']),
