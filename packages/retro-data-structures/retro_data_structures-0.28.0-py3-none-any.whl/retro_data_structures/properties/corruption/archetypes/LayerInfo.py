...
class LayerInfo(BaseProperty):
    motion_type: int = dataclasses.field(default=864275068, metadata={
    ...
    amplitude: float = dataclasses.field(default=0.15000000596046448, metadata={
        'reflection': FieldReflection[float](
            float, id=0x89e3d294, original_name='Amplitude'
        ),
    })
    texture_scale: float = dataclasses.field(default=10.0, metadata={
        'reflection': FieldReflection[float](
