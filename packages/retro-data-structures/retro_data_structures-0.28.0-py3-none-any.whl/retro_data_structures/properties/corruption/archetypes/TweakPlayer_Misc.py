...
class TweakPlayer_Misc(BaseProperty):
    ...
    unknown_0xfb909bc3: float = dataclasses.field(default=5.0, metadata={
        'reflection': FieldReflection[float](
    ...
    unknown_0x88297760: bool = dataclasses.field(default=True, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x88297760, original_name='Unknown'
        ),
    })
