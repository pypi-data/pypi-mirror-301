...
class DebrisPropertiesOrientationEnum(BaseProperty):
    orientation: enums.UnknownEnum1 = dataclasses.field(default=enums.UnknownEnum1.Unknown1, metadata={
        'reflection': FieldReflection[enums.UnknownEnum1](
            enums.UnknownEnum1, id=0xf4bf6637, original_name='Orientation', from_json=enums.UnknownEnum1.from_json, to_json=enums.UnknownEnum1.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            orientation=enums.UnknownEnum1.from_json(json_data['orientation']),
        )
