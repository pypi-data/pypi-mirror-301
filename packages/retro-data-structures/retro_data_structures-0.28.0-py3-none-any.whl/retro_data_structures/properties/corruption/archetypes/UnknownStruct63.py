...
class UnknownStruct63(BaseProperty):
    unknown_0x04131a2a: enums.Unknown = dataclasses.field(default=enums.Unknown.Unknown1, metadata={
        'reflection': FieldReflection[enums.Unknown](
            enums.Unknown, id=0x04131a2a, original_name='Unknown', from_json=enums.Unknown.from_json, to_json=enums.Unknown.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            unknown_0x04131a2a=enums.Unknown.from_json(json_data['unknown_0x04131a2a']),
