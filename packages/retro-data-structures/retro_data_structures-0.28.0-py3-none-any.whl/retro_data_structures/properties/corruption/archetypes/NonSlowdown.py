...
class NonSlowdown(BaseProperty):
    path_shape: PathType = dataclasses.field(default_factory=PathType, metadata={
        'reflection': FieldReflection[PathType](
            PathType, id=0x7fcd6908, original_name='PathShape', from_json=PathType.from_json, to_json=PathType.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    0x7fcd6908: ('path_shape', PathType.from_stream),
}
