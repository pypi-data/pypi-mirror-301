...
class BonusCredit(BaseProperty):
    bonus_credit: enums.BonusCredit = dataclasses.field(default=enums.BonusCredit.Unknown5, metadata={
        'reflection': FieldReflection[enums.BonusCredit](
            enums.BonusCredit, id=0xff5de1da, original_name='BonusCredit', from_json=enums.BonusCredit.from_json, to_json=enums.BonusCredit.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            bonus_credit=enums.BonusCredit.from_json(json_data['bonus_credit']),
        )
