...
class ColliderPosition(BaseProperty):
    collider_position_type: enums.ColliderPositionType = dataclasses.field(default=enums.ColliderPositionType.Unknown1, metadata={
        'reflection': FieldReflection[enums.ColliderPositionType](
            enums.ColliderPositionType, id=0xe2ae470c, original_name='ColliderPositionType', from_json=enums.ColliderPositionType.from_json, to_json=enums.ColliderPositionType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            collider_position_type=enums.ColliderPositionType.from_json(json_data['collider_position_type']),
