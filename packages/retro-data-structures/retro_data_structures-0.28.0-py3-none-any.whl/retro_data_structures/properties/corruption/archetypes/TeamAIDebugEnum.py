...
class TeamAIDebugEnum(BaseProperty):
    team_ai_state: enums.TeamAIState = dataclasses.field(default=enums.TeamAIState.Unknown1, metadata={
        'reflection': FieldReflection[enums.TeamAIState](
            enums.TeamAIState, id=0x94d97b5a, original_name='TeamAIState', from_json=enums.TeamAIState.from_json, to_json=enums.TeamAIState.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            team_ai_state=enums.TeamAIState.from_json(json_data['team_ai_state']),
        )
