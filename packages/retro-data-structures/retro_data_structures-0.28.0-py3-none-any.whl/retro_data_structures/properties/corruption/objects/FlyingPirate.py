...
class FlyingPirate(BaseObjectType):
    ...
    flying_pirate_properties: FlyingPirateData = dataclasses.field(default_factory=FlyingPirateData, metadata={
        'reflection': FieldReflection[FlyingPirateData](
            FlyingPirateData, id=0xb327e803, original_name='FlyingPirateProperties', from_json=FlyingPirateData.from_json, to_json=FlyingPirateData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xb327e803: ('flying_pirate_properties', FlyingPirateData.from_stream),
}
