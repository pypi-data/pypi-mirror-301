...
class PhazonPuffer(BaseObjectType):
    ...
    unknown_struct51: UnknownStruct51 = dataclasses.field(default_factory=UnknownStruct51, metadata={
        'reflection': FieldReflection[UnknownStruct51](
            UnknownStruct51, id=0x1be8b2db, original_name='UnknownStruct51', from_json=UnknownStruct51.from_json, to_json=UnknownStruct51.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x1be8b2db: ('unknown_struct51', UnknownStruct51.from_stream),
}
