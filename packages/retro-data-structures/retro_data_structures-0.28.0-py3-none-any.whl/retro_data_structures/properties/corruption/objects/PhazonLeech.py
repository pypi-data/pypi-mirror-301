...
class PhazonLeech(BaseObjectType):
    ...
    phazon_leech_data: PhazonLeechData = dataclasses.field(default_factory=PhazonLeechData, metadata={
        'reflection': FieldReflection[PhazonLeechData](
            PhazonLeechData, id=0xca34b83e, original_name='PhazonLeechData', from_json=PhazonLeechData.from_json, to_json=PhazonLeechData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xca34b83e: ('phazon_leech_data', PhazonLeechData.from_stream),
