...
class SeedBoss1Orb(BaseObjectType):
    ...
    seed_boss1_orb_data: SeedBoss1OrbData = dataclasses.field(default_factory=SeedBoss1OrbData, metadata={
        'reflection': FieldReflection[SeedBoss1OrbData](
            SeedBoss1OrbData, id=0xee53ebe7, original_name='SeedBoss1OrbData', from_json=SeedBoss1OrbData.from_json, to_json=SeedBoss1OrbData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xee53ebe7: ('seed_boss1_orb_data', SeedBoss1OrbData.from_stream),
}
