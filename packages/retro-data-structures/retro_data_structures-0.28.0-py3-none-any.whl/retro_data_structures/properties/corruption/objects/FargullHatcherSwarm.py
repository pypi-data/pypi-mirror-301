...
class FargullHatcherSwarm(BaseObjectType):
    ...
    fargull_hatcher_swarm_data: FargullHatcherSwarmData = dataclasses.field(default_factory=FargullHatcherSwarmData, metadata={
        'reflection': FieldReflection[FargullHatcherSwarmData](
            FargullHatcherSwarmData, id=0x146f75d9, original_name='FargullHatcherSwarmData', from_json=FargullHatcherSwarmData.from_json, to_json=FargullHatcherSwarmData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, character_animation_information, active, swarm_basics_data, flyer_swarm_data, fargull_hatcher_swarm_data)
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x146f75d9: ('fargull_hatcher_swarm_data', FargullHatcherSwarmData.from_stream),
}
