...
class SeedBoss1(BaseObjectType):
    ...
    data: SeedBoss1Data = dataclasses.field(default_factory=SeedBoss1Data, metadata={
        'reflection': FieldReflection[SeedBoss1Data](
            SeedBoss1Data, id=0xf6e66110, original_name='Data', from_json=SeedBoss1Data.from_json, to_json=SeedBoss1Data.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        data_ = SeedBoss1Data.from_stream(data, property_size)
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xf6e66110: ('data', SeedBoss1Data.from_stream),
}
