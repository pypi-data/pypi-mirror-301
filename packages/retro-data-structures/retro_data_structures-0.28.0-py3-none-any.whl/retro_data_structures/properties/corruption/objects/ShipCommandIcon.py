...
class ShipCommandIcon(BaseObjectType):
    ...
    necessary_upgrade: enums.PlayerItem = dataclasses.field(default=enums.PlayerItem.PowerBeam, metadata={
        'reflection': FieldReflection[enums.PlayerItem](
            enums.PlayerItem, id=0x08072da5, original_name='NecessaryUpgrade', from_json=enums.PlayerItem.from_json, to_json=enums.PlayerItem.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            necessary_upgrade=enums.PlayerItem.from_json(json_data['necessary_upgrade']),
