...
class SwarmBot(BaseObjectType):
    ...
    swarm_bot_properties: SwarmBotData = dataclasses.field(default_factory=SwarmBotData, metadata={
        'reflection': FieldReflection[SwarmBotData](
            SwarmBotData, id=0x3fa5c15b, original_name='SwarmBotProperties', from_json=SwarmBotData.from_json, to_json=SwarmBotData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x3fa5c15b: ('swarm_bot_properties', SwarmBotData.from_stream),
}
