...
class PirateDrone(BaseObjectType):
    ...
    pirate_drone_data: PirateDroneData = dataclasses.field(default_factory=PirateDroneData, metadata={
        'reflection': FieldReflection[PirateDroneData](
            PirateDroneData, id=0x16e8d4e8, original_name='PirateDroneData', from_json=PirateDroneData.from_json, to_json=PirateDroneData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x16e8d4e8: ('pirate_drone_data', PirateDroneData.from_stream),
