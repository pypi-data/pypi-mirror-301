...
if typing.TYPE_CHECKING:
    class UnknownStruct85Json(typing_extensions.TypedDict):
        start_hidden: bool
        minimum_hide_time: float
        maximum_hide_time: float
...
class UnknownStruct85(BaseProperty):
    start_hidden: bool = dataclasses.field(default=True, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x4def7b9b, original_name='StartHidden'
        ),
    })
    minimum_hide_time: float = dataclasses.field(default=0.5, metadata={
        'reflection': FieldReflection[float](
            float, id=0xcc7d17d6, original_name='MinimumHideTime'
        ),
    })
    maximum_hide_time: float = dataclasses.field(default=1.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xe503eace, original_name='MaximumHideTime'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct85Json", data)
        return cls(
            start_hidden=json_data['start_hidden'],
            minimum_hide_time=json_data['minimum_hide_time'],
            maximum_hide_time=json_data['maximum_hide_time'],
        )
