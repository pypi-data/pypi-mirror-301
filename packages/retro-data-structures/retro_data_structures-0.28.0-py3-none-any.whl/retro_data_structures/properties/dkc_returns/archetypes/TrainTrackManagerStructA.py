...
if typing.TYPE_CHECKING:
    class TrainTrackManagerStructAJson(typing_extensions.TypedDict):
        weight: float
...
class TrainTrackManagerStructA(BaseProperty):
    weight: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xffb03300, original_name='Weight'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("TrainTrackManagerStructAJson", data)
        return cls(
