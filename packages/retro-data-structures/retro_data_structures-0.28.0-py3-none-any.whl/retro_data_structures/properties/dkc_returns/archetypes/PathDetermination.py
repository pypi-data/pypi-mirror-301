...
class PathDetermination(BaseProperty):
    path_link_type: enums.PathLinkType = dataclasses.field(default=enums.PathLinkType.Unknown3, metadata={
        'reflection': FieldReflection[enums.PathLinkType](
            enums.PathLinkType, id=0x559542ab, original_name='PathLinkType', from_json=enums.PathLinkType.from_json, to_json=enums.PathLinkType.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            path_link_type=enums.PathLinkType.from_json(json_data['path_link_type']),
