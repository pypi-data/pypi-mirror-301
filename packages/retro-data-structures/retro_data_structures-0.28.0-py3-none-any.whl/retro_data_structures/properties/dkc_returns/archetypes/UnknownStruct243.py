...
if typing.TYPE_CHECKING:
    class UnknownStruct243Json(typing_extensions.TypedDict):
        dummy: bool
...
class UnknownStruct243(BaseProperty):
    dummy: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0xa0347c3f, original_name='Dummy'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct243Json", data)
        return cls(
            dummy=json_data['dummy'],
        )
