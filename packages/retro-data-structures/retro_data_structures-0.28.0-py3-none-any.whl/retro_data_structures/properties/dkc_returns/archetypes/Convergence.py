...
class Convergence(BaseProperty):
    convergence_type: enums.ConvergenceType = dataclasses.field(default=enums.ConvergenceType.Unknown4, metadata={
        'reflection': FieldReflection[enums.ConvergenceType](
            enums.ConvergenceType, id=0x2ef22401, original_name='ConvergenceType', from_json=enums.ConvergenceType.from_json, to_json=enums.ConvergenceType.to_json
        ),
    })
    ...
    unknown_struct66: UnknownStruct66 = dataclasses.field(default_factory=UnknownStruct66, metadata={
        'reflection': FieldReflection[UnknownStruct66](
            UnknownStruct66, id=0x1ff47ddf, original_name='UnknownStruct66', from_json=UnknownStruct66.from_json, to_json=UnknownStruct66.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(convergence_type, velocity, unknown_struct66, spring, pid, proportional)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            convergence_type=enums.ConvergenceType.from_json(json_data['convergence_type']),
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x1ff47ddf: ('unknown_struct66', UnknownStruct66.from_stream),
