...
if typing.TYPE_CHECKING:
    class UnknownStruct23Json(typing_extensions.TypedDict):
        ...
        unknown_0xfc764233: float
        unknown_0xe29028fc: float
...
class UnknownStruct23(BaseProperty):
    unknown_0xf228ec53: float = dataclasses.field(default=3.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xf228ec53, original_name='Unknown'
        ),
    })
    unknown_0xd91227f1: float = dataclasses.field(default=7.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xd91227f1, original_name='Unknown'
        ),
    })
    unknown_0xfc764233: float = dataclasses.field(default=0.5, metadata={
        'reflection': FieldReflection[float](
            float, id=0xfc764233, original_name='Unknown'
        ),
    })
    unknown_0xe29028fc: float = dataclasses.field(default=10.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xe29028fc, original_name='Unknown'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0xfc764233=json_data['unknown_0xfc764233'],
            unknown_0xe29028fc=json_data['unknown_0xe29028fc'],
        )
