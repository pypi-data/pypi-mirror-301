...
class NonSlowdown(BaseProperty):
    path_shape: AreaPathStructA = dataclasses.field(default_factory=AreaPathStructA, metadata={
        'reflection': FieldReflection[AreaPathStructA](
            AreaPathStructA, id=0x7fcd6908, original_name='PathShape', from_json=AreaPathStructA.from_json, to_json=AreaPathStructA.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            path_shape=AreaPathStructA.from_json(json_data['path_shape']),
        )
