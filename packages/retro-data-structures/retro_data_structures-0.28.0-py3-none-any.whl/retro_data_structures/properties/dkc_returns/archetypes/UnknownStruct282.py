...
if typing.TYPE_CHECKING:
    class UnknownStruct282Json(typing_extensions.TypedDict):
        unknown_0x968337ab: int
        unknown_0x8308e359: int
        unknown_0x9b4f1416: float
...
class UnknownStruct282(BaseProperty):
    unknown_0x968337ab: int = dataclasses.field(default=3, metadata={
        'reflection': FieldReflection[int](
            int, id=0x968337ab, original_name='Unknown'
        ),
    })
    unknown_0x8308e359: int = dataclasses.field(default=5, metadata={
        'reflection': FieldReflection[int](
            int, id=0x8308e359, original_name='Unknown'
        ),
    })
    unknown_0x9b4f1416: float = dataclasses.field(default=0.5, metadata={
        'reflection': FieldReflection[float](
            float, id=0x9b4f1416, original_name='Unknown'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("UnknownStruct282Json", data)
        return cls(
            unknown_0x968337ab=json_data['unknown_0x968337ab'],
            unknown_0x8308e359=json_data['unknown_0x8308e359'],
            unknown_0x9b4f1416=json_data['unknown_0x9b4f1416'],
        )
