...
if typing.TYPE_CHECKING:
    class MusicModifierJson(typing_extensions.TypedDict):
...
class MusicModifier(BaseObjectType):
    ...
    fade_up_time: float = dataclasses.field(default=0.25, metadata={
        'reflection': FieldReflection[float](
            float, id=0x0d21d348, original_name='FadeUpTime'
        ),
    })
    fade_down_time: float = dataclasses.field(default=0.25, metadata={
        'reflection': FieldReflection[float](
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("MusicModifierJson", data)
        return cls(
