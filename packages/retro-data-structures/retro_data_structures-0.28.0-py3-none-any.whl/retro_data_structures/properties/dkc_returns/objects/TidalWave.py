...
if typing.TYPE_CHECKING:
    class TidalWaveJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        character_animation_information: json_util.JsonObject
        actor_information: json_util.JsonObject
        tidal_wave_data: json_util.JsonObject
...
class TidalWave(BaseObjectType):
    ...
    tidal_wave_data: TidalWaveData = dataclasses.field(default_factory=TidalWaveData, metadata={
        'reflection': FieldReflection[TidalWaveData](
            TidalWaveData, id=0x8c5e15c9, original_name='TidalWaveData', from_json=TidalWaveData.from_json, to_json=TidalWaveData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, character_animation_information, actor_information, tidal_wave_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("TidalWaveJson", data)
        return cls(
            ...
            tidal_wave_data=TidalWaveData.from_json(json_data['tidal_wave_data']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x8c5e15c9: ('tidal_wave_data', TidalWaveData.from_stream),
}
