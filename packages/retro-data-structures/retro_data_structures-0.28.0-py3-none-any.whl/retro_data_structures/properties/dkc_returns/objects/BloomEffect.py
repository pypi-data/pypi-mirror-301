...
if typing.TYPE_CHECKING:
    class BloomEffectJson(typing_extensions.TypedDict):
...
class BloomEffect(BaseObjectType):
    ...
    unknown_struct65: UnknownStruct65 = dataclasses.field(default_factory=UnknownStruct65, metadata={
        'reflection': FieldReflection[UnknownStruct65](
            UnknownStruct65, id=0x882e9f47, original_name='UnknownStruct65', from_json=UnknownStruct65.from_json, to_json=UnknownStruct65.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct65)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("BloomEffectJson", data)
        return cls(
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x882e9f47: ('unknown_struct65', UnknownStruct65.from_stream),
}
