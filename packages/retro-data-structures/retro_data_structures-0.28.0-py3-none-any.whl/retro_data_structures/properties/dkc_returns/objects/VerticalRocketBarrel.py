...
if typing.TYPE_CHECKING:
    class VerticalRocketBarrelJson(typing_extensions.TypedDict):
        ...
        unknown_struct297: json_util.JsonObject
...
class VerticalRocketBarrel(BaseObjectType):
    ...
    unknown_struct297: UnknownStruct297 = dataclasses.field(default_factory=UnknownStruct297, metadata={
        'reflection': FieldReflection[UnknownStruct297](
            UnknownStruct297, id=0x45b5b754, original_name='UnknownStruct297', from_json=UnknownStruct297.from_json, to_json=UnknownStruct297.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, shadow_data, actor_information, unknown_struct, common, mount_data, rider_list_data, unknown_struct297)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("VerticalRocketBarrelJson", data)
        return cls(
            ...
            unknown_struct297=UnknownStruct297.from_json(json_data['unknown_struct297']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x45b5b754: ('unknown_struct297', UnknownStruct297.from_stream),
}
