...
class Debris(BaseObjectType):
    ...
    debris_properties: DebrisProperties = dataclasses.field(default_factory=DebrisProperties, metadata={
        'reflection': FieldReflection[DebrisProperties](
            DebrisProperties, id=0x8a1c821d, original_name='DebrisProperties', from_json=DebrisProperties.from_json, to_json=DebrisProperties.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x8a1c821d: ('debris_properties', DebrisProperties.from_stream),
}
