...
class StreamedMovie(BaseObjectType):
    ...
    is_level_reveal: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x781ba115, original_name='IsLevelReveal'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, movie_file, loop, video_filter_enabled, unknown, volume, volume_type, cache_length, fade_out_time, is_level_reveal)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            is_level_reveal=json_data['is_level_reveal'],
        )
