...
if typing.TYPE_CHECKING:
    class PilotChickenJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct243: json_util.JsonObject
...
class PilotChicken(BaseObjectType):
    ...
    unknown_struct243: UnknownStruct243 = dataclasses.field(default_factory=UnknownStruct243, metadata={
        'reflection': FieldReflection[UnknownStruct243](
            UnknownStruct243, id=0x253fa4ef, original_name='UnknownStruct243', from_json=UnknownStruct243.from_json, to_json=UnknownStruct243.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, unknown_struct243)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("PilotChickenJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct243=UnknownStruct243.from_json(json_data['unknown_struct243']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x253fa4ef: ('unknown_struct243', UnknownStruct243.from_stream),
}
