...
if typing.TYPE_CHECKING:
    class CheckpointJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        checkpoint_data: json_util.JsonObject
...
class Checkpoint(BaseObjectType):
    ...
    checkpoint_data: CheckpointData = dataclasses.field(default_factory=CheckpointData, metadata={
        'reflection': FieldReflection[CheckpointData](
            CheckpointData, id=0xb9a97fee, original_name='CheckpointData', from_json=CheckpointData.from_json, to_json=CheckpointData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, checkpoint_data, layer_list)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("CheckpointJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            checkpoint_data=CheckpointData.from_json(json_data['checkpoint_data']),
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xb9a97fee: ('checkpoint_data', CheckpointData.from_stream),
