...
if typing.TYPE_CHECKING:
    class DistanceFogJson(typing_extensions.TypedDict):
        ...
        color_rate: float
        unknown_0x685255a5: float
        unknown_0x7869a2b0: float
        force_settings: bool
        is_two_sided: bool
...
class DistanceFog(BaseObjectType):
    ...
    near_plane_distance: float = dataclasses.field(default=30.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x8fc4dbe8, original_name='NearPlaneDistance'
        ),
    })
    far_plane_distance: float = dataclasses.field(default=100.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x8bc357ff, original_name='FarPlaneDistance'
        ),
    })
    ...
    unknown_0x685255a5: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x685255a5, original_name='Unknown'
        ),
    })
    unknown_0x7869a2b0: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x7869a2b0, original_name='Unknown'
        ),
    })
    ...
    unknown_0xb7246843: Color = dataclasses.field(default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0), metadata={
        'reflection': FieldReflection[Color](
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_0x88e8d530, mode, color, near_plane_distance, far_plane_distance, color_rate, unknown_0x685255a5, unknown_0x7869a2b0, force_settings, is_two_sided, unknown_0xb7246843, vector2f_0x520d1dd5, unknown_0xbc86052a, vector2f_0xfba31a97)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            near_plane_distance=json_data['near_plane_distance'],
            far_plane_distance=json_data['far_plane_distance'],
            color_rate=json_data['color_rate'],
            unknown_0x685255a5=json_data['unknown_0x685255a5'],
            unknown_0x7869a2b0=json_data['unknown_0x7869a2b0'],
