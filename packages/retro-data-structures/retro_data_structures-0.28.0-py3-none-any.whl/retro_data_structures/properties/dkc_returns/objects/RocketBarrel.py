...
if typing.TYPE_CHECKING:
    class RocketBarrelJson(typing_extensions.TypedDict):
        ...
        unknown_struct250: json_util.JsonObject
        unknown_struct252: json_util.JsonObject
...
class RocketBarrel(BaseObjectType):
    ...
    unknown_struct250: UnknownStruct250 = dataclasses.field(default_factory=UnknownStruct250, metadata={
        'reflection': FieldReflection[UnknownStruct250](
            UnknownStruct250, id=0x15f240a8, original_name='UnknownStruct250', from_json=UnknownStruct250.from_json, to_json=UnknownStruct250.to_json
        ),
    })
    unknown_struct252: UnknownStruct252 = dataclasses.field(default_factory=UnknownStruct252, metadata={
        'reflection': FieldReflection[UnknownStruct252](
            UnknownStruct252, id=0x4a862510, original_name='UnknownStruct252', from_json=UnknownStruct252.from_json, to_json=UnknownStruct252.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, shadow_data, actor_information, unknown_struct, common, mount_data, rider_list_data, unknown_struct250, unknown_struct252)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("RocketBarrelJson", data)
        return cls(
            ...
            unknown_struct250=UnknownStruct250.from_json(json_data['unknown_struct250']),
            unknown_struct252=UnknownStruct252.from_json(json_data['unknown_struct252']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x15f240a8: ('unknown_struct250', UnknownStruct250.from_stream),
    0x4a862510: ('unknown_struct252', UnknownStruct252.from_stream),
}
