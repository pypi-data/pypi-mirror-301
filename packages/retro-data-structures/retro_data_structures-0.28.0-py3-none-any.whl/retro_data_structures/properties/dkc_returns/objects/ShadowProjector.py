...
class ShadowProjector(BaseObjectType):
    ...
    unknown_struct510: UnknownStruct510 = dataclasses.field(default_factory=UnknownStruct510, metadata={
        'reflection': FieldReflection[UnknownStruct510](
            UnknownStruct510, id=0xa21b515a, original_name='UnknownStruct510', from_json=UnknownStruct510.from_json, to_json=UnknownStruct510.to_json
        ),
    })
    unknown_0x8ce1176e: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x8ce1176e, original_name='Unknown'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, shadow_scale, shadow_offset, shadow_height, shadow_alpha, shadow_fade_time, unknown_0xbca8b742, render_in_foreground, unknown_0x606e341c, unknown_struct510, unknown_0x8ce1176e)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_struct510=UnknownStruct510.from_json(json_data['unknown_struct510']),
            unknown_0x8ce1176e=json_data['unknown_0x8ce1176e'],
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa21b515a: ('unknown_struct510', UnknownStruct510.from_stream),
