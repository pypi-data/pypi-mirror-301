...
if typing.TYPE_CHECKING:
    class TippyPlatformJson(typing_extensions.TypedDict):
...
class TippyPlatform(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, collision_box, collision_offset, actor_information, model, collision_model, animation, tippy_platform_module, motion_platform_module, unknown_struct18)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("TippyPlatformJson", data)
        return cls(
