...
if typing.TYPE_CHECKING:
    class RobotChickenJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct259: json_util.JsonObject
...
class RobotChicken(BaseObjectType):
    ...
    unknown_struct259: UnknownStruct259 = dataclasses.field(default_factory=UnknownStruct259, metadata={
        'reflection': FieldReflection[UnknownStruct259](
            UnknownStruct259, id=0x9e3b570e, original_name='UnknownStruct259', from_json=UnknownStruct259.from_json, to_json=UnknownStruct259.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, unknown_struct259)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("RobotChickenJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct259=UnknownStruct259.from_json(json_data['unknown_struct259']),
        )
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x9e3b570e: ('unknown_struct259', UnknownStruct259.from_stream),
}
