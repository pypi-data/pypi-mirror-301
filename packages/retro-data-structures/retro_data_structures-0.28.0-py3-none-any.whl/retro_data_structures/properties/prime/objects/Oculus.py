...
class Oculus(BaseObjectType):
    ...
    unnamed_0x0000000c: DamageVulnerability = dataclasses.field(default_factory=DamageVulnerability, metadata={
        'reflection': FieldReflection[DamageVulnerability](
            DamageVulnerability, id=0x0000000c, original_name=None, from_json=DamageVulnerability.from_json, to_json=DamageVulnerability.to_json
        ),
    })
    ...
    unnamed_0x0000000e: DamageInfo = dataclasses.field(default_factory=DamageInfo, metadata={
        'reflection': FieldReflection[DamageInfo](
            DamageInfo, id=0x0000000e, original_name=None, from_json=DamageInfo.from_json, to_json=DamageInfo.to_json
        ),
    })
