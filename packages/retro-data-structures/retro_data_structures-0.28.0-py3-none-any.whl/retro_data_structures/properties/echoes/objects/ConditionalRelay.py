...
class ConditionalRelay(BaseObjectType):
    ...
    multiplayer_mask_and_negate: int = dataclasses.field(default=7680, metadata={
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.conditional1.dependencies_for, "conditional1", "ConditionalTest"),
            (self.conditional2.dependencies_for, "conditional2", "ConditionalTest"),
            (self.conditional3.dependencies_for, "conditional3", "ConditionalTest"),
            (self.conditional4.dependencies_for, "conditional4", "ConditionalTest"),
        ]:
            try:
