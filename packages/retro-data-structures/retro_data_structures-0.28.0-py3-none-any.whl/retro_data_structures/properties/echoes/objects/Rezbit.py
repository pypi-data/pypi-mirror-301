...
class Rezbit(BaseObjectType):
    ...
    rezbit_data: RezbitData = dataclasses.field(default_factory=RezbitData, metadata={
        'reflection': FieldReflection[RezbitData](
            RezbitData, id=0x8716d656, original_name='RezbitData', from_json=RezbitData.from_json, to_json=RezbitData.to_json
        ),
    })
...
_property_decoder: typing.Dict[int, typing.Tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x8716d656: ('rezbit_data', RezbitData.from_stream),
}
