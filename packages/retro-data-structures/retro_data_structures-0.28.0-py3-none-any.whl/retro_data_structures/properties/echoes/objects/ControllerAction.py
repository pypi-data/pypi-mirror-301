...
class ControllerAction(BaseObjectType):
    ...
    controller_action_struct: ControllerActionStruct = dataclasses.field(default_factory=ControllerActionStruct, metadata={
        'reflection': FieldReflection[ControllerActionStruct](
            ControllerActionStruct, id=0x4c6eefae, original_name='ControllerActionStruct', from_json=ControllerActionStruct.from_json, to_json=ControllerActionStruct.to_json
        ),
    })
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.controller_action_struct.dependencies_for, "controller_action_struct", "ControllerActionStruct"),
        ]:
            try:
