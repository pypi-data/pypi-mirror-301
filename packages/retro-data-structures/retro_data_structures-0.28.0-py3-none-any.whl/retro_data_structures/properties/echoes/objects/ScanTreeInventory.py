...
class ScanTreeInventory(BaseObjectType):
    ...
    inventory_slot: enums.InventorySlot = dataclasses.field(default=enums.InventorySlot.PowerBeam, metadata={
        'reflection': FieldReflection[enums.InventorySlot](
            enums.InventorySlot, id=0x3d326f90, original_name='Inventory Slot', from_json=enums.InventorySlot.from_json, to_json=enums.InventorySlot.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            inventory_slot=enums.InventorySlot.from_json(json_data['inventory_slot']),
