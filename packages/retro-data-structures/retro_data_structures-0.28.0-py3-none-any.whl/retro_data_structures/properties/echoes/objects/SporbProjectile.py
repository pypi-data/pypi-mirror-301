...
class SporbProjectile(BaseObjectType):
    ...
    ball_spit_particle_effect: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['PART'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x677d4fc2, original_name='BallSpitParticleEffect'
        ),
    })
    ball_escape_particle_effect: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['PART'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0xaaff1884, original_name='BallEscapeParticleEffect'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, ball_spit_particle_effect, ball_escape_particle_effect)
    ...
    def _dependencies_for_ball_spit_particle_effect(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_dependencies_for_asset(self.ball_spit_particle_effect)

    def _dependencies_for_ball_escape_particle_effect(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
