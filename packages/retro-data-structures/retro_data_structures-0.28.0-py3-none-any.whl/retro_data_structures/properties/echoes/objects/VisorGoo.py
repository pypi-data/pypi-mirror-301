...
class VisorGoo(BaseObjectType):
    ...
    sound_hit_sound: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0xa6dc9a92, original_name='Sound_HitSound'
        ),
    })
    ...
    def _dependencies_for_electric(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
