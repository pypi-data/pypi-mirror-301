...
class ScannableObjectInfo(BaseObjectType):
    ...
    scan_speed: enums.ScanSpeed = dataclasses.field(default=enums.ScanSpeed.Normal, metadata={
        'reflection': FieldReflection[enums.ScanSpeed](
            enums.ScanSpeed, id=0xc308a322, original_name='ScanSpeed', from_json=enums.ScanSpeed.from_json, to_json=enums.ScanSpeed.to_json
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            scan_speed=enums.ScanSpeed.from_json(json_data['scan_speed']),
