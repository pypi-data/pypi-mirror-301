...
class TweakPlayerGun_RicochetDamage_Factor(BaseProperty):
    ...
    dark_beam: float = dataclasses.field(default=0.10000000149011612, metadata={
        'reflection': FieldReflection[float](
            float, id=0x4f420191, original_name='DarkBeam'
        ),
    })
    light_beam: float = dataclasses.field(default=0.10000000149011612, metadata={
        'reflection': FieldReflection[float](
            float, id=0x7b529049, original_name='LightBeam'
        ),
    })
    annihilator_beam: float = dataclasses.field(default=0.10000000149011612, metadata={
        'reflection': FieldReflection[float](
            float, id=0x503dddca, original_name='AnnihilatorBeam'
        ),
    })
