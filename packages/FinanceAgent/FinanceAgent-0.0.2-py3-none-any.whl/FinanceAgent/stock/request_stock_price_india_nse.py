...
def row_mapper_money_control(entity_data):
    ...
    result_dict[KEY_HIGH_PRICE] = entity_data[KEY_HIGH_PRICE] if KEY_HIGH_PRICE in entity_data else ""  # default high to a
    result_dict[KEY_LOW_PRICE] = entity_data[KEY_LOW_PRICE] if KEY_LOW_PRICE in entity_data else ""
    result_dict[KEY_SYMBOL] = entity_data[KEY_SYMBOL]  if KEY_SYMBOL in  entity_data else ""          # AAPL
    result_dict[KEY_COMPANY_NAME] = entity_data[KEY_COMPANY_NAME]  if KEY_COMPANY_NAME in  entity_data else ""          # AAPL    
