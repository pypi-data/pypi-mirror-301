...
# s k input_height
    ...
    print(f"random_crop :{args.random_crop} ; random_rotation:{args.random_rotation};squeeze_num: {args.squeeze_num};dithering:{args.dithering};pratio:{args.pratio}")
...
def atk_train(args):
    ...
    with open(params_log_file, 'a') as file_handle:
        file_handle.write(f"random_crop :{args.random_crop} ; random_rotation:{args.random_rotation};squeeze_num: {args.squeeze_num};dithering:{args.dithering};pratio:{args.pratio}\n" )
