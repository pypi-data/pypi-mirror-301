    ...
    async def get_pro_coding_requests(
        ...
        for group in plan.get('groups', []):
            ...
            for agent in coding_agents:
                ...
                # Update the conversation history without overwriting the existing system prompt
                new_messages = [msg for msg in conversation_history if msg not in agent.conversation_history]
