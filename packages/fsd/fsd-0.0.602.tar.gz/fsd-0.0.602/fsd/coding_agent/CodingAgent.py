    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- If any instruction is unclear, preserve the existing code without modification.\n"
                "- Ensure all variable names, function names, and class names remain consistent with the original code.\n"
                "- Do not alter the overall structure or logic flow of the existing code.\n"
                "- Strictly adhere to the development plan; do not implement anything not explicitly mentioned.\n"
                "- If instructed to separate a file, maintain the same flow and structure in the separated files.\n"
