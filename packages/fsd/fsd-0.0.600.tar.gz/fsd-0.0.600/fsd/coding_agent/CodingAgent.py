    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- Do not import randomly or use incorrect paths.\n"
                "- Mimic the original code's style and approach as it is the correct working code.\n"
                "- Do not introduce new elements or structures that may break the existing app.\n"
                "- Only implement changes you are certain about based on the given instructions.\n"
                "- If unsure about any aspect, maintain the existing code structure and functionality.\n"
            )
