...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"command here\n"
            f"```\n"
            f"Provide ONLY KEY CODE SNIPPETS, AS LITTLE AS POSSIBLE. This is a plan, not the coding phase. "
            ...
            f"KEEP THIS PLAN AS SHORT AND FOCUSED AS POSSIBLE, FOCUSING ON KEY TASKS ONLY, NODE CODE IF POSSIBLE. "
