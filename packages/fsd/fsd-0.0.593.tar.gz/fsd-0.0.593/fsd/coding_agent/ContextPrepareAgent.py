...
class ContextPrepareAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        prompt = (
            ...
            "Be extremely careful to include all relative paths in the filenames. The paths must be complete from the project root. "
            ...
            "    \"working_files\": [],\n"
            "}\n\n"
            f"The current project path is \"{self.repo.get_repo_path()}\". Ensure all file paths start with this project path.\n"
