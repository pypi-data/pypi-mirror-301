...
class FileManagerAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        prompt = (
                ...
                "            \"Parameters\": {\n"
                "                \"full_path\": \"/exact/path/from/development/plan/example.extension\"\n"
                "            }\n"
                "        }\n"
                "    ]\n"
                "}\n\n"
                "Existing_files, Context_files, and Adding_new_files must include only files explicitly mentioned in the instruction.\n"
                "full_path must be the exact path as specified in the development plan, without any modifications.\n"
