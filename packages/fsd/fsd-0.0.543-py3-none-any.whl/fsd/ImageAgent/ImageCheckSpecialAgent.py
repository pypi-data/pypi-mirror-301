        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "| File Path | [Full path including root and correct relative path from development plan] |\n"
                    "| Description | [Detailed description from development plan] |\n"
                    ...
                    "IMPORTANT:\n"
                    "- Use ONLY the exact full paths for images as specified in the development plan\n"
                    "- Do not modify, guess, or create new paths for images\n"
