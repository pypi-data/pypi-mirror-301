...
class ImageGenAgent:
    ...
    async def process_image_generation_pro(self, steps: List[Dict]):
        """
        Processes image generation steps concurrently with no limit.
        """
    ...
    async def generate_images(self, task: Dict, tier):
        ...
        if tier == "Free":
            ...
            logger.info(" #### Thanks for using our Pro Tier. `Image Gen Agent` will start image generation in supercharged mode.")
