        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "1. Use the exact file paths provided in the instruction for image saving.\n"
                    ...
                    "- file_path: Exact file path as specified in the instruction\n"
                    ...
                    '    "steps": [\n'
                    '        {\n'
                    '            "file_path": "/exact/path/from/instruction/example.png",\n'
