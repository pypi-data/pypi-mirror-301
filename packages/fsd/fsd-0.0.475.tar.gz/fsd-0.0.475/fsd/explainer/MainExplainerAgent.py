...
class MainExplainerAgent:
    ...
    async def get_answer_plan(self, conversation_history, user_prompt, language, all_file_content, role, file_attachments, focused_files, crawl_logs):
        prompt = ""
    ...
    async def get_answer_plans(self, conversation_history, user_prompt, language, files, role, file_attachments, focused_files, crawl_logs):
        ...
        plan = await self.get_answer_plan(conversation_history, user_prompt, language, all_file_content, role, file_attachments, focused_files, crawl_logs)
        return plan
