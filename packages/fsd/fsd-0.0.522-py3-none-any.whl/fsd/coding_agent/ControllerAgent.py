    ...
    async def get_pro_coding_requests(
            ...
            if self.is_coding_file(full_file):
                ...
                if main_path:
                    ...
                    try:
                        ...
                        if shared_conversation_history and shared_conversation_history[-1]["role"] == "user":
                            shared_conversation_history.append({"role": "assistant", "content": "Understood."})

                        shared_conversation_history.append({"role": "user", "content": user_prompt})
                        shared_conversation_history.append({"role": "assistant", "content": result})
        ...
        for group in plan.get('groups', []):
            ...
            for agent in coding_agents:
                ...
                agent.conversation_history = shared_conversation_history.copy()
            ...
            if coding_agents:
                shared_conversation_history = coding_agents[0].conversation_history
