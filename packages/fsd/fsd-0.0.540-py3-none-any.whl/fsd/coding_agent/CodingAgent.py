...
class CodingAgent:
    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        if is_svg:
            ...
            user_prompt += (
                "Create a visually appealing design that matches the overall design aesthetic and purpose of usage.\n"
                "Ensure the SVG design fits seamlessly with existing elements and enhances the user experience.\n"
                "If creating social icons, respect and maintain consistency with the original logo design.\n"
                "Prioritize visual harmony, functionality, and sophisticated design without modifying core brand elements.\n"
            )
        else:
            ...
            user_prompt += (
                ...
                "- Your work must be as comprehensive as possible, demonstrating the expertise of a super coder who leaves no stone unturned in creating flawless, efficient, and innovative solutions.\n"
                "- When referencing images, use the correct image paths from the Development plan.\n"
            )
