...
class GeneralExplainerAgent:
    ...
    def process_image_files(self, file_attachments: List[str]) -> Dict[str, str]:
        """
        ...
        Returns:
            Dict[str, str]: Dictionary of image file names and their base64 representations.
        """
        image_files = {}
            ...
            if file_path.lower().endswith(image_extensions):
                try:
                    with open(file_path, "rb") as image_file:
                        ...
                        image_files[file_name] = f"data:{mime_type};base64,{encoded_string}"
    ...
    async def get_normal_answer_plan(self, user_prompt, language, role, file_attachments, focused_files, crawl_logs):
        ...
        # Process image files
        image_files = self.process_image_files(file_attachments)
