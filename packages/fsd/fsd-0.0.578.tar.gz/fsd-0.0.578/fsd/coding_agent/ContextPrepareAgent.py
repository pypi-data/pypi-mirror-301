...
class ContextPrepareAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        prompt = (
            ...
            "'working_files' must include the full path for existing files that may needs to be modified or updated to complete the user's task. "
            "'context_files' must include the full path for existing files that provide relevant supporting information for the task, but won't be modified. "
        ...
        logger.info(self.repo.print_tree())
