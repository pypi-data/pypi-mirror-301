...
class FirstPromptAgent:
    ...
    def _create_messages(self, user_prompt):
        ...
        system_content = (
            ...
            "and discuss coding topics without modifying a project.\n"
            ...
            "3. Ambiguous: Use this if you are unsure whether the request is talkable or actionable, such as ambiguous prompts.\n"
