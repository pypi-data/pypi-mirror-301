...
class InvoiceRequest(BaseModel):
    ...
    Attributes:
        ...
        global_data (GlobalData): Data for global invoices. Optional.
    ...
    global_data: Optional[GlobalData]  # Añadido soporte para facturas globales
    complements: Optional[List[PaymentComplement]]  # Añadido soporte para complementos de pago
