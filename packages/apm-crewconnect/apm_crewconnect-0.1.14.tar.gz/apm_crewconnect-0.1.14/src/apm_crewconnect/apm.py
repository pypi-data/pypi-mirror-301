...
class Apm:
    ...
    def get_roster(
        ...
        with open("/config/debug.txt", "w+") as file:
            file.write("Parameters")
            file.write("\n")
            file.write(start_date.isoformat() if start_date else "None")
            file.write("\n")
            file.write(end_date.isoformat() if end_date else "None")
        ...
        with open("/config/debug.txt", "w+") as file:
            file.write("Values for fetch")
            file.write("\n")
            file.write(start_date.isoformat())
            file.write("\n")
            file.write(end_date.isoformat())
