...
def plot_nlsolve(
    ...
    def plot_xy_s(
        ...
        ax.scatter(x.iloc[0], y.iloc[0], color='red', label='First point')
        ax.scatter(x.iloc[-1], y.iloc[-1], color='blue', label='Last point')
        
        ax.plot(x, y, label='path of stiffnes center', color='gray')
    ...
    if save:
        ...
        plt.savefig(f'{formatted_time}_nlsolve.pdf')
