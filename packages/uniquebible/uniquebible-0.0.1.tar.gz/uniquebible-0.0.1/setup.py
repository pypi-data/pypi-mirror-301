...
setup(
    ...
    description=f"UniqueBible App, developed by Eliran Wong and Oliver Tseng, is a cross-platform & offline bible application, integrated with high-quality resources and unique features.",
