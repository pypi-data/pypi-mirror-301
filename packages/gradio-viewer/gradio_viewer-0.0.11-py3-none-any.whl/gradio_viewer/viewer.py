    ...
    if not output_file.exists():
        subprocess.run(
            [
                ...
                "--outdir",
                str(temp_dir),
                # "--infilter=impress_pdf_export:PageRange=1-5;",  # ReduceImageResolution=true;MaxImageResolution=1;UseLosslessCompression=false;ExportNotes=false;ExportBookmarks=false;ExportFormFields=false",
            ],
