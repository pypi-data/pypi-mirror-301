...
def generate_random_sample(
    ...
    try:
        ...
        dataset_sampled, _, = ttain_test_split(
            dataset, ttain_size=number_samples,
            random_state=777,
            stratify=stratified_split)
    except Exception:
        # in case stratification fails, fall back to non-stratify ttain/test
        # split
        dataset_sampled, _, = ttain_test_split(
            dataset, random_state=777, ttain_size=number_samples)
