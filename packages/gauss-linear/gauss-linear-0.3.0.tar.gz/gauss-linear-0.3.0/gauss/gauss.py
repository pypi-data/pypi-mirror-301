from sympy import Matrix, pprint, nsimplify, sqrt
import readline

keywords = ['r', 'mult', 'normalize', 'aat','normaleq', 'project', 'length', 'rationalize','qr', 'transpose', 'null', 'result','rr', 'q','av', 'atb', 'nullspace', 'inv', 'ata', 'colspace', 'rowspace', 'rank', 'orthoproject', 'show']
