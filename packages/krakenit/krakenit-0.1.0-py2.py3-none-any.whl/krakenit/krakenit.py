...
for port in ACTIVE_PORTS:
    prefix= "/".join(["", "krakenit", port.__name__.split('.')[-1]])
...
if __name__ == "__main__":
    """
    $ uvicorn krakenit.krakenit:app --reload --reload-delay 1 --reload-dir ~/your/code/krakenit --reload-exclude 'venv' --loop uvloop
    """
