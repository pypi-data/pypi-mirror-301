...
class KrakenitInventory(Item):
    """A Krakenit InventoryItem model"""
    item: Dict[UID_TYPE, KrakenitItem] = {}


# ---------------------------------------------------------
# InventoryRequest
# ---------------------------------------------------------
class KrakenitInventoryRequest(Request):
    
    """A Krakenit request to inventory manager.
...
# InventoryResponse
# ---------------------------------------------------------
class KrakenitInventoryResponse(Response):
    
    """A Krakenit response to inventory manager.
    Contains the search results given by a request.
    """
    data: Dict[UID_TYPE, KrakenitItem] = {}
