...
# models / mappers
# ---------------------------------------------------------
# from ..models.krakenit import KrakenitApp
# from .. import mappers
...
class KrakenitCrawler(iAsyncCrawler):
    "Example class for Krakenit crawler"
    # MODEL = KrakenitApp
    ...
    async def get_data(self, kind, path, **kwargs):
        """
        Example a crawling function for Krakenit crawler.
