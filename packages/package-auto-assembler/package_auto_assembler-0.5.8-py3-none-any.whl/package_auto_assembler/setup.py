...
setup(
    ...
    install_requires=['requests', 'pandas==2.1.1', 'numpy==1.26.0', 'packaging', 'uvicorn', 'click==8.1.7', 'nbconvert==7.16.4', 'pip_audit==2.7.3', 'pyyaml', 'nbformat', 'stdlib-list', 'mkdocs==1.6.0', 'attrs>=22.2.0', 'fastapi'],
