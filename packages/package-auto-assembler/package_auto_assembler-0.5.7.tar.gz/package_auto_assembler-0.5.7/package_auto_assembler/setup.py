...
setup(
    ...
    install_requires=['nbformat', 'pandas==2.1.1', 'requests', 'stdlib-list', 'mkdocs==1.6.0', 'uvicorn', 'packaging', 'pyyaml', 'pip_audit==2.7.3', 'nbconvert==7.16.4', 'fastapi', 'numpy==1.26.0', 'attrs>=22.2.0', 'click==8.1.7'],
