...
import cv2, fitz, io, re, easyocr, os, time,pyautogui,webbrowser,pyperclip
import numpy as np
...
def generate_user_manual_by_ChatGPT(final_ocr):
    chat_history = ['''I want to generate a detailed user manual documentation, i am giving you the OCR, please make a detailed user manual documentation for me.''',
                '''Do not use '####' and dont write it in markdown. and Can you please elaborate and explain the things in detailed manner.''',
    ...
    pyautogui.click(500, 500)  # Adjust the coordinates to click within the chat area
