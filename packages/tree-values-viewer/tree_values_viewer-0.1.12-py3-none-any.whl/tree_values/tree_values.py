...
def main():
    print("Debug: tree_values.py main() function is called")

    parser = argparse.ArgumentParser(description="Project tree and values viewer.")
    parser.add_argument('command', choices=['tree', 'values', 'values_info'],
                        help="tree: View project tree, values: View file names and contents, values_info: View file information including line count.")
