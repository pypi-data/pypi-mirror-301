...
import { B as Block, S as StatusTracker, e as BlockLabel, C as Chat, h as IconButtonWrapper$1, i as IconButton$1, z as Community, A as Trash, G as MarkdownCode, H as Copy, J as ScrollDownArrow, R as Retry, v as Undo } from './2-CM3gFCtA.js';
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
  ...
  })}` : ``} <div class="${escape(null_to_empty(layout === "bubble" ? "bubble-wrap" : "panel-wrap"), true) + " svelte-1sepu1"}" role="log" aria-label="chatbot conversation" aria-live="polite"${add_attribute("this", div, 0)}>${value !== null && value.length > 0 && groupedMessages !== null ? `<div class="message-wrap svelte-1sepu1">${each(groupedMessages, (messages, i) => {
  ...
  })} ${pending_message ? `${validate_component(Pending, "Pending").$$render($$result, { layout }, {}, {})}` : ``}</div>` : `<div class="placeholder-content svelte-1sepu1">${placeholder !== null ? `<div class="placeholder svelte-1sepu1">${validate_component(MarkdownCode, "Markdown").$$render(
    $$result,
    {
      message: placeholder,
      latex_delimiters,
    ...
    {},
    {}
  )}</div>` : ``} ${examples !== null ? `<div class="examples svelte-1sepu1">${each(examples, (example, i) => {
    return `<button class="example svelte-1sepu1">${example.icon !== void 0 ? `<div class="example-icon-container svelte-1sepu1">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "example-icon",
        src: example.icon.url,
      ...
      {},
      {}
    )} </div>` : ``} ${example.display_text !== void 0 ? `<span class="example-display-text svelte-1sepu1">${escape(example.display_text)}</span>` : `<span class="example-text svelte-1sepu1">${escape(example.text)}</span>`} ${example.files !== void 0 && example.files.length > 1 ? `<span class="example-file svelte-1sepu1"><em>${escape(example.files.length)} Files</em></span>` : `${example.files !== void 0 && example.files[0] !== void 0 && example.files[0].mime_type?.includes("image") ? `<div class="example-image-container svelte-1sepu1">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "example-image",
        src: example.files[0].url,
      ...
      {},
      {}
    )} </div>` : `${example.files !== void 0 && example.files[0] !== void 0 ? `<span class="example-file svelte-1sepu1"><em>${escape(example.files[0].orig_name)}</em></span>` : ``}`}`} </button>`;
  })}</div>` : ``}</div>`}</div> ${show_scroll_button ? `<div class="scroll-down-button-container svelte-1sepu1">${validate_component(IconButton$1, "IconButton").$$render(
    $$result,
    {
      Icon: ScrollDownArrow,
      label: "Scroll down",
...
//# sourceMappingURL=Index55-CMZianlJ.js.map
