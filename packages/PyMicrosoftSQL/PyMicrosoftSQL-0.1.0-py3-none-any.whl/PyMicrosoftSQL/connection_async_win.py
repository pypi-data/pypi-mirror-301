...
class ConnectionAsyncWin:
    ...
    def _initialize(self):
        self._initialize_async_event_manager()
    ...
    def _initialize_async_event_manager(self):
        self.manager = AsyncSQLEventManager(self.odbc.SQLDriverConnectW, self.odbc.SQLExecDirectW)
    ...
    def _connect_to_server(self):
        ...
        self.manager.add_conn_handle(conn_event)
    ...
    def execute(self, query):
        ...
        self.manager.add_stmt_handle(stmt_event)
