            ...
            ib.on_new_iu(move |iu: RustIUMQTT| {
                ...
                Box::pin(async move {
                    ...
                    if let Err(e) = cor.await {
                        error!("executing on_new_iu callback for InputBuffer {} failed: {e}", ib_uid)
                    }
                })
            })
                .await;
        ...
        pyo3_asyncio::tokio::future_into_py(py, async move {
            ...
            ib.on_new_message(move |msg: String| {
                ...
                Box::pin(async move {
                    ...
                    if let Err(e) = cor.await {
                        error!("executing on_new_message callback for InputBuffer {} failed: {e}", ib_uid)
                    }
                })
            })
                .await;
