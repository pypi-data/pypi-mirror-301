...
REF_DIR: Path = Path(__file__).parent / "refs" / "test_directors"

ONE_BLOCK_RES_DIR: Path = REF_DIR / "TestDirectorsWindCase3OneBlock"
TWO_BLOCKS_RES_DIR: Path = REF_DIR / "TestDirectorsWindCase3TwoBlocks"
TRICKY_RES_DIR: Path = REF_DIR / "TestDirectorsWindCase3Tricky"
...
if __name__ == "__main__":
    process_dir(ONE_BLOCK_RES_DIR, "one_block.txt")
    process_dir(TWO_BLOCKS_RES_DIR, "two_blocks.txt")
    process_dir(TRICKY_RES_DIR, "tricky.txt")
