...
class TestTemplateFunctions:
    ...
    def test_read_template_with_weights(self, test_file):
        weights = np.array([1])
        assert isinstance(
            read_template(test_file, weights=weights), CentroidTemplateRetriever
        )
...
class TestJsonTemplateRetriever:
    ...
    def test_init_and_read_file(self, test_file):
        ...
        tpl_rtr2 = read_template(test_file)
        ...
        assert read_template("file_does_not_exist.json") is None
...
class TestIniTemplateRetriever:
    ...
    def test_init_and_read_file(self, test_file):
        ...
        # Test with not existing file
        assert read_template("file_does_not_exist.ini") is None
...
class TestCsvTemplateRetriever:
    ...
    def test_init_and_read_file(self, test_file):
        ...
        tpl_rtr2 = read_template(test_file, index_col=["A", "B"])
        self._check_get(tpl_rtr2)

        assert tpl_rtr1 == tpl_rtr2

        # Test with not existing file
        assert read_template("file_does_not_exist.csv") is None
...
class TestCentroidTemplateRetriever:
    ...
    def test_init_and_read_file(self):
        ...
        # Test with not existing file
        assert read_template("file_does_not_exist.csv", force_centroid=True) is None
