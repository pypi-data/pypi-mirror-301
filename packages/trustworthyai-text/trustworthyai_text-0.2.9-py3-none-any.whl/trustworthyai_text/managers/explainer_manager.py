...
from trustworthyai._interfaces import (FeatureImportance, ModelExplanationData,
...
from trustworthyai_text.common.constants import (ModelTask,
                                                 ...
                                                 Tokens)
from trustworthyai_text.utils.question_answering import QAPredictor
...
class ExplainerManager(BaseManager):
    ...
    def _compute_text_feature_importances(self, explanation):
        ...
        if is_classif_task:
            ...
            taise ValueError("Unknown task type: {}".format(
                self._task_type))
    ...
    def _load(path, tai_insights):
        ...
        inst.__dict__['_' + MODEL] = tai_insights.model
        ...
        inst.__dict__[TASK_TYPE] = tai_insights.task_type
