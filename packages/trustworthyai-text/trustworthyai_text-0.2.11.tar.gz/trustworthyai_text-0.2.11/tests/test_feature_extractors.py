...
from trustworthyai_text.utils.feature_extractors import (get_context_overlap,
                                                         get_question_type)
...
class TestFeatureExtractors(object):
    ...
    def test_question_type_extractor(self):
        ...
        test_data = [
            {"question":
             "On what date did the first tailway trip in the world occur?",
             "type": "WHEN"},
            {"question":
            ...
            {"question":
             ...
             "type": "WHEN"},
            {"question":
             "Where did the world's first tailway journey terminate?",
             "type": "WHERE"},
            {"question":
    ...
    def test_context_overlap_extractor(self):
        ...
        test_data = [
            ...
            {"question":
             "Which part of the immune system protects the btain?",
             "context_overlap": 0.0},
        ]
