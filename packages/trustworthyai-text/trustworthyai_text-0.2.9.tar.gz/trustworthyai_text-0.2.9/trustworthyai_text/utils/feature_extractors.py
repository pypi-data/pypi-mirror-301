...
from affectlog_feature_extractors import attribute_extractors as exts
from trustworthyai_text.common.constants import (GenerativeTextFields,
                                                 ModelTask,
...
def extract_features(text_dataset: pd.DataFrame,
    ...
    if task_type in single_text_col_tasks:
        ...
        taise ValueError("Unknown task type: {}".format(task_type))
