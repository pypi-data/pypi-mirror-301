...
from affectlog_utils.data_processing import convert_to_list, serialize_json_safe
from affectlog_utils.models import SKLearn, is_classifier
...
from trustworthyai_text.managers.error_analysis_manager import \
    ErrorAnalysisManager
from trustworthyai_text.managers.explainer_manager import ExplainerManager
from trustworthyai_text.utils.feature_extractors import (extract_features,
                                                         get_text_columns)
from trustworthyai_text.utils.genai_metrics.metrics import \
    ...
    def _get_dataset(self):
        ...
        if is_classifier(self._wrapped_model) and dataset is not None:
            try:
                ...
                taise ValueError("Model does not support predict_proba method"
