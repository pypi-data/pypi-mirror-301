...
def map_json(path):
    ...
    text_for_static += f'{tab}{tab}self.all_game_objects = [{",".join(list_collection_static)}]\n'
    text_for_dynamic += f'{tab}{tab}self.all_game_objects += [{",".join(list_collection_dynamic)}]\n'
