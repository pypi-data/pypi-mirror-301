...
class TraverseDatasetItems:
    ...
    @classmethod
    def __traverse_dataset(cls, traverse_dir: str, item_file_type: str) -> List[tuple]:
        """
    ...
    @staticmethod
    def traverse_dataset(traverse_dir: str, file_abs_path: str):
        return TraverseDatasetItems.__traverse_dataset(traverse_dir, file_abs_path)
