...
def exec(args: argparse.Namespace):
    ...
    if os.path.isfile(path):
        ...
        raise ValueError(f'Path {path} is neither a directory nor a file!')
    ...
    if config_module is not None:
        found_configurations = [clazz for clazz in found_configurations if clazz.__module__ == config_module.__name__]
