...
"""
    ...
    def __init__(self, provider: str, model, temperature: float, api_key: str):
...
class OpenAIModel:
    def __init__(self, api_key: str, model: str, temperature: float, prompt: str | None):
    ...
    def __serialize_completion(self, completion: ChatCompletion) -> str:
    ...
    def __extract_response(self, completion: ChatCompletion, schema: dict):
        try:
            return (
                ...
                self.__serialize_completion(completion=completion)
            )
