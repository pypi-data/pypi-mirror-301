...
REST_FRAMEWORK = {
    ...
    # EXCEPTION:
    'EXCEPTION_HANDLER': 'bomiot.core.my_exceptions.custom_exception_handler',
    # Base API policies:
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': ['bomiot.core.auth.AsyncAuthentication', ],
    'DEFAULT_PERMISSION_CLASSES': ["bomiot.core.permission.AsyncPermission", ],
    'DEFAULT_THROTTLE_CLASSES': ['bomiot.core.throttle.AsyncThrottle', ],
