...
class ScanNetBindingSiteClient:
    ...
    def process_data(self, biomarker_data,qid):
        try:
            #pdb_data = {"protein": qid,"pdb": biomarker_data}
            biomarker_data = post_connection_format(biomarker_data, self.url_pattern, self.genome_version)
