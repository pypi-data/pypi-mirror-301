...
from pararamio.utils import get_formatted_attr_or_load
...
def get_formatted_attr_fn(cls) -> Any:
    """
    ...
    if hasattr(cls, 'load') and hasattr(cls, '_load_on_key_error'):
...
class BaseLoadedAttrMetaClass(type):
    ...
    def __new__(mcs, name, bases, dct):
        ...
        cls.__getattr__ = get_formatted_attr_fn(cls)
        return cls
