...
_dialect_name = "parseable+flight"
...
class ParseableExecutionContext(default.DefaultExecutionContext):
    pass
...
class ParseableDDLCompiler(compiler.DDLCompiler):
...
class ParseableIdentifierPreparer(compiler.IdentifierPreparer):
    reserved_words = compiler.RESERVED_WORDS.copy()
    parseable_reserved = {'abs', 'all', 'allocate', 'allow', 'alter', 'and', 'any', 'are', 'array',
    ...
    parseable_unique = parseable_reserved - reserved_words
    reserved_words.update(list(parseable_unique))

    def __init__(self, dialect):
        super(ParseableIdentifierPreparer, self). \
            __init__(dialect, initial_quote='"', final_quote='"')


class ParseableExecutionContext_flight(ParseableExecutionContext):
    pass


class ParseableDialect_flight(default.DefaultDialect):
    ...
    paramstyle = 'pyformat'
    ddl_compiler = ParseableDDLCompiler
    preparer = ParseableIdentifierPreparer
    execution_ctx_cls = ParseableExecutionContext
    ...
    @classmethod
    def dbapi(cls):
        import sqlalchemy_parseable.db as module
        return module
