...
class Checker:
    ...
    def curl_command(self):
        ...
        data = """-H 'Content-Type: application/json' -d '{"jsonrpc":"2.0","method":"ledger","params":[],"id":1}'"""
    ...
    def get_current_block_height(self):
        ...
        获取当前块高
        """
        return send_rpc_request(url=self._build_provider_url(), method="ledger")
