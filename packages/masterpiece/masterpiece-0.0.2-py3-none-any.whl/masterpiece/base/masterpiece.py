"""
    ...
    Classes:
        ...
        These objects can be copied, serialized, instantiated through class id (factory method pattern).
...
class MetaMasterPiece(type):
    ...
    classes. Typically the application code should not need to to be aware of this class.
    """
