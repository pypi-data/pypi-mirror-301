"""
Classes for loading and managing plugins. Isn't the name 'PlugMaster' cool, even
if I say so my self? :)
...
class PlugMaster(MasterPiece):
    ...
    def load(self, name: str) -> None:
        ...
        # TODO: fix Code is unreachablePylance, Instance of 'EntryPoints' has no 'get'
        # memberPylintE1101:no-member false positive.
    ...
    def get(self) -> Dict[str, Type[MasterPiece]]:
        """Fetch the directionary of plugins classes.
