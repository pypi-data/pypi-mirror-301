...
from matdb.core import MatDB, convert_coordinates, check_all_params_provided, perform_symmetry_analysis
...
class TestMatDB(unittest.TestCase):

    def setUp(self):
        self.temp_dir = tempfile.mkdtemp()
        self.manager = MatDB(db_dir=self.temp_dir, n_cores=2)
