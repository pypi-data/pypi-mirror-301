...
def _item_as_option(k: str, v: Union[bool, str]) -> str:
    k = k.replace("_", "-")
    # TODO: if v is False, do not include option
...
class Command:
    ...
    def __call__(self, *args: StrPath, **kw: Union[bool, str]) -> Command:
        ...
        return type(self)(args=new_args, cwd=self.cwd)
    ...
    def _run_process(
        ...
        # TODO: Close stdin / map to /dev/null if capture_output=True? -> Do not hang on prompts.
