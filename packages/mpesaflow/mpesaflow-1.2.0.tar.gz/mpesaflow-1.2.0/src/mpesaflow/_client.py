...
ENVIRONMENTS: Dict[str, str] = {
    "sandbox": "https://sandbox-api.mpesaflow.com/v1",
    "production": "https://api.mpesaflow.com/v1",
}
...
class MpesaFlow(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        base_url_env = os.environ.get("MPESA_FLOW_BASE_URL")
        if is_given(base_url) and base_url is not None:
            ...
            if base_url_env and base_url is not None:
                raise ValueError(
                    "Ambiguous URL; The `MPESA_FLOW_BASE_URL` env var and the `environment` argument are given. If you want to use the environment, you must pass base_url=None",
                )
