...
@tc.final
class TenseOptions(tc.Abstract, tc.Final, _init_sentinel = True, _final_sentinel = True):
    """
    \\@since 0.3.27a5
    ```
    in module tense
...
@tc.final
class FencordOptions(tc.Abstract, tc.Final, _init_sentinel = True, _final_sentinel = True):
    """
    \\@since 0.3.27b1
    ```
    in module tense
