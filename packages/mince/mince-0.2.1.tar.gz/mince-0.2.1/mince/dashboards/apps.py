...
def _create_app(
    ...
    def update_ui(*args) -> list[str | bool]:
        ...
        if ui_state['initial_load']:
            urls.parse_url(url, display_state, dashboard.spec['default_state'])
        ...
        state_module._fix_invalid_inputs(
...
def get_default_assets_folder() -> str:
    ...
    path = str(importlib.resources.path('mince.assets', 'favicon.ico'))
