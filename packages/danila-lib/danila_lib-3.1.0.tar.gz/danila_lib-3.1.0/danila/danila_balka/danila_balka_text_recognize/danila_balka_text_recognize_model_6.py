...
class Danila_balka_text_recognize_model_6(Danila_balka_text_recognize_model):
    ...
    def get_model_cut_first_last(self, yolo_path):
        return Balka_Text_Recognize_yolo(model_path=LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_4,
                                         yolo_path=yolo_path, cut_first_last=True)
