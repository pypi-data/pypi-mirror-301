...
class Image_text_areas_altai:
    ...
    def __init__(self):
        ...
        self.areas = dict(
            {
                Class_text_altai.number : [],
                Class_text_altai.prod : [],
                Class_text_altai.seria : [],
                Class_text_altai.sran : [],
                Class_text_altai.text : [],
                Class_text_altai.year : []
            }
        )
