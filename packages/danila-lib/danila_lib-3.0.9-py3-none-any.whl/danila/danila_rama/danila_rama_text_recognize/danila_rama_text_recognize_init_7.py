from danila.danila_rama.danila_rama_text_recognize.danila_rama_text_recognize_model_5 import \
    Danila_rama_text_recognize_model_5
...
class Danila_rama_text_recognize_init_7:
    def __init__(self, yolov5_dir):
        danila_rama_text_recognize_model = Danila_rama_text_recognize_model_5()
