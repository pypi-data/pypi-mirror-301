...
from danila.danila_balka.danila_balka_text_recognize.danila_balka_text_recognize_init_8 import \
    Danila_balka_text_recognize_init_8
...
class Danila_balka_text_recognize_init:
    def __init__(self, yolov5_dir, balka_text_recognize_version):
        ...
        elif balka_text_recognize_version == 8:
            self.danila_balka_text_recognize_init = Danila_balka_text_recognize_init_8(yolov5_dir=yolov5_dir)
