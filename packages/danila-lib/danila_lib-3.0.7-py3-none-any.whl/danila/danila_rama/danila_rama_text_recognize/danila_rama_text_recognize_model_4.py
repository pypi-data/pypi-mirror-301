...
class Danila_rama_text_recognize_model_4(Danila_rama_text_recognize_model):
    def get_model(self, yolo_path):
        return Text_Recognize_yolo(model_path= LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_4, yolo_path=yolo_path)
