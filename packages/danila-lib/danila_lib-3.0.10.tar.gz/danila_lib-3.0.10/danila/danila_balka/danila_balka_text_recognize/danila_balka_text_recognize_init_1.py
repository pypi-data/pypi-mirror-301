...
from danila.danila_balka.danila_balka_text_recognize.danila_balka_text_recognize_model_1 import \
    Danila_balka_text_recognize_model_1
...
class Danila_balka_text_recognize_init_1:
    def __init__(self, yolov5_dir):
        danila_balka_text_recognize_model = Danila_balka_text_recognize_model_1()
