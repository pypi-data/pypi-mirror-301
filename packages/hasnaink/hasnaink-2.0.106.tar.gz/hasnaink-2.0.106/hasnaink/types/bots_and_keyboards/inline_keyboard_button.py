...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~hasnaink.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~hasnaink.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~hasnaink.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~hasnaink.types.CallbackGame`, *optional*):
