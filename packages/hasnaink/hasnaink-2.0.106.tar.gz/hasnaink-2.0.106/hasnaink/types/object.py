...
class Object:
    def __init__(self, client: "hasnaink.Client" = None):
        self._client = client

    def bind(self, client: "hasnaink.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~hasnaink.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/hasnainkchat/167281
