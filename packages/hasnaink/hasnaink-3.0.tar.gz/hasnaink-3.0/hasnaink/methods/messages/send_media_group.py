...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~hasnaink.types.InputMediaPhoto`, :obj:`~hasnaink.types.InputMediaVideo`, :obj:`~hasnaink.types.InputMediaAudio` and :obj:`~hasnaink.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~hasnaink.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from hasnaink.types import InputMediaPhoto, InputMediaVideo
