...
import hasnaink
from hasnaink.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~hasnaink.Client.start`, :meth:`~hasnaink.idle` and :meth:`~hasnaink.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`hasnaink.compose`.
