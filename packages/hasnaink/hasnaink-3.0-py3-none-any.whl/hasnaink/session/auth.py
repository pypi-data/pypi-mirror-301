...
from hasnaink.crypto import aes, rsa, prime
from hasnaink.errors import SecurityCheckMismatch
from hasnaink.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "hasnaink.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
