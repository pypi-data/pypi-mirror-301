...
import hasnaink
from hasnaink import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~hasnaink.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~hasnaink.types.MessageEntity`, *optional*):
