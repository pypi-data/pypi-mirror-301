...
from hasnaink.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "hasnaink.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~hasnaink.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~hasnaink.handlers.MessageHandler` the *update* argument will be a :obj:`~hasnaink.types.Message`; in a :obj:`~hasnaink.handlers.CallbackQueryHandler` the *update* will be a :obj:`~hasnaink.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~hasnaink.filters.command` or :meth:`~hasnaink.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~hasnaink.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Document` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Game` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Video` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Location` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~hasnaink.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~hasnaink.types.Message`.
    ...
    async def func(flt, client: hasnaink.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~hasnaink.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~hasnaink.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~hasnaink.types.InlineQuery`: The filter will match ``query``.
