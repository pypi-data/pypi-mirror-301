...
import hasnaink
from hasnaink import __version__, __license__
from hasnaink import enums
from hasnaink import raw
from hasnaink import utils
from hasnaink.crypto import aes
from hasnaink.errors import CDNFileHashMismatch
from hasnaink.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from hasnaink.handlers.handler import Handler
from hasnaink.methods import Methods
from hasnaink.session import Auth, Session
from hasnaink.storage import FileStorage, MemoryStorage
from hasnaink.types import User, TermsOfService
from hasnaink.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~hasnaink.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~hasnaink.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.hasnaink.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except hasnaink.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
