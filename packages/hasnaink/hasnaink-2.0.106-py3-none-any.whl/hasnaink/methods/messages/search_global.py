...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~hasnaink.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~hasnaink.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~hasnaink.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "hasnaink". Get the first 50 results
                async for message in app.search_global("hasnaink", limit=50):
                    print(message.text)
