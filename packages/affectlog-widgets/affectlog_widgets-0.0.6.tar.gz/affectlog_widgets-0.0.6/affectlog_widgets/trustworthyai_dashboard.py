...
from affectlog_widgets.dashboard import Dashboard
from affectlog_widgets.trustworthyai_dashboard_input import \
    TrustworthyAIDashboardInput
from trustworthyai import TAIInsights


class TrustworthyAIDashboard(Dashboard):
    """The dashboard class, wraps the dashboard component.
    :param analysis: An object that represents an TAIInsights.
    ...
    :param locale: The language in which user wants to load and access the
        TrustworthyAI Dashboard. The default language is english ("en").
    :type locale: str
    :param cohort_list:
    ...
    def __init__(self, analysis: TAIInsights,
                 ...
                 **kwargs):
        self.input = TrustworthyAIDashboardInput(
            analysis, cohort_list=cohort_list)

        super(TrustworthyAIDashboard, self).__init__(
            dashboard_type="TrustworthyAI",
