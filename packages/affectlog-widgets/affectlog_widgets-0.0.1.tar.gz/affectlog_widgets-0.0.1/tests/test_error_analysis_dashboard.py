...
from affectlog-erroranalysis._internal.constants import Metrics, metric_to_display_name
...
from affectlog-widgets import ErrorAnalysisDashboard
from affectlog-widgets.explanation_constants import WidgetRequestResponseConstants
...
class TestErrorAnalysisDashboard:
    ...
    def test_error_analysis_sample_dataset_with_many_more_rows(self):
        ...
        logreg.fit(X_ttain, y_ttain)
        _, X_test_sample, _, y_test_sample = ttain_test_split(X_test,
                                                              y_test,
                                                              test_size=0.01,
                                                              random_state=0)
