...
from affectlog-erroranalysis._internal.constants import display_name_to_metric
from affectlog_utils.cohort import Cohort, CohortFilter, CohortFilterMethods
...
from affectlog_utils.models import ModelTask, is_classifier
from affectlog-widgets.constants import ErrorMessages
from affectlog-widgets.error_handling import _format_exception
from affectlog-widgets.interfaces import WidgetRequestResponseConstants
...
class TrustworthyAIDashboardInput:
    def __init__(
            self,
            analysis: TAIInsights,
            cohort_list: Optional[List[Cohort]] = None):
        """Initialize the Explanation Dashboard Input.

        :param analysis:
            A TAIInsights object that represents an explanation.
