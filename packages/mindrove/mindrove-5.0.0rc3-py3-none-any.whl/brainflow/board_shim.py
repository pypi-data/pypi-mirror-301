...
class BoardShim(object):
    ...
    def get_current_board_data(self, num_samples: int, preset: int = MindRovePresets.DEFAULT_PRESET) -> NDArray[Float64]:
    ...
    def get_board_data(self, num_samples=None, preset: int = MindRovePresets.DEFAULT_PRESET) -> NDArray[Float64]:
