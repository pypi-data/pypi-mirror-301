...
def read_and_analyse_features( ip, file_data ):
    ...
    if plot_mean_features:
        ...
        gu.plot_features( ip.output_directory, mean_features, ["Feature 1", "Feature 2", "Feature 3", "Feature 4", "Feature 5", "Feature 6", "Feature 7"], [resin_data.loc[i]["Label"] for i in sample_mask], subdirectory = "Rheology/Features/", title = "Means_Features.pdf" )
