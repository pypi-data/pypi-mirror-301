...
def plot_crossover_points( directory, output_directory, resin_data, file_data, features_df, sample_array, samples_to_plot, specimens, mean, data_extraction_bool, savefig ):
...
def plot_van_Gurp_Palmen_plot( output_directory, resin_data, file_data, data, sample_array, samples_present_array, samples_to_plot, specimens, mean, colours, data_extraction_bool, savefig ):
    ...
    if mean:
        ...
        for i in samples_to_plot:
            ...
            data_extraction.append( data[7][index] * data[0] )
            data_extraction.append( np.arctan( data[8][index] ) * 180 / np.pi )
...
def plot_data( ip, file_data, data, first_derivative_data, second_derivative_data, savefig = False ):
    ...
    # samples_to_plot = [18, 20, 21, 22, 23, 16, 17, 19, 1, 2]
    # samples_to_plot = [4, 8, 23, 16, 15]
    samples_to_plot = [7]
    ...
    if perform_plot_crossover_points:
        ...
        plot_crossover_points( ip.directory, ip.output_directory, resin_data, file_data, features_df, sample_array, samples_to_plot, specimens, mean, data_extraction_bool, savefig )

    if perform_van_Gurp_Palmen_plot:

        plot_van_Gurp_Palmen_plot( ip.output_directory, resin_data, file_data, data, sample_array, samples_present_array, samples_to_plot, specimens, mean, colours, data_extraction_bool, savefig )
