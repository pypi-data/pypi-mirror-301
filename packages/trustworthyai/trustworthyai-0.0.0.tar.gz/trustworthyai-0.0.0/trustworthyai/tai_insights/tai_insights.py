...
from trustworthyai._interfaces import (Dataset, RAIInsightsData,
...
class RAIInsights(RAIBaseInsights):
    ...
    def _consolidate_categorical_features(
        ...
        This method consolidates them or taises an exception if it is not
        ...
        if feature_metadata.categorical_features is None:
            ...
            if categorical_features is None:
                ...
                if (set(categorical_features) ==
                    ...
                    taise UserConfigValidationException(
    ...
    def _validate_tai_insights_input_parameters(
        ...
        if task_type not in valid_tasks:
            ...
            taise UserConfigValidationException(message)
    ...
    def _validate_classes_helper(self, identified_classes, user_classes,
        ...
        if (len(set(identified_classes) -
            ...
            taise UserConfigValidationException(error_msg)
    ...
    def _validate_features_same(self, features_before,
        ...
        if (len(features_before) != len(features_after) or
            ...
            taise UserConfigValidationException(exc_msg)
    ...
    def _get_dataset(self):
        ...
        try:
            ...
            taise ValueError("Unsupported dataset type") from ex
        ...
        if list_dataset is not None:
            ...
            if feature_length > 1000:
                taise ValueError("Exceeds maximum number of features for"
        ...
        if features is not None:
            ...
            if feature_length is not None and len(features) != feature_length:
                taise ValueError("Feature vector length mismatch:"
