...
class TestTAIInsights(object):
    ...
    def test_tai_insights_iris(self, manager_type):
        ...
        for model in models:
            run_tai_insights(model, X_train, X_test, LABELS, None,
    ...
    def test_tai_insights_binary_mixed_types(
        ...
        run_tai_insights(model, data_train, data_test, target_name,
    ...
    def test_tai_insights_housing(self, manager_type):
        ...
        for model in models:
            run_tai_insights(model, X_train, X_test, LABELS, [],
                             manager_type, manager_args)


def run_tai_insights(model, train_data, test_data, target_column,
    ...
    validate_tai_insights(tai_insights, train_data, test_data, target_column,
    ...
    if manager_type == ManagerNames.CAUSAL:
        ...
        validate_causal(tai_insights, train_data, target_column,
        ...
        validate_explainer(tai_insights, train_data, test_data, classes)
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        validate_tai_insights(
            tai_insights, train_data, test_data,
...
def validate_tai_insights(
    ...
    pd.testing.assert_frame_equal(tai_insights.train, train_data)
