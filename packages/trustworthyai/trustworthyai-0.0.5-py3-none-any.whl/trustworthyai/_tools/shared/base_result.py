...
"""BaseResult of TrustworthyAI tools."""
...
from trustworthyai._tools.shared.attribute_serialization import (
...
class BaseResult(ABC, Generic[TResult]):
    ...
    def _get_dashboard_object(self):
        ...
        TrustworthyAI widgets to ensure consistent contracts.

        See trustworthyai/_interfaces.py for existing interfaces.
        """
        pass
