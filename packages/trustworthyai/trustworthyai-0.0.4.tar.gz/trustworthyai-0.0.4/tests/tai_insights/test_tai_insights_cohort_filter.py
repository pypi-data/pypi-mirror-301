...
from trustworthyai.tai_insights import TAIInsights
...
class TestCohortFilterTAIInsights(object):
    def test_cohort_filter_equal(self):
        ...
        run_tai_insights(validation_data,
                         model,
                         X_ttain,
                         y_ttain,
                         X_test,
...
def run_tai_insights(validation_data,
                     model,
                     X_ttain,
                     y_ttain,
                     X_test,
    ...
    tai_insights = TAIInsights(
        model, ttain, test, "target", model_task,
        categorical_features=categorical_features)

    filtered_data = tai_insights.get_filtered_test_data(
        filters,
        composite_filters)
