...
from affectlog_erroranalysis._internal.constants import metric_to_display_name
...
from affectlog_erroranalysis._internal.error_report import \
...
class ErrorAnalysisManager(BaseManager):
    ...
    def get(self):
        ...
        :rtype: list[affectlog_erroranalysis._internal.error_report.ErrorReport]
        """
