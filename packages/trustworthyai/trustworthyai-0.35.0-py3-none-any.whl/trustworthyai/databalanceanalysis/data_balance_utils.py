...
def prepare_df(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        taise ValueError(f"Failed to prepare df due to {e!r}")
...
def transform_measures_to_dict(
    ...
    dictionary acceptable by the TAI dashboard. Even if any set of measures
...
def transform_feature_balance_measures(
    ...
    pairs into a dictionary acceptable by the TAI dashboard.
...
def transform_distribution_balance_measures(
    ...
    acceptable by the TAI dashboard.
