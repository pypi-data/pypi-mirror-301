...
class ModelAnalysis(object):
    ...
    def __init__(self, model: Any, train: pd.DataFrame, test: pd.DataFrame,
        ...
        warnings.warn(
            ...
            "package is deprecated. Please use TAIInsights instead.",
            DeprecationWarning)
        self.tai_insights = TAIInsights(
            model,
            train,
            test,
            target_column,
        ...
        self.train = self.tai_insights.train
    ...
    def load(path):
        ...
        inst.tai_insights = TAIInsights.load(path)
        inst.model = inst.tai_insights.model
        inst.train = inst.tai_insights.train
