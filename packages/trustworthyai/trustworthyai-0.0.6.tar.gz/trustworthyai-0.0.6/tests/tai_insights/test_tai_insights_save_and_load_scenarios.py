...
class TestTAIInsightsSaveAndLoadScenarios(object):
...
def validate_tai_insights(
    ...
    if feature_metadata is not None:
        # mismatch between categorical_features passed in TAIInsights
