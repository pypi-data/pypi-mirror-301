...
The text of the problem should be short and simply phrased, but the taks itself should be highly complex and require advanced knowledge of programming to be solved. 
The problem shall contain only a few hints and constraits.
Keep in mind that, even thought the problem is asked by a intermediate-beginner, it will be a practionioner with advanced level of programming skills to be requested to solve the problem.
...
OSS_problem_prompt_complex_brief = ChatPromptTemplate.from_messages(
    [
...
OSS_solution_prompt_complex_brief = ChatPromptTemplate.from_messages(
    [
