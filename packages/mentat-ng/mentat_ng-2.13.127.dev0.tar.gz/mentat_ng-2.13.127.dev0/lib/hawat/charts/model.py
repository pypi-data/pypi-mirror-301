...
import typing
from typing import Any, Callable, Dict, Iterable, Iterator, List, NamedTuple, Optional, Union
...
from .const import ChartJSONType, DataComplexity, InputDataFormat
...
class TimelineChartData(ChartData):
    ...
    def __init__(
        ...
        add_rest: bool = False,
        x_axis_label_override: Union[str, LazyString, None] = None,
