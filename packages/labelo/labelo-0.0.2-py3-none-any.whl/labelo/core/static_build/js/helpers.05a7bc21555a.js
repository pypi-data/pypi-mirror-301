...
function smart_submit(done, form_id) {
  ...
  console.log("runnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
  

  // Validate the username field before proceeding
  var usernameField = $(f).find('input[name="username"]');
  var errorMessage = $(f).find('.error-message');

  if (usernameField.val().trim() === "") {
    // Show error message if validation fails
    console.log("errrrrrrrrrrrrrrrrrrrrrrro");
    
    errorMessage.show(); 
    usernameField.addClass('error');  // Optionally add an error class for styling
