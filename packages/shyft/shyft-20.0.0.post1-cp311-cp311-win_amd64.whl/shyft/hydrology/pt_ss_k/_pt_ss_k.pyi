...
class PTSSKCellSkaugenResponseStatistics:
    ...
    @overload
    def total_stored_water(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def total_stored_water(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def total_stored_water_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
...
class PTSSKCellSkaugenStateStatistics:
    ...
    @overload
    def nu(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def nu(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def nu_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def residual(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def residual(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def residual_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
