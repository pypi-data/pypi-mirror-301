...
class RPMGSKCellActualEvapotranspirationResponseStatistics:
    ...
    @overload
    def pot_ratio(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        ...
        ...
    @overload
    def pot_ratio(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns the ratio the ratio (1-exp(-water_level*3/scale_factor)) for cells matching catchments_ids at the i'th timestep
        """
        ...

    def pot_ratio_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
...
class RPMGSKCellGammaSnowStateStatistics:
    ...
    @overload
    def acc_melt(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def acc_melt(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def acc_melt_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def albedo(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def albedo(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def albedo_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def alpha(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def alpha(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def alpha_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def iso_pot_energy(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def iso_pot_energy(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def iso_pot_energy_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def lwc(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def lwc(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def lwc_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def sdc_melt_mean(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def sdc_melt_mean(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def sdc_melt_mean_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def surface_heat(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def surface_heat(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def surface_heat_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
    ...
    @overload
    def temp_swe(self, indexes: Union[IntVector,list[int],range], ix_type: stat_scope = statscope.catchment) -> TimeSeries:
        """
        returns sum  for catcment_ids
        ...
        ...
    @overload
    def temp_swe(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> DoubleVector:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...

    def temp_swe_value(self, indexes: Union[IntVector,list[int],range], i: int, ix_type: stat_scope = statscope.catchment) -> float:
        """
        returns  for cells matching catchments_ids at the i'th timestep
        """
        ...
