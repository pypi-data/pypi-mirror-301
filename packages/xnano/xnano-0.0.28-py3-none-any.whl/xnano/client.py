...
class Completions:
    ...
    def __patch_litellm_client__(self):
        ...
        return litellm_patch(self.client.base, mode=Mode.TOOLS)
    ...
    def completion(
        ...
        **kwargs
        ...
        if response_model:
            if model.startswith("o1-"):
                logger.warning("OpenAI O1- model detected. Using JSON_O1 Instructor Mode.")
                completion_client.client.patch.mode = Mode.JSON_O1
            else:
                completion_client.client.patch.mode = get_mode(mode)
