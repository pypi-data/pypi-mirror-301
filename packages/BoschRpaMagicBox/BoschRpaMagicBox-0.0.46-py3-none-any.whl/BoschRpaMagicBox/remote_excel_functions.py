...
def copy_worksheet(username, password, server_ip, server_name, share_name, source_file_path, source_sheet_name, target_file_path, target_sheet_name, port=445):
    ...
    source_file_obj = smb_load_file_obj(username, password, server_ip, server_name, share_name, source_file_path, port)
    source_workbook = load_workbook(source_file_obj)
    source_sheet = source_workbook[source_sheet_name]

    target_file_obj = smb_load_file_obj(username, password, server_ip, server_name, share_name, target_file_path, port)
    target_workbook = load_workbook(target_file_obj)
    ...
    smb_store_remote_file_by_obj(username, password, server_ip, server_name, share_name, target_file_path, output_io, port)
