...
def year(date_value: Any) -> pl.Expr:
    ...
    Args:
        date_value (Any): The date or timestamp to extract the year from. Can be a FlowFile expression or any other value.
...
def month(date_value: Any) -> pl.Expr:
    ...
    Args:
        date_value (Any): The date or timestamp to extract the month from. Can be a FlowFile expression or any other value.
...
def day(date_value: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The date or timestamp to extract the day from. Can be a FlowFile expression or any other value.
...
def hour(date_value: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to extract the hour from.
...
def minute(date_value: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to extract the minute from.
...
def second(date_value: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to extract the second from.
...
def add_days(date_value: PlStringType, days: PlIntType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The date or Polars expression to add days to.
...
def add_years(date_value: PlStringType, years: PlIntType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The date or Polars expression to add years to.
...
def add_hours(date_value: PlStringType, hours: PlIntType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to add hours to.
...
def add_minutes(date_value: PlStringType, minutes: PlIntType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to add minutes to.
...
def add_seconds(date_value: PlStringType, seconds: PlIntType) -> pl.Expr:
    ...
    Args:
        date_value (PlStringType): The timestamp or Polars expression to add seconds to.
...
def datetime_diff_seconds(date_value1: PlStringType, date_value2: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value1 (PlStringType): The first timestamp or Polars expression.
        date_value2 (PlStringType): The second timestamp or Polars expression.
...
def date_diff_days(date_value1: PlStringType, date_value2: PlStringType) -> pl.Expr:
    ...
    Args:
        date_value1 (PlStringType): The first date or Polars expression.
        date_value2 (PlStringType): The second date or Polars expression.
...
def date_trim(date_value: Any, part: str) -> pl.Expr:
    ...
    Args:
        date_value (Any): The date or timestamp to trim. Can be a FlowFile expression or any other value.
...
def date_truncate(date_value: Any, truncate_by: str) -> pl.Expr:
    ...
    Args:
        date_value (Any): The date or timestamp to truncate. Can be a FlowFile expression or any other value.
        truncate_by (str): The part of the date to truncate by. Can be 'Nyear', 'Nmonth', 'Nday', 'Nhour', 'Nminute', or 'Nsecond'.
