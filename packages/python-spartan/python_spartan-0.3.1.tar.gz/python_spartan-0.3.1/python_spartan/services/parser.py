...
class ParserService:
    def __init__(self, name: str):
        ...
        self.destination_folder = "parsers"
        self.source_stub = os.path.join(
            self.home_directory, "stubs", "parser", "default.stub"
        )
    ...
    def create_parser_file(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            try:
                ...
                print(f"An error occurred while writing the new parser file: {e}")
        else:
            print(f"File '{self.file_path}' already exists. Skipping creation.")

    def delete_parser_file(self):
