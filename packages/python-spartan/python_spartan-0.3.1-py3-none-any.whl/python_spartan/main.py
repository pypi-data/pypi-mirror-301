...
app.add_typer(layer_app, name="layer", help="Compress local packages into single zip file.")
...
def create_test(test_name: str):
    """
    Create a new test file with the specified name.
    """
    try:
        # Create a new test file using TestService
        test_service = TestService(name=test_name)
        test_service.create_test_file()
        print(f"Test file and stub for '{test_name}' created.")
    except Exception as e:
