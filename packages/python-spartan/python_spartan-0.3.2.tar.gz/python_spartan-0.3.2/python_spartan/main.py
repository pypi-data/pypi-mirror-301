...
def create_test(
    test_name: str,
    integration: bool = typer.Option(False, "--integration", "-i", help="Create an integration test."),
    output: str = typer.Option(None, "--output", "-o", help="Specify the output directory for the test file."),
):
    """
    ...
    try:
        ...
        test_service = TestService(name=test_name, integration=integration, output_path=output)
