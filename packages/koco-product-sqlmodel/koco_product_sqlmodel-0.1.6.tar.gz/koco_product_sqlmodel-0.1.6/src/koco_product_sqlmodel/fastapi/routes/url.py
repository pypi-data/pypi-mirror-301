...
class UrlRoute(rgen.ParentRoute):
    ...
    async def post_object(self, object: sqlm.CUrlPost, request: Request) -> sqlm.SQLModel:
    ...
    async def patch_object(self, id: int, obj: sqlm.CUrlPost, request: Request) -> sqlm.SQLModel:
