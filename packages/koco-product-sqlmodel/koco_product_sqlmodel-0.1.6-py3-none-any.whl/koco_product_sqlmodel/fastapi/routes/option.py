...
class OptionRoute(rgen.MyBaseRoute):
    ...
    async def post_object(self, object: sqlm.COptionPost, request: Request) -> sqlm.SQLModel:
    ...
    async def patch_object(self, id: int, obj: sqlm.COptionPost, request: Request) -> sqlm.SQLModel:
