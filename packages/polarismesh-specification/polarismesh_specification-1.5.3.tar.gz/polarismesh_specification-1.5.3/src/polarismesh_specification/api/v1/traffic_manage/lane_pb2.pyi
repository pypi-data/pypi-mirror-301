...
class LaneGroup(_message.Message):
    __slots__ = ("id", "name", "entries", "destinations", "revision", "description", "ctime", "mtime", "rules", "metadata", "baselineFilterStrategy", "editable", "deleteable")
    class BaselineFilterStrategy(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        NOT_MATCH_KEY: _ClassVar[LaneGroup.BaselineFilterStrategy]
        NOT_MATCH_KEY_VALUES: _ClassVar[LaneGroup.BaselineFilterStrategy]
    NOT_MATCH_KEY: LaneGroup.BaselineFilterStrategy
    NOT_MATCH_KEY_VALUES: LaneGroup.BaselineFilterStrategy
    ...
    BASELINEFILTERSTRATEGY_FIELD_NUMBER: _ClassVar[int]
    ...
    baselineFilterStrategy: LaneGroup.BaselineFilterStrategy
    editable: bool
    deleteable: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., entries: _Optional[_Iterable[_Union[TrafficEntry, _Mapping]]] = ..., destinations: _Optional[_Iterable[_Union[_routing_pb2.DestinationGroup, _Mapping]]] = ..., revision: _Optional[str] = ..., description: _Optional[str] = ..., ctime: _Optional[str] = ..., mtime: _Optional[str] = ..., rules: _Optional[_Iterable[_Union[LaneRule, _Mapping]]] = ..., metadata: _Optional[_Mapping[str, str]] = ..., baselineFilterStrategy: _Optional[_Union[LaneGroup.BaselineFilterStrategy, str]] = ..., editable: bool = ..., deleteable: bool = ...) -> None: ...
...
class LaneRule(_message.Message):
    __slots__ = ("id", "name", "group_name", "traffic_match_rule", "default_label_value", "enable", "match_mode", "revision", "ctime", "mtime", "etime", "priority", "description", "label_values", "label_key")
