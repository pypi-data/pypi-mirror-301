...
@task_deco('fs_put_local', function_timeout=120, concurrent_mode=ConcurrentModeEnum.ASYNC, concurrent_num=4, broker_kind=BrokerEnum.LOCAL_PYTHON_QUEUE, max_retry_times=2)
...
@task_deco('fs_get_{}_local'.format(cfg['NODE_ID']), function_timeout=60, concurrent_mode=ConcurrentModeEnum.ASYNC, concurrent_num=4, broker_kind=BrokerEnum.LOCAL_PYTHON_QUEUE, max_retry_times=2)
