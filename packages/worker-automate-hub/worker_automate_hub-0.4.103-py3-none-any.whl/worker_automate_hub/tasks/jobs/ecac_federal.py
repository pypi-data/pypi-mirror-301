                    ...
                    async with async_playwright() as p:
                        ...
                        if element_popup_certificate_pos == None:
                            ...
                            try:
                                ...
                                await page.goto(ecac_login_url, timeout=80000, wait_until='load')
                                try:
                                ...
                                await page.locator(XPATH_ECAC_ENTRAR).click(timeout=80000)
                                try:
                                    await page.wait_for_load_state("networkidle")
                                except:
                                    await asyncio.sleep(3)
                                ...
                                await page.locator(XPATH_SSO_GOV).dblclick(timeout=90000)
                                await asyncio.sleep(9)

                                try:
                                    await page.locator('//*[@id="identidade-govbr"]').click()
                                except:
                                    pass
                                ...
                                try:
                                    ...
                                    await page.locator('//*[@id="login-certificate"]').click()
                                    await asyncio.sleep(2)
