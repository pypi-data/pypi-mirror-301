    ...
    try:
        ...
        try:
            while True:
                ...
                await worker_sleep(4)
                try:
                    console.print(f"SELECIONANDO UB-24 - F PARA UNIDADE ...\n")
                    ...
                    get_unidade = main_window.child_window(class_name="TDBIComboBox", found_index=1)
                    if get_unidade.window_text() != "UN-24 - F" or get_unidade.window_text() != "UNIDADE":
                        return {"sucesso": False, "retorno": f"Erro ao selecionar o tipo de unidade nos itens, não possui UN-24 - F ou UNIDADE"} 
