...
import json
import inspect
from creaap.formats import datetime_to_tables_string, to_table_storage_key, unfuck_numpy_formats
    ...
    def to_table_entities(self):
        ...
        for key, value in self.__dict__.items():
            if (key == self.partition_key):
                out['PartitionKey'] = to_table_storage_key(value)
            elif key == self.row_key:
                out['RowKey'] = to_table_storage_key(value)
