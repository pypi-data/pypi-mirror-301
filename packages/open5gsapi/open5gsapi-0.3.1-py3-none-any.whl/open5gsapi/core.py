...
class Session:
    def __init__(self, parent, name):
        self.parent = parent
        self.name = name
        self.type = 1  # Default: IPv4
        self.ambr = AMBR(self)
        self.qos = QoS(self)
        self.arp = ARP(self)
        self.pcc_rule = [PccRule(self), PccRule(self)]  # Initialize with two PCC rules
                            ...
                            pcc_rule_config = {
                                'qos': {
                                    ...
                                    'arp': {
                                        ...
                                        'pre_emption_vulnerability': pcc_rule.qos.arp.pre_emption_vulnerability,
                                        'pre_emption_capability': pcc_rule.qos.arp.pre_emption_capability
                                    },
                                    'mbr': {
                                        'downlink': {'value': pcc_rule.mbr.downlink.value, 'unit': pcc_rule.mbr.downlink.unit},
                                        'uplink': {'value': pcc_rule.mbr.uplink.value, 'unit': pcc_rule.mbr.uplink.unit}
                                    },
                                    'gbr': {
                                        'downlink': {'value': pcc_rule.gbr.downlink.value, 'unit': pcc_rule.gbr.downlink.unit},
                                        'uplink': {'value': pcc_rule.gbr.uplink.value, 'unit': pcc_rule.gbr.uplink.unit}
                                    }
                                },
                                'flow': pcc_rule.flow
                            }
                            session_config['pcc_rule'].append(pcc_rule_config)
