...
class BaseAPI(_Base):
    ...
    def _execute(self, data: dict | str, method: str = 'POST', headers: dict = None, override_profile_data: dict = None,
        ...
        if self.POST_METHOD == method:
            self._response = kdb_driver.requests.post(url, json=self._request_data, headers=self._headers,
                                                      **kwargs)
