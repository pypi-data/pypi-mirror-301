...
def test_processSequence_noheading(datafiles, initSequenceApp, tmp_path, dburl):
    with psycopg.connect(dburl, row_factory=dict_row) as db2, initSequenceApp(datafiles, preprocess=False):
