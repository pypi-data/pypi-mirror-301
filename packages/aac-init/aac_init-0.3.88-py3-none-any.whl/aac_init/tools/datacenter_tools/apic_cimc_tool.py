...
class APIC_CIMC_Tool:
    ...
    def ssh_install_apic(self):
        ...
        try:
            ...
            self.ssh_connection.send_command("exit", "1 packets transmitted, 1 received, 0% packet loss", read_timeout=120)
            ...
            while time.time() - start_time < 15*60:
                ...
                if new_data and (
                    r"Enter the artifact URL (empty if done):" in new_data
                ):
