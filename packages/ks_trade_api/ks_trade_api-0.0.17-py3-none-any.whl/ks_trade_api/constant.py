...
class RthTime(Enum):
    # 美股时间
    US_EQUITY_PRE_MARKET_START = time(4, 0, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_PRE_MARKET_END = time(9, 30, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_RTH_START = time(9, 30, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_RTH_END = time(16, 0, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_AFTER_HOURS_START = time(16, 0, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_AFTER_HOURS_END = time(20, 0, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_OVER_NIGHT_START = time(20, 0, 0, 0, tzinfo=US_EASTERN_TZ)
    US_EQUITY_OVER_NIGHT_END = time(4, 0, 0, 0, tzinfo=US_EASTERN_TZ)

    # 港股时间
    HK_EQUITY_RTH_START = time(9, 30, 0, 0, tzinfo=CHINA_TZ)
    HK_EQUITY_AFTER_HOURS_END = time(16, 0, 0, 0, tzinfo=CHINA_TZ)
