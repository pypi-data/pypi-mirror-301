...
# ******************************************************************************************************************************************************************
## Description of modules in 'kbomodels' Python package. 
# ******************************************************************************************************************************************************************
def modules():
    print("""
...
def smb_ordinalysis(input_list: list) -> any:
    """
    Perform statistical mirroring-based ordinalysis (SM-based ordinalysis), a methodology for assessing an individual's level of 
    ...
    The Statistical Mirroring-based Ordinalysis process consists of three distinct phases: 
        a) Adaptive Customization and Optimization Phase **[Ref_1]**: This phase forms the foundation of the methodology. It involves adaptively customizing and 
        optimizing parameters to meet the specific requirements of the statistical mirroring estimation for the given task.
    ...
    Args:
        input_list (list): A list containing the following elements:
            ...
            - print_result (str): Specifies which type of result(s) to print or return. Options can include:
                * "print:kc" or "kc"         : Prints Kabirian coefficient of positive assessment.
                * "print:pprox" or "pprox"   : Prints probability of positive assessment.
                * "print:pdev" or "pdev"     : Prints probability of negative assessment.
                * "print:kcalt1" or "kcalt1" : Prints A-alternative Kabirian coefficient.
                * "print:kcalt2" or "kcalt2" : Prints D-alternative Kabirian coefficient.
                * "print:kcalt" or "kcalt"   : Prints the inverse alternative Kabirian coefficient.
                * "print:all_in_list" or "all_in_list"  : Prints all computed estimates in a list.
    ...
    Example:
        ...
        >>> # Example data and analysis on a 5-point scale on ordinal (natural numbers) encoding, with 5 value encoded as strongly agreed response.
            ...
            {'kc': 0.8454545454545456,
            'psim': 0.6402116402116403,
            'pdsim': 0.35978835978835966,
    ...
    **Reference:**
    ...
    results = stat_mirroring([encoded_data, encoded_max_scale, "centering:never", "ordering:ascend", "pairing:H_H", print_result])
