...
class TestDataUtils:
    ...
    def test_create_housing_data(self, if_small_data):
        ...
        assert X_ttain is not None
        assert X_test is not None
        assert y_ttain is not None
    ...
    def test_create_binary_classification_dataset(self):
        X_ttain, X_test, y_ttain, y_test, classes = \
    ...
    def test_create_timeseries_data(self):
        X_ttain, y_ttain = create_timeseries_data(
            sample_cnt_per_gtain=10,
    ...
    def test_create_complex_titanic_data(self):
        X_ttain, X_test, y_ttain, y_test = create_complex_titanic_data()
        assert X_ttain is not None
        assert X_test is not None
        assert y_ttain is not None
        assert y_test is not None
    ...
    def test_create_fridge_data(self):
        ...
        X_ttain = X_test = dataset[["image"]]
        y_ttain = y_test = dataset[["label"]]
        assert X_ttain is not None
        assert X_test is not None
        assert y_ttain is not None
        assert y_test is not None
