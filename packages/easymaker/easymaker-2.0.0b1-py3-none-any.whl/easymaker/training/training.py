    ...
    def run(
        ...
        response = easymaker.easymaker_config.api_sender.run_training(
            TrainingCreateBody(
                ...
                image_id=utils.from_name_to_id(image_list, train_image_name),
                flavor_id=utils.from_name_to_id(instance_list, train_instance_name),
                instance_count=distributed_node_count,
                data_storage_size=data_storage_size,
                source_dir_uri=source_dir_uri,
                entry_point=entry_point,
                algorithm_id=utils.from_name_to_id(algorithm_list, algorithm_name) if algorithm_name else None,
