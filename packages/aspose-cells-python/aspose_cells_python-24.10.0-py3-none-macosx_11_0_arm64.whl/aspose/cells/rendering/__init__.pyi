...
class ImageOrPrintOptions:
    ...
    def chart_image_type(self, value : aspose.pydrawing.imaging.ImageFormat) -> None:
        '''Indicate the chart imagetype when converting.
        default value: PNG.'''
        raise NotImplementedError()
    ...
    @emf_type.setter
    def emf_type(self, value : aspose.pydrawing.imaging.EmfType) -> None:
...
class SheetRender:
    ...
    @overload
    def to_printer(self, printer_settings : aspose.pydrawing.printing.PrinterSettings) -> None:
        '''Render worksheet to Printer
    ...
    @overload
    def to_printer(self, printer_settings : aspose.pydrawing.printing.PrinterSettings, job_name : str) -> None:
        '''Render worksheet to Printer
