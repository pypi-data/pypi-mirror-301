...
class PivotField:
    ...
    @overload
    def group_by(self, start : datetime, end : datetime, groups : List[aspose.cells.pivot.PivotGroupByType], interval : float, first_as_new_field : bool) -> None:
    ...
    @overload
    def group_by(self, start : float, end : float, interval : float, new_field : bool) -> None:
    ...
    @overload
    def group_by(self, custom_group_items : List[aspose.cells.pivot.CustomPiovtFieldGroupItem], new_field : bool) -> None:
