...
class ModelClient:
    ...
    def publish(
        ...
        self.logger_client.info(f"Model {model_id} and related processor launched successfully, optionally, open this url to run your model in UI: https://proxy.vipas.ai/models/{model_id}.")
