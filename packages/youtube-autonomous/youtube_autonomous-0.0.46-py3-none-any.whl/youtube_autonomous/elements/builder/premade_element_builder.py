...
class PremadeElementBuilder(ElementBuilder):
    ...
    def build_from_enhancement(cls, enhancement: dict):
        ...
        # TODO: I need to avoid 'duration' here
        parameters = super().extract_extra_params(enhancement, cls.premade_name_to_class(premade_name).generate, ['self', 'cls', 'args', 'kwargs', 'duration'])
    ...
    def build_from_segment(cls, segment: dict):
        ...
        parameters = super().extract_extra_params(segment, cls.premade_name_to_class(premade_name).generate, ['self', 'cls', 'args', 'kwargs', 'duration'])
