    ...
    def __init__(self, shortcode_tags: list[ShortcodeTag]):
        ...
        for shortcode_tag in shortcode_tags:
            if shortcode_tag.is_block_scoped():
                self.__parser.register(lambda shortcodes, pargs, kwargs, context, content: shortcode_tag.handler(shortcodes, pargs, kwargs, context, content), shortcode_tag.tag.value, f'/{shortcode_tag.tag.value}')
            else:
                self.__parser.register(lambda shortcodes, pargs, kwargs, context, content: shortcode_tag.handler(shortcodes, pargs, kwargs, context, content), shortcode_tag.tag.value)
