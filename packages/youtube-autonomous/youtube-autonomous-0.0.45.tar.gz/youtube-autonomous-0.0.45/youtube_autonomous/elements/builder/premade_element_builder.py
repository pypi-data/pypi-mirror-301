...
class PremadeElementBuilder(ElementBuilder):
    ...
    def build_from_enhancement(cls, enhancement: dict):
        ...
        parameters = super().extract_extra_params(enhancement, cls.premade_name_to_class(premade_name).__init__, ['self', 'cls', 'args', 'kwargs', 'duration'])
    ...
    def build_from_segment(cls, segment: dict):
        ...
        parameters = super().extract_extra_params(segment, cls.premade_name_to_class(premade_name).__init__, ['self', 'cls', 'args', 'kwargs', 'duration'])
