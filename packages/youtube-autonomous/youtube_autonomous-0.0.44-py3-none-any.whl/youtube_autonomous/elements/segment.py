        ...
        for enhancement in sorted(self.enhancements, key = lambda enhancement: enhancement.start):
            ...
            if enhancement.mode == EnhancementMode.INLINE.value:
                ...
                if enhancement.type in [EnhancementType.EFFECT.value, EnhancementType.EFFECT]:
                    ...
                    if issubclass(enhancement_clip, MoviepyEffect):
                        enhancement_clip = enhancement_clip(clip = self.video_clip.subclip(enhancement.start, end), **parameters).apply()
                    elif issubclass(enhancement_clip, VideoEffect):
                        enhancement_clip = enhancement_clip(video = self.video_clip.subclip(enhancement.start, end)).apply(**parameters)
                    # TODO: What about 'BasePositionMoviepyEffect' (?)
