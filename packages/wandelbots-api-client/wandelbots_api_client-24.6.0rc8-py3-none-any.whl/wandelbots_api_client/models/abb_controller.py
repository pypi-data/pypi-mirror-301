...
from wandelbots_api_client.models.abb_controller_all_of_egm_server import AbbControllerAllOfEgmServer
...
class AbbController(BaseModel):
    ...
    egm_server: AbbControllerAllOfEgmServer = Field(alias="egmServer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "egmServer": AbbControllerAllOfEgmServer.from_dict(obj["egmServer"]) if obj.get("egmServer") is not None else None
        })
        return _obj
