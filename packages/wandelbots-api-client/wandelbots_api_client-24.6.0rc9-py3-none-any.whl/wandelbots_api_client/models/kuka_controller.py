...
from wandelbots_api_client.models.controller_kind import ControllerKind
from wandelbots_api_client.models.kuka_controller_all_of_rsi_server import KukaControllerAllOfRsiServer
...
class KukaController(BaseModel):
    ...
    rsi_server: KukaControllerAllOfRsiServer = Field(alias="rsiServer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rsiServer": KukaControllerAllOfRsiServer.from_dict(obj["rsiServer"]) if obj.get("rsiServer") is not None else None
        })
        return _obj
