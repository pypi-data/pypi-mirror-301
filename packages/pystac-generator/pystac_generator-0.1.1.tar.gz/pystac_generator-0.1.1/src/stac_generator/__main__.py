...
from src.stac_generator.base.schema import StacCatalogConfig, StacCollectionConfig
from src.stac_generator.generator_factory import StacGeneratorFactory
...
def run_cli() -> None:
    ...
    collection_metadata.add_argument("--title", type=str, help="title of collection", required=False, default="Auto-generated.")
    ...
    # Catalog Information
    catalog_metadata = parser.add_argument_group("STAC catalog metadata- Derived from STAC Collection metadata if not provided")
    ...
    common_metadata.add_argument("--license", type=str, help="STAC license", required=False, default="proprietary")
    common_metadata.add_argument("--platform", type=str, help="STAC platform", required=False, default=None)
    common_metadata.add_argument("--constellation", type=str, help="STAC constellation", required=False, default=None)
    common_metadata.add_argument("--mission", type=str, help="STAC mission", required=False, default=None)
    ...
    collection_config = StacCollectionConfig(
        ...
        start_datetime=args.start_datetime if args.start_datetime else metadata_json.get("start_datetime"),
        ...
        constellation=args.constellation if args.constellation else metadata_json.get("constellation"),
