...
class OakEmuEnv(gym.Env):
    ...
    def __init__(
        ...
        self._actions = list(self._game.actions)
    ...
    def step(
        ...
        step_result = self._game.execute_step(action_name)
    ...
    def _get_obs(self) -> np.ndarray:
        if self._obs_type == "spectrum":
            return self._game.spectrum.get_pixel_colour_screenshot()
        elif self._obs_type == "rgb":
            return self._game.spectrum.get_rgb_screenshot()
        else:
            return self._game.spectrum.get_screen()
    ...
    def render(self) -> np.ndarray | None:
        screenshot = self._game.spectrum.get_rgb_screenshot()
