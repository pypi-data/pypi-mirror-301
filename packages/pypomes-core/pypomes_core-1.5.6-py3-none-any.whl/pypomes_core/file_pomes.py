...
def file_get_data(file_data: Path | str | bytes,
    ...
    :param chunk_size: optional chunk size used in reading the data, defaults to 128KB
        ...
        with file_path.open(mode="rb") as f:
            ...
            while in_bytes:
                ...
                if max_len and max_len <= len(file_bytes):
                    break
                buf_size = min(max_len - len(file_bytes), chunk_size) if max_len else chunk_size
