...
from test_tai_vision_insights import run_tai_insights

from trustworthyai_vision import ModelTask
...
class TestRAIVisionInsightsAutoMLImages(object):
    ...
    def test_tai_insights_automl_image_classification_fridge(self):
