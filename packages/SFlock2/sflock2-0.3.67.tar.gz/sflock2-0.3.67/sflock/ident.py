...
def android(f):
    # ToDo I see cases where it can't list childs
    # e9236ee727aa718eecabd4adce06da5b8cc2a1d9fde2706d2a24af8e2ccad347 - apk without children
    if b"AndroidManifest.xml" in f.contents and b"classes.dex" in f.contents:
        return "apk"
