      ...
      <div class="pricing-step-content roi flex flex-col" v-if="orderPricing && order && orderPricing.supplier_id">
        ...
        <div class="roi-results flex py-[0.75rem]">
          ...
          <div class="roi-results-wrap w-6/12 flex items-center px-[0.75rem]">
            ...
            <div class="roi-results-value-green" ref="roiEl">{{
...
const {
  ...
  (roiEl.value! as HTMLElement).style.backgroundColor = orderRoi.value.roi_parameters?.background_fill_hex ? `#${orderRoi.value.roi_parameters?.background_fill_hex}` : 'rgb(58, 176, 80)';
  (roiEl.value! as HTMLElement).style.color = orderRoi.value.roi_parameters?.text_colour_hex ? `#${orderRoi.value.roi_parameters?.text_colour_hex}` : 'rgb(255, 255, 255)';
