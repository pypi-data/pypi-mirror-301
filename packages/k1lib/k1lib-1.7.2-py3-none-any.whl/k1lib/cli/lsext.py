...
class LiConn:                                                                    # LiConn
    def __init__(self, conn, fn): self.conn = conn; self.fn = fn; self._lastrowid = None # LiConn
    def queryRaw(self, f): cur = self.conn.cursor(); res = f(cur); self.conn.commit(); cur.close(); return res # LiConn
