...
class ServiceResource(SchemaObjectReferenceMixin[ServiceCollection]):
    ...
    def create_or_alter(
        ...
        """
        self.collection._api.create_or_alter_service(self.database.name, self.schema.name, self.name, service,
                                                     async_req=False)
    ...
    def drop(self) -> None:
        ...
        """
        self.collection._api.delete_service(self.database.name, self.schema.name, self.name, False, async_req=False)
    ...
    def suspend(self) -> None:
        ...
        """
        self.collection._api.suspend_service(self.database.name, self.schema.name, self.name, async_req=False)
    ...
    def resume(self) -> None:
        ...
        """
        self.collection._api.resume_service(self.database.name, self.schema.name, self.name, async_req=False)
    ...
    @api_telemetry
    def get_containers(self) -> Iterable[ServiceContainer]:
        ...
        """
        return self.collection._api.list_service_containers(
            self.database.name, self.schema.name, self.name, async_req=False
        )

    @api_telemetry
    def get_instances(self) -> Iterable[ServiceInstance]:
        ...
        """
        return self.collection._api.list_service_instances(
            self.database.name, self.schema.name, self.name, async_req=False
        )

    @api_telemetry
    def get_roles(self) -> Iterable[ServiceRole]:
        ...
        """
        return self.collection._api.list_service_roles(
            self.database.name, self.schema.name, self.name, async_req=False
        )
