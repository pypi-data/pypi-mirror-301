...
class FileTransferMaterial(BaseModel):
    ...
    presigned_url : str, optional
        Presigned url for file transfer.
    query_stage_master_key : str, optional
        Query stage master key for client side file encryption. NULL if the stage does not use client encryption.
    query_id : str, optional
        Query id for client side file encryption. NULL if the stage does not use client encryption or the presigned_url is used for downloading.
    smk_id : int, optional
        SMK id for client side file encryption. NULL if the stage does not use client encryption or the presigned_url is used for downloading.
    """
