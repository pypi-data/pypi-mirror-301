...
class NetworkPolicyCollection(AccountObjectCollectionParent["NetworkPolicyResource"]):
    ...
    def create(
        ...
        network_policy: NetworkPolicy
            ...
            name
            allowed_network_rule_list, blocked_network_rule_list are optional
            allowed_ip_list, blocked_ip_list, comment are optional
...
class NetworkPolicyResource(ObjectReferenceMixin[NetworkPolicyCollection]):
    ...
    def drop(self) -> None:
        ...
        """
        self.collection._api.delete_network_policy(self.name, async_req=False)
