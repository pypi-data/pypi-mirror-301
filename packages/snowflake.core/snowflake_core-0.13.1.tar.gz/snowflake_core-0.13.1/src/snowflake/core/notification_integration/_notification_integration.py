...
class NotificationIntegrationCollection(AccountObjectCollectionParent["NotificationIntegrationResource"]):
    ...
    def iter(
        ...
        *,
    ...
    ) -> typing.Iterator[NotificationIntegration]:
        ...
        Showing notification integrations starting with 'prefix-':

        >>> notification_integrations = notification_integrations.iter(like="prefix-%")
