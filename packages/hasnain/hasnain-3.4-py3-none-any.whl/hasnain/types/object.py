...
class Object:
    def __init__(self, client: "hasnain.Client" = None):
        self._client = client

    def bind(self, client: "hasnain.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~hasnain.types.Client`):
