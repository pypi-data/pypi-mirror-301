...
DESTINATION_PATH = Path("hasnain_kk/raw")
NOTICE_PATH = "NOTICE"
...
def get_docstring_arg_type(t: str):
    if t in CORE_TYPES:
        ...
        return "Any object from :obj:`~hasnain_kk.raw.types`"
    elif t == "!X":
        return "Any function from :obj:`~hasnain_kk.raw.functions`"
    elif t.lower().startswith("vector"):
        return "List of " + get_docstring_arg_type(t.split("<", 1)[1][:-1])
    else:
        return f":obj:`{t} <hasnain_kk.raw.base.{t}>`"
...
def start(format: bool = False):
    ...
    for qualtype in types_to_constructors:
        ...
        docstring += f"\n\n    Constructors:\n" \
                     ...
                     f"        .. currentmodule:: hasnain_kk.raw.types\n\n" \
                     f"        .. autosummary::\n" \
                     f"            :nosignatures:\n\n" \
                     f"            {items}"
        ...
        if references:
            docstring += f"\n\n    Functions:\n        This object can be returned by " \
                         ...
                         f"        .. currentmodule:: hasnain_kk.raw.functions\n\n" \
                         f"        .. autosummary::\n" \
                         f"            :nosignatures:\n\n" \
                         f"            " + references
    ...
    for c in combinators:
        ...
        if c.section == "types":
            ...
            docstring += f"\n    Constructor of :obj:`~hasnain_kk.raw.base.{c.qualtype}`."
        else:
    ...
    with open(DESTINATION_PATH / "all.py", "w", encoding="utf-8") as f:
        ...
        for c in combinators:
            f.write(f'\n    {c.id}: "hasnain_kk.raw.{c.section}.{c.qualname}",')

        f.write('\n    0xbc799737: "hasnain_kk.raw.core.BoolFalse",')
        f.write('\n    0x997275b5: "hasnain_kk.raw.core.BoolTrue",')
        f.write('\n    0x1cb5c415: "hasnain_kk.raw.core.Vector",')
        f.write('\n    0x73f1f8dc: "hasnain_kk.raw.core.MsgContainer",')
        f.write('\n    0xae500895: "hasnain_kk.raw.core.FutureSalts",')
        f.write('\n    0x0949d9dc: "hasnain_kk.raw.core.FutureSalt",')
        f.write('\n    0x3072cfa1: "hasnain_kk.raw.core.GzipPacked",')
        f.write('\n    0x5bb8e511: "hasnain_kk.raw.core.Message",')
