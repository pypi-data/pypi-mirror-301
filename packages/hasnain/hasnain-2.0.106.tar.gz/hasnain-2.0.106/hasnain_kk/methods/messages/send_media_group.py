...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~hasnain_kk.types.InputMediaPhoto`, :obj:`~hasnain_kk.types.InputMediaVideo`, :obj:`~hasnain_kk.types.InputMediaAudio` and :obj:`~hasnain_kk.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~hasnain_kk.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from hasnain_kk.types import InputMediaPhoto, InputMediaVideo
