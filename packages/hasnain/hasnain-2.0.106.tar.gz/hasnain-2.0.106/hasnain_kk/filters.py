...
from hasnain_kk.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "hasnain_kk.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~hasnain_kk.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~hasnain_kk.handlers.MessageHandler` the *update* argument will be a :obj:`~hasnain_kk.types.Message`; in a :obj:`~hasnain_kk.handlers.CallbackQueryHandler` the *update* will be a :obj:`~hasnain_kk.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~hasnain_kk.filters.command` or :meth:`~hasnain_kk.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Document` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Game` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Video` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Location` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~hasnain_kk.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~hasnain_kk.types.Message`.
    ...
    async def func(flt, client: hasnain_kk.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~hasnain_kk.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~hasnain_kk.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~hasnain_kk.types.InlineQuery`: The filter will match ``query``.
