...
from hasnain.crypto import aes, rsa, prime
from hasnain.errors import SecurityCheckMismatch
from hasnain.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "hasnain.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
