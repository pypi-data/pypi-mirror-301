...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~hasnain.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~hasnain.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~hasnain.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "hasnain". Get the first 50 results
                async for message in app.search_global("hasnain", limit=50):
                    print(message.text)
