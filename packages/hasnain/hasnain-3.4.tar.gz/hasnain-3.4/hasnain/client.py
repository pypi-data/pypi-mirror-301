...
import hasnain
from hasnain import __version__, __license__
from hasnain import enums
from hasnain import raw
from hasnain import utils
from hasnain.crypto import aes
from hasnain.errors import CDNFileHashMismatch
from hasnain.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from hasnain.handlers.handler import Handler
from hasnain.methods import Methods
from hasnain.session import Auth, Session
from hasnain.storage import FileStorage, MemoryStorage
from hasnain.types import User, TermsOfService
from hasnain.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~hasnain.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~hasnain.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.hasnain.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except hasnain.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
