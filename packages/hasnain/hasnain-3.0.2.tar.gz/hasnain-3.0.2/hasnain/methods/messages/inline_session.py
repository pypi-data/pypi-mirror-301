...
from hasnain.errors import AuthBytesInvalid
from hasnain.session import Session
from hasnain.session.auth import Auth


async def get_session(client: "hasnain.Client", dc_id: int):
