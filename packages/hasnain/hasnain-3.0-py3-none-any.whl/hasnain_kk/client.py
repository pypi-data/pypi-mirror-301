...
import hasnain_kk
from hasnain_kk import __version__, __license__
from hasnain_kk import enums
from hasnain_kk import raw
from hasnain_kk import utils
from hasnain_kk.crypto import aes
from hasnain_kk.errors import CDNFileHashMismatch
from hasnain_kk.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from hasnain_kk.handlers.handler import Handler
from hasnain_kk.methods import Methods
from hasnain_kk.session import Auth, Session
from hasnain_kk.storage import FileStorage, MemoryStorage
from hasnain_kk.types import User, TermsOfService
from hasnain_kk.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~hasnain_kk.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~hasnain_kk.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.hasnain_kk.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except hasnain_kk.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
