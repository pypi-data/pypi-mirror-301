...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~hasnain_kk.Client.stop` and then :meth:`~hasnain_kk.Client.start` in a row in
        ...
        Returns:
            :obj:`~hasnain_kk.Client`: The restarted client itself.
