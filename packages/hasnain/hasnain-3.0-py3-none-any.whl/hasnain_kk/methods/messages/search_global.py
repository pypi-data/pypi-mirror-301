...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~hasnain_kk.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~hasnain_kk.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~hasnain_kk.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "hasnain_kk". Get the first 50 results
                async for message in app.search_global("hasnain_kk", limit=50):
                    print(message.text)
