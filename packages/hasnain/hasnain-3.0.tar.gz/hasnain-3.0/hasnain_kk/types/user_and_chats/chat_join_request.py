...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~hasnain_kk.types.Chat`):
        ...
        invite_link (:obj:`~hasnain_kk.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~hasnain_kk.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~hasnain_kk.types.ChatJoinRequest`.
