...
from hasnain_kk.crypto import aes, rsa, prime
from hasnain_kk.errors import SecurityCheckMismatch
from hasnain_kk.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "hasnain_kk.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
