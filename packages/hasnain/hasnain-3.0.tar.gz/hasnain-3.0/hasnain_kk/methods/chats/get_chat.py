...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~hasnain_kk.types.Chat` | :obj:`~hasnain_kk.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("hasnain_kk")
                print(chat)
        """
