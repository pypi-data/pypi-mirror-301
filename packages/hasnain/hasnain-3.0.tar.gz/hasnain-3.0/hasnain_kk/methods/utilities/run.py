...
import hasnain_kk
from hasnain_kk.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~hasnain_kk.Client.start`, :meth:`~hasnain_kk.idle` and :meth:`~hasnain_kk.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`hasnain_kk.compose`.
