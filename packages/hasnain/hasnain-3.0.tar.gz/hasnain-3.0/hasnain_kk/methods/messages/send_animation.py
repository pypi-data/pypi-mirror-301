...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~hasnain_kk.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~hasnain_kk.Client.stop_transmission`, None is
            returned.
