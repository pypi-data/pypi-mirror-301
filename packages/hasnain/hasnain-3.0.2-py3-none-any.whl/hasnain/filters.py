...
from hasnain.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "hasnain.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~hasnain.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~hasnain.handlers.MessageHandler` the *update* argument will be a :obj:`~hasnain.types.Message`; in a :obj:`~hasnain.handlers.CallbackQueryHandler` the *update* will be a :obj:`~hasnain.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~hasnain.filters.command` or :meth:`~hasnain.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~hasnain.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Document` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Game` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Video` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Location` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~hasnain.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~hasnain.types.Message`.
    ...
    async def func(flt, client: hasnain.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~hasnain.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~hasnain.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~hasnain.types.InlineQuery`: The filter will match ``query``.
