...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~hasnain.types.InputMediaPhoto`, :obj:`~hasnain.types.InputMediaVideo`, :obj:`~hasnain.types.InputMediaAudio` and :obj:`~hasnain.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~hasnain.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from hasnain.types import InputMediaPhoto, InputMediaVideo
