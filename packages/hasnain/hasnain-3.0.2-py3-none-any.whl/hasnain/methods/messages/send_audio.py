...
import hasnain
from hasnain import StopTransmission, enums
from hasnain import raw
from hasnain import types
from hasnain import utils
from hasnain.errors import FilePartMissing
from hasnain.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~hasnain.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~hasnain.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~hasnain.Client.stop_transmission`, None is returned.
