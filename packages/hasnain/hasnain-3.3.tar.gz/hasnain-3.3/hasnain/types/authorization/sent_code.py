...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~hasnain.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~hasnain.Client.sign_in` or :meth:`~hasnain.Client.sign_up`).

        next_type (:obj:`~hasnain.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~hasnain.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~hasnain.Client.resend_code`.
    """
