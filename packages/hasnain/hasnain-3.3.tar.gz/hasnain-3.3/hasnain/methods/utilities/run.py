...
import hasnain
from hasnain.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~hasnain.Client.start`, :meth:`~hasnain.idle` and :meth:`~hasnain.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`hasnain.compose`.
