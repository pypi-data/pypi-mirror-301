...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~hasnain_kk.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~hasnain_kk.Client.sign_in` or :meth:`~hasnain_kk.Client.sign_up`).

        next_type (:obj:`~hasnain_kk.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~hasnain_kk.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~hasnain_kk.Client.resend_code`.
    """
