...
class Object:
    def __init__(self, client: "hasnain_kk.Client" = None):
        self._client = client

    def bind(self, client: "hasnain_kk.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~hasnain_kk.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/hasnain_kkchat/167281
    ...
    def __repr__(self) -> str:
        return "hasnain_kk.types.{}({})".format(
