...
import hasnain_kk
from hasnain_kk import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~hasnain_kk.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~hasnain_kk.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~hasnain_kk.types.BotCommand`: On success, the list of bot commands is returned.
