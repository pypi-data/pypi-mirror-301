...
from hasnain_kk.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~hasnain_kk.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~hasnain_kk.Client.stop_transmission`, None is returned.
