...
def eval_model(args):
    ...
    imgdir = args.image_file
    imgpaths = [tmp.path for tmp in mf.smart_scan_stat(imgdir)]
    for _, image_file in enumerate(imgpaths):
        image_list = []
        ...
        if args.render:
            ...
            imgname = mf.SmartPath(imgpath).stem

            txt_path = f's3://fucheng/test/0924/GOT_ocr/gpu/e2e/{imgdir}/{imgname}.txt'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="/data/model/models--vikp--GOT/")
    ...
    args = argparse.Namespace(
        ...
        image_file=f"s3://pdf/training/pdf_parser_pipeline/benchmark/bm_1221/imgs/net.20402/",
        # image_file="s3://fucheng/test/0924/GOT_ocr/imgs/",
        render=True,
        multi_page=False
    )
