...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_lwk_checksum_method_secretkey_bytes() != 44270:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_signer_keyorigin_xpub() != 45874:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_method_txout_script_pubkey() != 7466:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_txout_unblind() != 61899:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_method_wollet_wait_for_tx() != 43566:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_wolletdescriptor_derive_blinding_key() != 36522:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_wolletdescriptor_is_mainnet() != 62487:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_wolletdescriptor_script_pubkey() != 49110:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_address_new() != 10931:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_bip_new_bip49() != 11926:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_bip_new_bip84() != 18094:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_bip_new_bip87() != 59201:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_constructor_esploraclient_new() != 20614:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_esploraclient_new_waterfalls() != 58795:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_constructor_script_new() != 2756:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_secretkey_from_bytes() != 13343:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_signer_new() != 63885:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_signer_random() != 32064:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class Bip:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_lwk_fn_free_bip, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_lwk_fn_clone_bip, self._pointer)
    ...
    def new_bip49(cls, ):
        ...
        pointer = _rust_call(_UniffiLib.uniffi_lwk_fn_constructor_bip_new_bip49,)
    ...
    def new_bip84(cls, ):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_lwk_fn_constructor_bip_new_bip84,)
        return cls._make_instance_(pointer)
    ...
    def new_bip87(cls, ):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_lwk_fn_constructor_bip_new_bip87,)
        return cls._make_instance_(pointer)
...
class ElectrumClient:
    ...
    def ping(self, ):
        _rust_call_with_error(
    _UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_electrumclient_ping,self._uniffi_clone_pointer(),)
...
class EsploraClient:
    ...
    @classmethod
    def new_waterfalls(cls, url: "str"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_lwk_fn_constructor_esploraclient_new_waterfalls,
        _UniffiConverterString.lower(url))
        return cls._make_instance_(pointer)
...
class SecretKey:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_lwk_fn_free_secretkey, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_lwk_fn_clone_secretkey, self._pointer)
    ...
    def from_bytes(cls, bytes: "bytes"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_constructor_secretkey_from_bytes,
    ...
    def bytes(self, ) -> "bytes":
        return _UniffiConverterBytes.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_secretkey_bytes,self._uniffi_clone_pointer(),)
        )
...
class Signer:
    ...
    def random(cls, network: "Network"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_constructor_signer_random,
        _UniffiConverterTypeNetwork.lower(network))
        return cls._make_instance_(pointer)
    ...
    def keyorigin_xpub(self, bip: "Bip") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(
    _UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_signer_keyorigin_xpub,self._uniffi_clone_pointer(),
    ...
    def mnemonic(self, ) -> "Mnemonic":
        return _UniffiConverterTypeMnemonic.lift(
            _rust_call_with_error(
    _UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_signer_mnemonic,self._uniffi_clone_pointer(),)
        )
...
class Transaction:
    ...
    def outputs(self, ) -> "typing.List[TxOut]":
        return _UniffiConverterSequenceTypeTxOut.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_transaction_outputs,self._uniffi_clone_pointer(),)
        )
...
class TxOut:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_lwk_fn_free_txout, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_lwk_fn_clone_txout, self._pointer)
    ...
    def asset(self, ) -> "typing.Optional[AssetId]":
        ...
        return _UniffiConverterOptionalTypeAssetId.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_txout_asset,self._uniffi_clone_pointer(),)
        )
    ...
    def is_fee(self, ) -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_txout_is_fee,self._uniffi_clone_pointer(),)
        )
    ...
    def is_partially_blinded(self, ) -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_txout_is_partially_blinded,self._uniffi_clone_pointer(),)
        )
    ...
    def script_pubkey(self, ) -> "Script":
        ...
        return _UniffiConverterTypeScript.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_txout_script_pubkey,self._uniffi_clone_pointer(),)
        )
    ...
    def unblind(self, secret_key: "SecretKey") -> "TxOutSecrets":
        ...
        return _UniffiConverterTypeTxOutSecrets.lift(
            _rust_call_with_error(
    _UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_txout_unblind,self._uniffi_clone_pointer(),
    ...
    def value(self, ) -> "typing.Optional[int]":
        ...
        return _UniffiConverterOptionalUInt64.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_txout_value,self._uniffi_clone_pointer(),)
        )
...
class Update:
    ...
    def only_tip(self, ) -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_update_only_tip,self._uniffi_clone_pointer(),)
        )
...
class WolletDescriptor:
    ...
    def derive_blinding_key(self, script_pubkey: "Script") -> "typing.Optional[SecretKey]":
        ...
        return _UniffiConverterOptionalTypeSecretKey.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_wolletdescriptor_derive_blinding_key,self._uniffi_clone_pointer(),
    ...
    def is_mainnet(self, ) -> "bool":
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_lwk_fn_method_wolletdescriptor_is_mainnet,self._uniffi_clone_pointer(),)
        )
    ...
    def script_pubkey(self, ext_int: "Chain",index: "int") -> "Script":
        ...
        return _UniffiConverterTypeScript.lift(
            _rust_call_with_error(
    _UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_wolletdescriptor_script_pubkey,self._uniffi_clone_pointer(),
