...
MENUS = {
    ...
    "render_rop_list": advanced_render_rops.populate_render_rop_menu,
}
...
# See on_loaded.
NEEDS_PAYLOAD_CALLBACK = ["output_folder", "render_script", "task_template", "frame_range", "title", "rop_checkbox_",
...
def on_created(node, **kwargs):
    ...
    advanced_render_rops.reset_render_rop_options(node)
...
PARM_HANDLERS = {
    ...
    "output_folder": advanced_render_rops.update_render_rop_options,
    "render_script": advanced_render_rops.update_render_rop_options,
    "task_template": advanced_render_rops.update_render_rop_options,
    "render_rop_list": advanced_render_rops.get_render_rop_options,
}
...
def on_change(node, **kwargs):
    ...
    # print("parm_name: {}".format(parm_name))
    # print("value: ", node.parm(parm_name).eval())
    with errors.show():
