...
class SnapshotController:
    ...
    def _get_raw_snapshot(self) -> None:
        ...
        # Unzip the file
        unzip_cmd = f"gunzip {local_file}"
        subprocess.check_output(unzip_cmd, text=True, shell=True)

        # Remove the .gz extension from the file
        local_file_unzipped = local_file.replace(".gz", "")
