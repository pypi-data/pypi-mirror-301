...
class Hub(Component, ABC):
    ...
    MountingPoints: Optional[MountingPoints] = Field(alias="MountingPoints", default=None)
    ...
    ConnectableNodes: Optional[HubConnectableNodes] = Field(alias="ConnectableNodes", default=HubConnectableNodes()) # Not supported yet
    OutputGroups: Optional[HubOutputGroupLibrary] = Field(alias="OutputGroups", default=HubOutputGroupLibrary()) # Not supported yet
