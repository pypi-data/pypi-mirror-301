...
class BladeOutputGroup(BladedModel):
    ...
    OutputLocations : List[BladeOutputsForLocation], default=list(), Not supported yet
    ...
    XML: Optional[XMLBladeOutputs] = Field(alias="XML", default=None) # Not supported yet
    LoadOutputs: Optional[BladeLoadOutputs] = Field(alias="LoadOutputs", default=None) # Not supported yet
    MotionOutputs: Optional[BladeMotionOutputs] = Field(alias="MotionOutputs", default=None) # Not supported yet
    AerodynamicOutputs: Optional[BladeAerodynamicOutputs] = Field(alias="AerodynamicOutputs", default=None) # Not supported yet
    HydrodynamicOutputs: Optional[BladeHydrodynamicOutputs] = Field(alias="HydrodynamicOutputs", default=None) # Not supported yet
    OutputLocations: Optional[List[BladeOutputsForLocation]] = Field(alias="OutputLocations", default=list()) # Not supported yet
