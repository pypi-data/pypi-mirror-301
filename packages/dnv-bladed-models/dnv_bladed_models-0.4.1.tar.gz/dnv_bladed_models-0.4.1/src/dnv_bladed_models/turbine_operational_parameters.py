...
class TurbineOperationalParameters(BladedModel):
    ...
    Attributes:
    ----------
    NominalHubWindSpeedVsRotorSpeedAndPitchAngle : List[NominalHubWindSpeedVsRotorSpeedAndPitchAngle], default=list()
    ...
    NominalHubWindSpeedVsRotorSpeedAndPitchAngle: Optional[List[NominalHubWindSpeedVsRotorSpeedAndPitchAngle]] = Field(alias="NominalHubWindSpeedVsRotorSpeedAndPitchAngle", default=list())
    VariableSpeedPitchRegulatedControlModel: Optional[VariableSpeedPitchRegulatedControlModel] = Field(alias="VariableSpeedPitchRegulatedControlModel", default=None)
