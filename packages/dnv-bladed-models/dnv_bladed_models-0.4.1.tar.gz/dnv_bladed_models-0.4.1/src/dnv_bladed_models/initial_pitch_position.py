...
class InitialPitchPosition(InitialPosition, InitialConditionType='InitialPitchPosition'):
    r"""
    ...
    Attributes:
    ----------
    InitialConditionType : str, default='InitialPitchPosition', Not supported yet
    ...
    InitialConditionType: Optional[str] = Field(alias="InitialConditionType", default='InitialPitchPosition') # Not supported yet
