...
class YawFaultConstantRate(YawFault, EventType='YawFaultConstantRate'):
    ...
    Attributes:
    ----------
    EventType : str, default='YawFaultConstantRate', Not supported yet
    ...
    EventType: Optional[str] = Field(alias="EventType", default='YawFaultConstantRate') # Not supported yet
    FaultYawRate: Optional[float] = Field(alias="FaultYawRate", default=None) # Not supported yet
    YawEndStop: Optional[float] = Field(alias="YawEndStop", default=None) # Not supported yet
