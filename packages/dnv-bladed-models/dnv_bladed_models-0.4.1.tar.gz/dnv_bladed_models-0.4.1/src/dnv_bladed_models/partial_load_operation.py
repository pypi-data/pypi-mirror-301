...
class PartialLoadOperation(BladedModel):
    ...
    GeneratorSpeedVsGeneratorTorque : List[GeneratorSpeedVsGeneratorTorque], default=list()
    ...
    OptimalModeGain: Optional[float] = Field(alias="OptimalModeGain", default=None)
    MinimumGeneratorSpeed: Optional[float] = Field(alias="MinimumGeneratorSpeed", default=None)
    GeneratorSpeedVsGeneratorTorque: Optional[List[GeneratorSpeedVsGeneratorTorque]] = Field(alias="GeneratorSpeedVsGeneratorTorque", default=list())
