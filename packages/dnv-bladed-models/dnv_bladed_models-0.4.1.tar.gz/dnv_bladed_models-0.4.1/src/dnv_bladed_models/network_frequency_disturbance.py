...
class NetworkFrequencyDisturbance(Fault, EventType='NetworkFrequencyDisturbance'):
    ...
    Attributes:
    ----------
    EventType : str, default='NetworkFrequencyDisturbance', Not supported yet
    ...
    TimeVsFrequencyChange : List[TimeVsFrequencyChange], default=list(), Not supported yet
    ...
    EventType: Optional[str] = Field(alias="EventType", default='NetworkFrequencyDisturbance') # Not supported yet
    Filepath: Optional[str] = Field(alias="Filepath", default=None) # Not supported yet
    TimeVsFrequencyChange: Optional[List[TimeVsFrequencyChange]] = Field(alias="TimeVsFrequencyChange", default=list()) # Not supported yet
