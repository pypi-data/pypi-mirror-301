...
class BladeStabilityAnalysis(BladeStabilityAnalysisCalculation, SteadyCalculationType='BladeStabilityAnalysis'):
    ...
    Attributes:
    ----------
    SteadyCalculationType : str, default='BladeStabilityAnalysis', Not supported yet
    ...
    ModeOfOperation : BladeStabilityAnalysisModeOfOperation, abstract, Not supported yet
    ...
    SteadyCalculationType: Optional[str] = Field(alias="SteadyCalculationType", default='BladeStabilityAnalysis') # Not supported yet
    ModeOfOperation: Optional[BladeStabilityAnalysisModeOfOperation] = Field(alias="ModeOfOperation", default=None) # Not supported yet
