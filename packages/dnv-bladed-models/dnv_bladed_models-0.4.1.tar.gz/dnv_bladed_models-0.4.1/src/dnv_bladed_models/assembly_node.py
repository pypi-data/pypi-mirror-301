...
class AssemblyNode(BladedModel):
    ...
    ComponentReference : str
        A path reference to the Component for this node, in the ComponentDefinitions of the current JSON document.  i.e. `#/ComponentDefinitions/<component-name>`
    ...
    class __CustomEntries__(BaseModel):
        entries: Dict[str, AssemblyNode] = Field(default={})
    ...
    def _factory(cls, data):
        ...
        return custom_entries_parser(cls, data, dict, AssemblyNode.__CustomEntries__)
