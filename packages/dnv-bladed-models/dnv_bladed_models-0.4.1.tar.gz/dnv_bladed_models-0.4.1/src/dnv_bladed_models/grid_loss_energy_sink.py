...
class GridLossEnergySink(BladedModel):
    ...
    MaximumGeneratorTorque: Optional[float] = Field(alias="MaximumGeneratorTorque", default=0) # Not supported yet
    EnergyCapacityOfSink: Optional[float] = Field(alias="EnergyCapacityOfSink", default=0) # Not supported yet
