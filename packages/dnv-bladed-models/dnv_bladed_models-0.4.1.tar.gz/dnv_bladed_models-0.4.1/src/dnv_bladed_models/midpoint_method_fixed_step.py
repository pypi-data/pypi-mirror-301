...
class MidpointMethodFixedStep(FixedStepIntegrator, IntegratorType='MidpointMethodFixedStep'):
    ...
    Attributes:
    ----------
    IntegratorType : str, default='MidpointMethodFixedStep', Not supported yet
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/SolverSettings/Integrator/MidpointMethodFixedStep.json')
    
    IntegratorType: Optional[str] = Field(alias="IntegratorType", default='MidpointMethodFixedStep') # Not supported yet
