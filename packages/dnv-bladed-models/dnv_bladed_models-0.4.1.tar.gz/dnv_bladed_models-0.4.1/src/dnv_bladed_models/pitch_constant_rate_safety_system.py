...
class PitchConstantRateSafetySystem(PitchControllerRateSafetySystem, PitchSafetySystemType='ConstantRate'):
    ...
    Attributes:
    ----------
    PitchSafetySystemType : str, default='ConstantRate'
    ...
    PitchSafetySystemType: Optional[str] = Field(alias="PitchSafetySystemType", default='ConstantRate')
    Rate: Optional[float] = Field(alias="Rate", default=0)
