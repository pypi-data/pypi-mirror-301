...
class WindMeanSpeedTimeHistory(WindMeanSpeedVariation, MeanSpeedVariationType='TimeHistory'):
    ...
    Attributes:
    ----------
    MeanSpeedVariationType : str, default='TimeHistory', Not supported yet
    ...
    TimeVsMeanSpeed : List[TimeVsWindMeanSpeed], default=list(), Not supported yet
    ...
    MeanSpeedVariationType: Optional[str] = Field(alias="MeanSpeedVariationType", default='TimeHistory') # Not supported yet
    TimeVsMeanSpeed: Optional[List[TimeVsWindMeanSpeed]] = Field(alias="TimeVsMeanSpeed", default=list()) # Not supported yet
