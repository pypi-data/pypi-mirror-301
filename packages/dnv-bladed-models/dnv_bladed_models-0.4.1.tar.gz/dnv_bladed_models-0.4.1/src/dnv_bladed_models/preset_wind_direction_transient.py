...
class PresetWindDirectionTransient(WindDirectionVariation, DirectionVariationType='PresetTransient'):
    ...
    Attributes:
    ----------
    DirectionVariationType : str, default='PresetTransient', Not supported yet
    ...
    VariationShape : PresetWindDirectionTransient_VariationShapeEnum, Not supported yet
    ...
    DirectionVariationType: Optional[str] = Field(alias="DirectionVariationType", default='PresetTransient') # Not supported yet
    DirectionAtStart: Optional[float] = Field(alias="DirectionAtStart", default=None) # Not supported yet
    ...
    VariationShape: Optional[PresetWindDirectionTransient_VariationShapeEnum] = Field(alias="VariationShape", default=None) # Not supported yet
