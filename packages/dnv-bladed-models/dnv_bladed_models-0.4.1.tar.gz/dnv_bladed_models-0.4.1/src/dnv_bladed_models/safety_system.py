...
from dnv_bladed_models.safety_system_circuits import SafetySystemCircuits
...
class SafetySystem(BladedModel):
    ...
    Attributes:
    ----------
    Circuits : SafetySystemCircuits, Not supported yet
    ...
    Circuits: Optional[SafetySystemCircuits] = Field(alias="Circuits", default=SafetySystemCircuits()) # Not supported yet
    GeneratorOverspeed: Optional[GeneratorOverspeed] = Field(alias="GeneratorOverspeed", default=None) # Not supported yet
    RotorOverspeed: Optional[RotorOverspeed] = Field(alias="RotorOverspeed", default=None) # Not supported yet
    GeneratorOverpower: Optional[GeneratorOverpower] = Field(alias="GeneratorOverpower", default=None) # Not supported yet
    NacelleVibration: Optional[NacelleVibration] = Field(alias="NacelleVibration", default=None) # Not supported yet
    GeneratorShortCircuit: Optional[GeneratorShortCircuit] = Field(alias="GeneratorShortCircuit", default=None) # Not supported yet
    EmergencyStopButton: Optional[EmergencyStopButton] = Field(alias="EmergencyStopButton", default=None) # Not supported yet
    OnlyActivateOnceLoggingHasCommenced: Optional[bool] = Field(alias="OnlyActivateOnceLoggingHasCommenced", default=None) # Not supported yet
