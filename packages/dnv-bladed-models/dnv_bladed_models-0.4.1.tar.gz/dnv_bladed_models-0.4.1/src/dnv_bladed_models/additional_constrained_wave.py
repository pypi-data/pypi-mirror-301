...
class AdditionalConstrainedWave(BladedModel):
    ...
    Method: Optional[AdditionalConstrainedWave_MethodEnum] = Field(alias="Method", default=None) # Not supported yet
    ...
    BlendNonLinearConstrained: Optional[bool] = Field(alias="BlendNonLinearConstrained", default=True) # Not supported yet
    TimeOfWaveCrest: Optional[float] = Field(alias="TimeOfWaveCrest", default=None) # Not supported yet
    NumberOfConstraints: Optional[int] = Field(alias="NumberOfConstraints", default=None) # Not supported yet
