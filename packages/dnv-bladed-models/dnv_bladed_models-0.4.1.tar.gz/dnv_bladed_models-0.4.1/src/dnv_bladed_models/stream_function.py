...
class StreamFunction(RegularWaves, WavesType='StreamFunction'):
    ...
    Attributes:
    ----------
    WavesType : str, default='StreamFunction', Not supported yet
    ...
    WavesType: Optional[str] = Field(alias="WavesType", default='StreamFunction') # Not supported yet
    UseTotalAcceleration: Optional[bool] = Field(alias="UseTotalAcceleration", default=None) # Not supported yet
