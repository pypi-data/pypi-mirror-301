...
class ExternalModuleComponent(Component, ComponentType='ExternalModuleComponent'):
    ...
    Attributes:
    ----------
    ComponentType : str, default='ExternalModuleComponent', Not supported yet
    ...
    ComponentType: Optional[str] = Field(alias="ComponentType", default='ExternalModuleComponent') # Not supported yet
    ...
    ConnectableNodes: Optional[ExternalModuleComponentConnectableNodes] = Field(alias="ConnectableNodes", default=ExternalModuleComponentConnectableNodes()) # Not supported yet
