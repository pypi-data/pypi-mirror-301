...
class Earthquake(BladedModel):
    ...
    QuakeFilepath: Optional[str] = Field(alias="QuakeFilepath", default=None) # Not supported yet
    StartTime: Optional[float] = Field(alias="StartTime", default=None) # Not supported yet
    DirectionClockwiseFromNorth: Optional[float] = Field(alias="DirectionClockwiseFromNorth", default=None) # Not supported yet
