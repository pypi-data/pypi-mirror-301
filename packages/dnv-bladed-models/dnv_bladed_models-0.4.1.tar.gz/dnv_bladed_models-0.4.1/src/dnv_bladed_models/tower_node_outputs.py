...
class TowerNodeOutputs(BladedModel):
    ...
    Displacements: Optional[bool] = Field(alias="Displacements", default=False) # Not supported yet
    Loads: Optional[bool] = Field(alias="Loads", default=False) # Not supported yet
    WaterKinematics: Optional[bool] = Field(alias="WaterKinematics", default=False) # Not supported yet
