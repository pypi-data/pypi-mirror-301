...
class PitchFaultConstantRate(PitchFault, EventType='PitchFaultConstantRate'):
    ...
    Attributes:
    ----------
    EventType : str, default='PitchFaultConstantRate', Not supported yet
    ...
    EventType: Optional[str] = Field(alias="EventType", default='PitchFaultConstantRate') # Not supported yet
    FaultPitchRate: Optional[float] = Field(alias="FaultPitchRate", default=None) # Not supported yet
