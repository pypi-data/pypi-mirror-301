...
class YawActuation(BladedModel):
    ...
    LoadBanks : List[LoadBank], default=list()
    ...
    ExternalLoadsFilepath: Optional[str] = Field(alias="ExternalLoadsFilepath", default=None)
    EffectiveGearRatio: Optional[float] = Field(alias="EffectiveGearRatio", default=None)
    LoadBanks: Optional[List[LoadBank]] = Field(alias="LoadBanks", default=list())
