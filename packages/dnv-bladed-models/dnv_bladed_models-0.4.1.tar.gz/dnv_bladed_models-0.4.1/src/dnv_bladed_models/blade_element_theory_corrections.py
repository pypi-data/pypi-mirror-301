...
class BladeElementTheoryCorrections(BladedModel):
    ...
    UsePrandtlCorrectionForTipLoss: Optional[bool] = Field(alias="UsePrandtlCorrectionForTipLoss", default=True)
    UsePrandtlCorrectionForRootLoss: Optional[bool] = Field(alias="UsePrandtlCorrectionForRootLoss", default=False)
