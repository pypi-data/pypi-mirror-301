...
class CurrentMeanSpeedVariation(BladedModel, ABC):
    ...
    MeanSpeedVariationType: Optional[CurrentMeanSpeedVariation_MeanSpeedVariationTypeEnum] = Field(alias="MeanSpeedVariationType", default=None) # Not supported yet
