...
class Aerofoil(BladedModel):
    ...
    ChordwiseOriginForForcesAndMoments: Optional[float] = Field(alias="ChordwiseOriginForForcesAndMoments", default=0.25)
    AerodynamicPerformance: Optional[List[AlphaLine]] = Field(alias="AerodynamicPerformance", default=list())
    ReynoldsNumber: Optional[float] = Field(alias="ReynoldsNumber", default=None)
