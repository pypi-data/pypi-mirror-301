...
class Settings(BladedModel):
    ...
    Attributes:
    ----------
    Solver : SolverSettings, Not supported yet
    ...
    Solver: Optional[SolverSettings] = Field(alias="Solver", default=None) # Not supported yet
    Aerodynamics: Optional[AerodynamicSettings] = Field(alias="Aerodynamics", default=None)
    Hydrodynamics: Optional[HydrodynamicCalculation] = Field(alias="Hydrodynamics", default=None) # Not supported yet
