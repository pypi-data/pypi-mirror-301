...
class TowerCanSectionProperties(BladedModel, ABC):
    r"""
    ...
    OutsideDiameter : float
        The external diameter of the can at this location.

    Notes:
    -----
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/common/TowerCanSectionProperties.json')
