...
class LookUpTableElement(BladedModel):
    ...
    DistanceFromFocalPoint: Optional[float] = Field(alias="DistanceFromFocalPoint", default=None) # Not supported yet
    ProportionOfSignal: Optional[float] = Field(alias="ProportionOfSignal", default=None) # Not supported yet
