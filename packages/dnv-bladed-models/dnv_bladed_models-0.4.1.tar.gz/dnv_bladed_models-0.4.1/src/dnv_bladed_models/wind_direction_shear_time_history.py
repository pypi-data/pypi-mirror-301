...
class WindDirectionShearTimeHistory(WindDirectionShearVariation, DirectionShearVariationType='TimeHistory'):
    ...
    TimeVsDirectionShear : List[TimeVsWindDirectionShear], default=list(), Not supported yet
    ...
    TimeVsDirectionShear: Optional[List[TimeVsWindDirectionShear]] = Field(alias="TimeVsDirectionShear", default=list()) # Not supported yet
