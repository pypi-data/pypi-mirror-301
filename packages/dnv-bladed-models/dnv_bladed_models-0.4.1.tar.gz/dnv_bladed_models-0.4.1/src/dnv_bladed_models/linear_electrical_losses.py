...
class LinearElectricalLosses(ElectricalLosses, ElectricalLossesType='LinearElectricalLosses'):
    ...
    Attributes:
    ----------
    ElectricalLossesType : str, default='LinearElectricalLosses'
    ...
    ElectricalLossesType: Optional[str] = Field(alias="ElectricalLossesType", default='LinearElectricalLosses')
