...
class InitialRotorSpeed(InitialCondition, InitialConditionType='InitialRotorSpeed'):
    r"""
    ...
    Attributes:
    ----------
    InitialConditionType : str, default='InitialRotorSpeed', Not supported yet
    ...
    InitialConditionType: Optional[str] = Field(alias="InitialConditionType", default='InitialRotorSpeed') # Not supported yet
