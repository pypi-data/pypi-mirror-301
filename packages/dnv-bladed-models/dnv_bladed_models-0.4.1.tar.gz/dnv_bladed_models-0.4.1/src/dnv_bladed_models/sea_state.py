...
class SeaState(BladedModel):
    ...
    Attributes:
    ----------
    Current : Current, abstract, Not supported yet

    Waves : Waves, abstract, Not supported yet
    ...
    Current: Optional[Current] = Field(alias="Current", default=None) # Not supported yet
    Waves: Optional[Waves] = Field(alias="Waves", default=None) # Not supported yet
    Tide: Optional[Tide] = Field(alias="Tide", default=None) # Not supported yet
