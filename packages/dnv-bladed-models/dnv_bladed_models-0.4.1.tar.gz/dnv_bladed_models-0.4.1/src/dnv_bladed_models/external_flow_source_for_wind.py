...
class ExternalFlowSourceForWind(Wind, WindType='ExternalFlowSourceForWind'):
    ...
    Attributes:
    ----------
    WindType : str, default='ExternalFlowSourceForWind', Not supported yet
    ...
    LibraryFilepath : str, Not supported yet
    ...
    WindType: Optional[str] = Field(alias="WindType", default='ExternalFlowSourceForWind') # Not supported yet
    LibraryFilepath: Optional[str] = Field(alias="LibraryFilepath", default=None) # Not supported yet
