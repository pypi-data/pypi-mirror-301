...
class BladedAnalysis(BladedModel):
    ...
    Attributes:
    ----------
    TimeDomainSimulation : TimeDomainSimulation, Not supported yet
    ...
    TimeDomainSimulation: Optional[TimeDomainSimulation] = Field(alias="TimeDomainSimulation", default=None) # Not supported yet
    ...
    ComponentDefinitions: Optional[ComponentLibrary] = Field(alias="ComponentDefinitions", default=ComponentLibrary())
