...
class LinearPassiveDamper(Damper, ComponentType='LinearPassiveDamper'):
    ...
    Attributes:
    ----------
    ComponentType : str, default='LinearPassiveDamper', Not supported yet
    ...
    ComponentType: Optional[str] = Field(alias="ComponentType", default='LinearPassiveDamper') # Not supported yet
    Mass: Optional[float] = Field(alias="Mass", default=None) # Not supported yet
    Frequency: Optional[float] = Field(alias="Frequency", default=None) # Not supported yet
    Damping: Optional[float] = Field(alias="Damping", default=None) # Not supported yet
    IgnoreInModalAnalysis: Optional[bool] = Field(alias="IgnoreInModalAnalysis", default=None) # Not supported yet
