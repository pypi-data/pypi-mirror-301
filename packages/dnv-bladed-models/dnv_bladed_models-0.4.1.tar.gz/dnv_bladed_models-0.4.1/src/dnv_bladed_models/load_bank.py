...
class LoadBank(BladedModel):
    ...
    HighSpeedShaftStiffness: Optional[float] = Field(alias="HighSpeedShaftStiffness", default=None)
    HighSpeedShaftDamping: Optional[float] = Field(alias="HighSpeedShaftDamping", default=None)
    MomentOfInertiaOfMotor: Optional[float] = Field(alias="MomentOfInertiaOfMotor", default=None)
