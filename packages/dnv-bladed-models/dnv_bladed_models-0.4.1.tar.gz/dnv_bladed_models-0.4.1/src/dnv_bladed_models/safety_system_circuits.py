...
class SafetySystemCircuits(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/SafetySystem/SafetySystemCircuits/SafetySystemCircuits.json')
    ...
    class __CustomEntries__(BaseModel):
        entries: Dict[str, SafetySystemCircuit] = Field(default={})
    ...
    def _factory(cls, data):
        if isinstance(data, SafetySystemCircuits):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SafetySystemCircuits models')
        return custom_entries_parser(cls, data, dict, SafetySystemCircuits.__CustomEntries__)

    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, SafetySystemCircuits.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = SafetySystemCircuits.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = SafetySystemCircuits.from_json('{ ... }')
        """
...
SafetySystemCircuits.update_forward_refs()
SafetySystemCircuits.__CustomEntries__.update_forward_refs() 
