...
class YawFaultLimp(YawFault, EventType='YawFaultLimp'):
    ...
    Attributes:
    ----------
    EventType : str, default='YawFaultLimp', Not supported yet
    ...
    EventType: Optional[str] = Field(alias="EventType", default='YawFaultLimp') # Not supported yet
    Friction: Optional[float] = Field(alias="Friction", default=None) # Not supported yet
