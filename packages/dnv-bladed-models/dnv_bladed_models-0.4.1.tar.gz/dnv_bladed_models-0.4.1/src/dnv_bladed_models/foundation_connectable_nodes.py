...
class FoundationConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Foundation/FoundationConnectableNodes/FoundationConnectableNodes.json')
    ...
    class __CustomEntries__(BaseModel):
        entries: Dict[str, ConnectableNode] = Field(default={})
    ...
    def _factory(cls, data):
        if isinstance(data, FoundationConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define FoundationConnectableNodes models')
        return custom_entries_parser(cls, data, dict, FoundationConnectableNodes.__CustomEntries__)

    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, FoundationConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = FoundationConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = FoundationConnectableNodes.from_json('{ ... }')
        """
...
FoundationConnectableNodes.update_forward_refs()
FoundationConnectableNodes.__CustomEntries__.update_forward_refs() 
