...
class AngleVsStiffnessTorque(BladedModel):
    ...
    Angle: Optional[float] = Field(alias="Angle", default=None) # Not supported yet
    StiffnessTorque: Optional[float] = Field(alias="StiffnessTorque", default=None) # Not supported yet
