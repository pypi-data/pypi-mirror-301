...
class TowerShadowPowles(BladedModel):
    ...
    ShadowWidthProportion: Optional[float] = Field(alias="ShadowWidthProportion", default=0)
    MaximumDeficit: Optional[float] = Field(alias="MaximumDeficit", default=0)
    LengthReference: Optional[float] = Field(alias="LengthReference", default=0)
