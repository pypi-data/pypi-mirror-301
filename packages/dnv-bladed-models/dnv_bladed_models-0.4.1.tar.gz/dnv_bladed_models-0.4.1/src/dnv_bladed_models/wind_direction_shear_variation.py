...
class WindDirectionShearVariation(BladedModel, ABC):
    ...
    Attributes:
    ----------
    DirectionShearVariationType : WindDirectionShearVariation_DirectionShearVariationTypeEnum, Not supported yet
    ...
    DirectionShearVariationType: Optional[WindDirectionShearVariation_DirectionShearVariationTypeEnum] = Field(alias="DirectionShearVariationType", default=None) # Not supported yet
