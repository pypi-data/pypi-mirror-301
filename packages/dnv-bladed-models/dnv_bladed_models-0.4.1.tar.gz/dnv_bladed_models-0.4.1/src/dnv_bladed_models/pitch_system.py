...
class PitchSystem(Component, ComponentType='PitchSystem'):
    ...
    Attributes:
    ----------
    ComponentType : str, default='PitchSystem'
    ...
    ComponentType: Optional[str] = Field(alias="ComponentType", default='PitchSystem')
    ...
    OutputGroups: Optional[PitchSystemOutputGroupLibrary] = Field(alias="OutputGroups", default=PitchSystemOutputGroupLibrary()) # Not supported yet
    ConnectableNodes: Optional[PitchSystemConnectableNodes] = Field(alias="ConnectableNodes", default=PitchSystemConnectableNodes()) # Not supported yet
