...
class WindHorizontalShearTimeHistory(WindHorizontalShearVariation, HorizontalShearVariationType='TimeHistory'):
    ...
    TimeVsHorizontalShear : List[TimeVsWindHorizontalShear], default=list(), Not supported yet
    ...
    TimeVsHorizontalShear: Optional[List[TimeVsWindHorizontalShear]] = Field(alias="TimeVsHorizontalShear", default=list()) # Not supported yet
