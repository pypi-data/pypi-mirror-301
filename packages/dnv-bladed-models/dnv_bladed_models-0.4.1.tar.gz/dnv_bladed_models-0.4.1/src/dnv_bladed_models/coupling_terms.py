...
class CouplingTerms(BladedModel):
    r"""
    Any coupling terms between bending and torsion.
    
    Attributes:
    ----------
    BendingXYCoupling : float, default=0
    ...
    TorsionBendingXCoupling : float, default=0
    ...
    TorsionBendingYCoupling : float, default=0
    ...
    -----
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/BladeSectionDefinition/BladeSectionStructuralProperties/CouplingTerms/CouplingTerms.json')
    
    BendingXYCoupling: Optional[float] = Field(alias="BendingXYCoupling", default=0)
    TorsionBendingXCoupling: Optional[float] = Field(alias="TorsionBendingXCoupling", default=0)
    TorsionBendingYCoupling: Optional[float] = Field(alias="TorsionBendingYCoupling", default=0)
