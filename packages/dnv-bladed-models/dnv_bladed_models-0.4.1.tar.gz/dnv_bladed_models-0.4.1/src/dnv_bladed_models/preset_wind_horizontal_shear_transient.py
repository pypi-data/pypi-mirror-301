...
class PresetWindHorizontalShearTransient(WindHorizontalShearVariation, HorizontalShearVariationType='PresetTransient'):
    ...
    Attributes:
    ----------
    HorizontalShearVariationType : str, default='PresetTransient', Not supported yet
    ...
    VariationShape : PresetWindHorizontalShearTransient_VariationShapeEnum, Not supported yet
    ...
    HorizontalShearVariationType: Optional[str] = Field(alias="HorizontalShearVariationType", default='PresetTransient') # Not supported yet
    HorizontalShearAtStart: Optional[float] = Field(alias="HorizontalShearAtStart", default=None) # Not supported yet
    ...
    VariationShape: Optional[PresetWindHorizontalShearTransient_VariationShapeEnum] = Field(alias="VariationShape", default=None) # Not supported yet
