...
class PresetWindMeanSpeedTransient(WindMeanSpeedVariation, MeanSpeedVariationType='PresetTransient'):
    ...
    Attributes:
    ----------
    MeanSpeedVariationType : str, default='PresetTransient', Not supported yet
    ...
    VariationShape : PresetWindMeanSpeedTransient_VariationShapeEnum, Not supported yet
    ...
    MeanSpeedVariationType: Optional[str] = Field(alias="MeanSpeedVariationType", default='PresetTransient') # Not supported yet
    MeanSpeedAtStart: Optional[float] = Field(alias="MeanSpeedAtStart", default=None) # Not supported yet
    ...
    VariationShape: Optional[PresetWindMeanSpeedTransient_VariationShapeEnum] = Field(alias="VariationShape", default=None) # Not supported yet
