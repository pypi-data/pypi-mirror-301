...
class UserDefinedWakeDeficit(SteadyWakeDeficit, SteadyWakeDeficitType='UserDefined'):
    ...
    Attributes:
    ----------
    SteadyWakeDeficitType : str, default='UserDefined', Not supported yet
    ...
    RadiusVsDeficit : List[RadiusVsDeficit], default=list(), Not supported yet
    ...
    SteadyWakeDeficitType: Optional[str] = Field(alias="SteadyWakeDeficitType", default='UserDefined') # Not supported yet
    RadiusVsDeficit: Optional[List[RadiusVsDeficit]] = Field(alias="RadiusVsDeficit", default=list()) # Not supported yet
