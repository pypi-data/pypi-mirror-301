...
class PresetWindDirectionShearTransient(WindDirectionShearVariation, DirectionShearVariationType='PresetTransient'):
    ...
    Attributes:
    ----------
    DirectionShearVariationType : str, default='PresetTransient', Not supported yet
    ...
    VariationShape : PresetWindDirectionShearTransient_VariationShapeEnum, Not supported yet
    ...
    DirectionShearVariationType: Optional[str] = Field(alias="DirectionShearVariationType", default='PresetTransient') # Not supported yet
    DirectionShearAtStart: Optional[float] = Field(alias="DirectionShearAtStart", default=None) # Not supported yet
    ...
    VariationShape: Optional[PresetWindDirectionShearTransient_VariationShapeEnum] = Field(alias="VariationShape", default=None) # Not supported yet
