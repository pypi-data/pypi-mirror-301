...
class CampbellDiagram(BladeStabilityAnalysisCalculation, SteadyCalculationType='CampbellDiagram'):
    ...
    Attributes:
    ----------
    SteadyCalculationType : str, default='CampbellDiagram', Not supported yet
    ...
    ModeOfOperation : CampbellDiagramModeOfOperation, abstract, Not supported yet
    ...
    SteadyCalculationType: Optional[str] = Field(alias="SteadyCalculationType", default='CampbellDiagram') # Not supported yet
    ModeOfOperation: Optional[CampbellDiagramModeOfOperation] = Field(alias="ModeOfOperation", default=None) # Not supported yet
