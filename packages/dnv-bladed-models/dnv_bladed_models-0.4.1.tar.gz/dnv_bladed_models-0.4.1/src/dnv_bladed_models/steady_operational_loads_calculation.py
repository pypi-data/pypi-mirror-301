...
class SteadyOperationalLoadsCalculation(SteadyCalculation, SteadyCalculationType='SteadyOperationalLoads'):
    ...
    Attributes:
    ----------
    SteadyCalculationType : str, default='SteadyOperationalLoads'
    ...
    SteadyCalculationType: Optional[str] = Field(alias="SteadyCalculationType", default='SteadyOperationalLoads')
