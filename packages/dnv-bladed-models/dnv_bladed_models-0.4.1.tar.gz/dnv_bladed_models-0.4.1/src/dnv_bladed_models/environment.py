...
class Environment(BladedModel):
    ...
    Attributes:
    ----------
    Wind : Wind, abstract, Not supported yet
    ...
    Wind: Optional[Wind] = Field(alias="Wind", default=None) # Not supported yet
    SeaState: Optional[SeaState] = Field(alias="SeaState", default=None) # Not supported yet
    Earthquake: Optional[Earthquake] = Field(alias="Earthquake", default=None) # Not supported yet
