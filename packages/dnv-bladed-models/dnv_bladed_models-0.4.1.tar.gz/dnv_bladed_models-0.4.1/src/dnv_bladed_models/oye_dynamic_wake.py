...
class OyeDynamicWake(DynamicWake, DynamicWakeType='OyeDynamicWake'):
    ...
    Attributes:
    ----------
    DynamicWakeType : str, default='OyeDynamicWake'
    ...
    DynamicWakeType: Optional[str] = Field(alias="DynamicWakeType", default='OyeDynamicWake')
    DynamicTangentialInduction: Optional[bool] = Field(alias="DynamicTangentialInduction", default=True)
    OyeTimeLagMultiplier: Optional[float] = Field(alias="OyeTimeLagMultiplier", default=1)
