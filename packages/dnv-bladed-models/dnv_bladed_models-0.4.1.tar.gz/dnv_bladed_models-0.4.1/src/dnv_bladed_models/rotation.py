...
class Rotation(Component, ComponentType='Rotation'):
    r"""
    ...
    Attributes:
    ----------
    ComponentType : str, default='Rotation'
    ...
    ComponentType: Optional[str] = Field(alias="ComponentType", default='Rotation')
    AxisOfRotation: Optional[Vector3D] = Field(alias="AxisOfRotation", default=None)
    AngleOfRotation: Optional[float] = Field(alias="AngleOfRotation", default=None)
