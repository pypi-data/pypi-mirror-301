...
class HardwareTracking(BladedModel):
    ...
    TrackPitchActuator: Optional[bool] = Field(alias="TrackPitchActuator", default=False) # Not supported yet
    TrackGenerator: Optional[bool] = Field(alias="TrackGenerator", default=None) # Not supported yet
