...
class CurrentDirectionTimeHistory(CurrentDirectionVariation, DirectionVariationType='TimeHistory'):
    ...
    TimeVsDirection : List[TimeVsCurrentDirection], default=list(), Not supported yet
    ...
    TimeVsDirection: Optional[List[TimeVsCurrentDirection]] = Field(alias="TimeVsDirection", default=list()) # Not supported yet
