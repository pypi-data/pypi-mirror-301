...
class PitchActuationLimited(PitchControllerTorqueSafetySystem, PitchSafetySystemType='ActuationLimited'):
    ...
    Attributes:
    ----------
    PitchSafetySystemType : str, default='ActuationLimited'
    ...
    PitchSafetySystemType: Optional[str] = Field(alias="PitchSafetySystemType", default='ActuationLimited')
    AppliedForceOrTorque: Optional[float] = Field(alias="AppliedForceOrTorque", default=0)
