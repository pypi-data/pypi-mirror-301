...
class Translation(Component, ComponentType='Translation'):
    r"""
    ...
    Attributes:
    ----------
    ComponentType : str, default='Translation'
    ...
    ComponentType: Optional[str] = Field(alias="ComponentType", default='Translation')
    X: Optional[float] = Field(alias="X", default=0)
    Y: Optional[float] = Field(alias="Y", default=0)
    Z: Optional[float] = Field(alias="Z", default=0)
