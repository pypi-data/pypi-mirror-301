...
class HydrodynamicCalculation(BladedModel):
    ...
    MinimumExcitationForceTimeStep: Optional[float] = Field(alias="MinimumExcitationForceTimeStep", default=0.1) # Not supported yet
    HydrostaticsMorisonMethod: Optional[HydrodynamicCalculation_HydrostaticsMorisonMethodEnum] = Field(alias="HydrostaticsMorisonMethod", default='NOT_USED') # Not supported yet
