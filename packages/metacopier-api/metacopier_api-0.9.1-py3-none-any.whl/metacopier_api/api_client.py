...
from metacopier_api.api_response import ApiResponse, T as ApiResponseT
import metacopier_api.models
from metacopier_api import rest
from metacopier_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(metacopier_api.models, klass)
