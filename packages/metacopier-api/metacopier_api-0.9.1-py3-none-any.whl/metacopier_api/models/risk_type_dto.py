...
class RiskTypeDTO(BaseModel):
    """
    You have to set it during resource creation, after that, it is only read-only. You have only to set the id e.g 4 for actual drawdown. 1: Daily 2: Weekly 3: Monthly 4: Actual. When you set a daily risk limit of 0.5 (50%), it means that if the ratio of the balance at a specific timepoint (see resetTime) to equity reaches 50%, the copy trading will be paused, and if specified, all trades will be closed (see closeAllOpenPositions). Example: {id:1}
    """ # noqa: E501
    id: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RiskTypeDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RiskTypeDTO from a dict"""
        if obj is None:
            return None
