...
class LogDTO(BaseModel):
    ...
    var_date: Optional[datetime] = Field(default=None, description="ISO 8601", alias="date")
    id: Optional[StrictInt] = None
    log_type: Optional[StrictStr] = Field(default=None, alias="logType")
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["accountId", "acknowledged", "customerEmail", "date", "id", "logType", "projectId", "text"]
