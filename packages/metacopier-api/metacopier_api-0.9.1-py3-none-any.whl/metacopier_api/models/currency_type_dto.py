...
class CurrencyTypeDTO(BaseModel):
    """
    You have only to set the id e.g 1 for USD, 2 for EUR, 3 for CHF. Example: {id:1}
    """ # noqa: E501
    id: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrencyTypeDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CurrencyTypeDTO from a dict"""
        if obj is None:
            return None
