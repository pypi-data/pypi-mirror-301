...
class TestStrategyDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StrategyDTO:
        """Test StrategyDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StrategyDTO`
        """
        model = StrategyDTO()
        if include_optional:
            return StrategyDTO(
