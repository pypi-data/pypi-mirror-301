...
class TestCurrencyTypeDTO(unittest.TestCase):
    """CurrencyTypeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyTypeDTO:
        """Test CurrencyTypeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyTypeDTO`
        """
        model = CurrencyTypeDTO()
        if include_optional:
