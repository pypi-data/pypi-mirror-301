...
class TestFeatureCopierFilterDTO(unittest.TestCase):
    """FeatureCopierFilterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureCopierFilterDTO:
        """Test FeatureCopierFilterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureCopierFilterDTO`
        """
        model = FeatureCopierFilterDTO()
        if include_optional:
            return FeatureCopierFilterDTO(
                comment = [
                    ''
                    ],
                magic_number = [
    ...
    def testFeatureCopierFilterDTO(self):
        """Test FeatureCopierFilterDTO"""
