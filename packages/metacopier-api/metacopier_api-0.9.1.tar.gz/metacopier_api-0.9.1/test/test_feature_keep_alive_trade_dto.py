...
class TestFeatureKeepAliveTradeDTO(unittest.TestCase):
    """FeatureKeepAliveTradeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureKeepAliveTradeDTO:
        """Test FeatureKeepAliveTradeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureKeepAliveTradeDTO`
        """
        model = FeatureKeepAliveTradeDTO()
        if include_optional:
            return FeatureKeepAliveTradeDTO(
                cron_expressions = [
                    ''
                    ],
                symbol = ''
    ...
    def testFeatureKeepAliveTradeDTO(self):
        """Test FeatureKeepAliveTradeDTO"""
