...
class TestFeatureTypeDTO(unittest.TestCase):
    """FeatureTypeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureTypeDTO:
        """Test FeatureTypeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureTypeDTO`
        """
        model = FeatureTypeDTO()
        if include_optional:
