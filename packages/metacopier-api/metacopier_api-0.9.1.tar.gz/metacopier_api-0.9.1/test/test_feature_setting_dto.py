...
class TestFeatureSettingDTO(unittest.TestCase):
    """FeatureSettingDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureSettingDTO:
        """Test FeatureSettingDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureSettingDTO`
        """
        model = FeatureSettingDTO()
        if include_optional:
    ...
    def testFeatureSettingDTO(self):
        """Test FeatureSettingDTO"""
