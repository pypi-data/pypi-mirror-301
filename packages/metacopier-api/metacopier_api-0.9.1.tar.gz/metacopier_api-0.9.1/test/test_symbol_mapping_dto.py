...
class TestSymbolMappingDTO(unittest.TestCase):
    """SymbolMappingDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SymbolMappingDTO:
        """Test SymbolMappingDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SymbolMappingDTO`
        """
        model = SymbolMappingDTO()
        if include_optional:
