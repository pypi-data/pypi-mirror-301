...
class TestRiskTypeDTO(unittest.TestCase):
    """RiskTypeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RiskTypeDTO:
        """Test RiskTypeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RiskTypeDTO`
        """
        model = RiskTypeDTO()
        if include_optional:
            return RiskTypeDTO(
