...
class TestAccountStatusDTO(unittest.TestCase):
    """AccountStatusDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountStatusDTO:
        """Test AccountStatusDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountStatusDTO`
        """
        model = AccountStatusDTO()
        if include_optional:
