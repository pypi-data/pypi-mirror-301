...
class TestScaleTypeDTO(unittest.TestCase):
    """ScaleTypeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScaleTypeDTO:
        """Test ScaleTypeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScaleTypeDTO`
        """
        model = ScaleTypeDTO()
        if include_optional:
            return ScaleTypeDTO(
