...
class FeatureTypeDTO(BaseModel):
    """
    You have only to set the id e.g 1 for Telegram. Example: {id:1}
    """ # noqa: E501
    id: StrictInt
    name: Optional[StrictStr] = None
    plan_name: Optional[StrictStr] = Field(default=None, alias="planName")
    __properties: ClassVar[List[str]] = ["id", "name", "planName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeatureTypeDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeatureTypeDTO from a dict"""
        if obj is None:
            return None
