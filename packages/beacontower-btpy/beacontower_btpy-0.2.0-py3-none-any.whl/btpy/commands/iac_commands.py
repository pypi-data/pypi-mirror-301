...
def list():
    ...
    # list all blobs in the container beacontower-iac
    container = client.get_container_client("beacontower-iac")
    blobs = container.list_blobs()
    print("\nList all blobs in beacontower-iac")
    print("---------------------------------")
    for blob in blobs:
        print(blob["name"])
