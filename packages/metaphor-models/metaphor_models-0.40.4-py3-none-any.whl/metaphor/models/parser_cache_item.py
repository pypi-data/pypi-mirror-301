...
class Species18095___ToStringTag8530(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18095: Optional['SharedArrayBuffer'] = None
    to_string_tag_8530: Optional[Species18095___ToStringTag8530] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18095 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18095"))
        to_string_tag_8530 = from_union([Species18095___ToStringTag8530, from_none], obj.get("__@toStringTag@8530"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18095, to_string_tag_8530, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18095 is not None:
            result["__@species@18095"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18095)
        if self.to_string_tag_8530 is not None:
            result["__@toStringTag@8530"] = from_union([lambda x: to_enum(Species18095___ToStringTag8530, x), from_none], self.to_string_tag_8530)
...
class ArrayBufferLike:
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        ...
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18095 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18095"))
        return ArrayBufferLike(to_string_tag_8530, byte_length, species_18095)
...
class SchemaFieldClass:
    ...
    def from_dict(obj: Any) -> 'SchemaFieldClass':
        ...
        subfields = from_union([lambda x: from_list(SchemaField.from_dict, x), from_none], obj.get("subfields"))
        tags = from_union([lambda x: from_list(from_str, x), from_none], obj.get("tags"))
        return SchemaFieldClass(description, field_name, field_path, formula, optional_type, type, is_unique, max_length, native_type, nullable, precision, subfields, tags)
