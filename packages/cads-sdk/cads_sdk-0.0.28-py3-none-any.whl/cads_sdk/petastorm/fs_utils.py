...
class FilesystemResolver(object):
    ...
    def __init__(self, dataset_url, hadoop_configuration=None, connector=HdfsConnector,
        ...
        if not self._parsed_dataset_url.scheme:
            ...
            self._filesystem_factory = fs.LocalFileSystem
...
import petastorm
petastorm.fs_utils.FilesystemResolver = FilesystemResolver
petastorm.etl.dataset_metadata.FilesystemResolver = FilesystemResolver