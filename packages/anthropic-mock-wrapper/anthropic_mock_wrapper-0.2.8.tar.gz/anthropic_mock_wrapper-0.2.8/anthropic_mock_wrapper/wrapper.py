...
from anthropic.types import Message, MessageStreamEvent, Completion, AsyncMessageStream
...
class AnthropicMockWrapper:
    ...
    class Messages:
        ...
        def _create_mock_message_sync(self, model: str, max_tokens: int, messages: List[Dict[str, Any]], **kwargs) -> Message:
        ...
        async def _create_mock_message_async(self, model: str, max_tokens: int, messages: List[Dict[str, Any]], **kwargs) -> Message:
        ...
        def _stream_mock_message_sync(self, model: str, max_tokens: int, messages: List[Dict[str, Any]], **kwargs) -> AsyncMessageStream:
            response_content = self.wrapper._generate_lorem_ipsum(max_tokens)
            ...
            return AsyncMessageStream(generator())

        async def _stream_mock_message_async(self, model: str, max_tokens: int, messages: List[Dict[str, Any]], **kwargs) -> AsyncIterator[MessageStreamEvent]:
            response_content = await self.wrapper._generate_lorem_ipsum_async(max_tokens)
            words = response_content.split()
    ...
    class Beta:
        ...
        class Messages:
            ...
            class Batches:
                ...
                def _create_mock_batch_sync(self, requests: List[Dict[str, Any]], **kwargs) -> Dict[str, Any]:
                    return {
                ...
                async def _create_mock_batch_async(self, requests: List[Dict[str, Any]], **kwargs) -> Dict[str, Any]:
                    return {
