...
.. [#src] The program is published at Codeberg.org_ and Pypi.org_. All figures are from the documentation for |prgnam|, especially the :doc:`/howtoguides` and :doc:`/tutorials`.
