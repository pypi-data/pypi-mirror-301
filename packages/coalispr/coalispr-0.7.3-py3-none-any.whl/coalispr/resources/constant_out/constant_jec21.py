...
# folder as the original. Replace "ExpSessionName" by one word, no spaces or
# special characters (it is part of a file name), keep surrounding quote marks.
#EXP         = "ExpSessionName"
# Exp can be set by "coalispr init" with "jec12" as the given name.
## Note: minimal lengths of mapped reads has been 12.
## Has been linked to as "JEC21" to reflect the strain name.
EXP         = "jec12"
CONFNAM     = "3_jec12.txt"
# Display name for experiment is set to species name (not directly used),
EXPNAM      = "C. deneoformans"
...
# For example with UNSPECLOG10 = 0.6, the required difference is ~4-fold.
UNSPECLOG10 = 1.3
# Series of possibilities for UNSPECLOG10
# values corresponding to ~4, 10, ~20, ~50, 100 fold difference
UNSPECTST   = 0.61, 1.0, 1.3, 1.7, 2.0
#
...
# lengthy segments overlapping a target.
...
BINS        = 5
#
# Reads UNSPECIFIC segments that comply with SPECIFIC small RNA characteristics
# can be retrieved and copied to new bam files for further analysis/mapping.
...
XLIM0       = 14  # minimum mapping length
XLIM1       = 36
XLIM00      = 18
XLIM11      = 26
...
LPPHFAC     = 1/5 #0.2    #1/4 #0.25   #3/8  #0.
...
#
SETBASE     = "/home/working/DATA_ANALYSIS/sRNAseq/"
# SETBASE    = ""

# SRCFLDR is name of the folder containing folders with bedgraphs,
# When replacing the name, keep underscore at end (the "collapsed" or
# "uncollapsed" tag will get attached here)
SRCFLDR     = "StringentMappedReadsAnalysis_12_"
# SRCFLDR    = "_"

# Folder with reference RNA-seq bedgraph-files
REFS        = "REFS"
#REFS        = ""
...
#EXPFILNAM   = ""
EXPFILNAM   = "exp_label_names13-sorted.tsv"
#EXPFILNAM   = "exp_label_names.tab"

# Column headers
# ++++++++++++++
# Headers of expected columns in an experiment file
# FILEKEY is a column of identifiers that link to folders with bedgraph and bam
# files
FILEKEY     = "File"
#
...
# GROUP column
# ************
# These values will normally be the first section of the associated and
...
MUTGROUPS   = {
               "a1":"ago1\u0394", "a2":"ago2\u0394",
               "a1a2":"ago1\u0394 ago2\u0394", "d1":"dcr1\u0394",
               "d2":"dcr2\u0394", "d1d2":"dcr1\u0394 dcr2\u0394",
               "r1":"rdp1\u0394", "h1":"hen1\u0394",
               "be":"\u03B2-elim.", "dh":"dhx\u0394", "p5":"prmt5\u0394",
                OTHR:"methyl\u0394", "rgg":"kGG, H99-RGG",
               "-rgg":"rgg\u0394, aGG","rWT":"repair WT",
               "ye":"ago1-Y593E", "2in1":"2 in 1",
              }


# Other possible groups for the side panel legend, defines labels and order of
# presentation/appearance.
# Use (remove # sign) "" lines if no different conditions or different methods
# have been tested
#CONDITIONS  =  ""
# place # in front of each line if conditions or methods are not different.
CONDITIONS  = {
...
METHODS     = {
                ...
                NOTAGIP:"No-tag IP", # keep to include some CAT_D
              }
FRACTIONS   = {
                WCE:"Cell extract",
              }
...
MUTANTS     = [
               "a2", "d1", "d2", "h1", "be", "dh", OTHR, "p5", "rWT", "rgg",
               "-rgg", "2in1",
              ]
...
# ASM9104v1-chrom-lengths.txt is based on version 1.43 (March 2019)
LENGTHSNAM = "Cryptococcus_neoformans.ASM9104v1-chrom-lengths.txt"
# When extra, mutational sequences are described in fasta and gtf
DNAXTRNAM  = "MitochCneoDTagsRecombinationalDNAs.fa"
LENXTRFILNAM = "MitochCneoDTagsRecombinationalDNAs-lengths.txt"
LENXTRA     = "" # 43824   # same value as in LENXTRFILNAM;
#CHRXTRA     = ""
CHRXTRA     = XTRA #"extra" # name used for "chromosome" of extra DNA;
# Annotation files to be used for gtf-tracks in bedgraph display
# use "" if not applicable
GTFSPECNAM  = "aJec21siRNAsegments.gtf"
GTFUNSPNAM  = "Cryptococcus_neoformans.ASM9104v1.ncrna__db.gtf"
GTFREFNAM   = "CrypJEC21-RNAi-spliced-genes_LTRs_pseudo.gtf"
...
GTFFEAT     = "srnasegment" # feature of choice to display
...
# Set by "coalispr init" to /home/working/PROGRAMMING/PYTHON/COALISPR/coalispr
SAVEIN      = Path("/home/working/PROGRAMMING/PYTHON/COALISPR/coalispr")
...
#LENGTHSFILE = ""
LENGTHSFILE = BASEDIR / SOURCE / SOURCE / LENGTHSNAM
#DNAXTRA     = ""
DNAXTRA     = BASEDIR / SOURCE / FASTA / DNAXTRNAM
#LENXTRAFILE = ""
LENXTRAFILE = BASEDIR / SOURCE / SOURCE / LENXTRFILNAM

# In/next to configuration folder (default)
#EXPFILE     = p / EXPFILNAM
...
#GTFSPEC     = ""
GTFSPEC     = BASEDIR / SOURCE / GTFS / GTFSPECNAM
#GTFUNSP     = ""
GTFUNSP     = BASEDIR / SOURCE / GTFS / GTFUNSPNAM
#GTFREF      = ""
GTFREF      = BASEDIR / SOURCE / GTFS / GTFREFNAM
# For extension of reference GTF
#GTFXTRA     = ""
GTFXTRA     = BASEDIR / SOURCE / GTFS / GTFXTRANAM
# For extension of GTFUNSPNAM GTF with common non-coding RNAs
#GTFUNXTR    = CONFIG / GTFS / GTFUNXTNAM
