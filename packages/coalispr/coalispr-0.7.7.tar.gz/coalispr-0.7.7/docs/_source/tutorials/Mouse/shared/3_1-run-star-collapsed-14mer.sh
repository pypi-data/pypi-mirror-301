...
# To turn off splicing, use --alignIntronMax 1 in addition to not using GTF at the
...
for i in $DATA
  do
    ...
    # Check for presence old alignment folders; these need to be renamed.
...
# Sequences from SRR6442834, 35, 37, 38, 40, 41, 43, 44
# Ignore splicing; increase seed length to speed up mapping --seedSplitMin 9
for i in $DATA
  do
