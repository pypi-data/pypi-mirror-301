...
# The "doc.txt" with notes on file naming and experiment descriptors in
# "constant.py" has been moved to `docs/html/howtoguides.html#Configuration`

# The functions timer() and this_func() have been moved to
# coalispr.resources.utilities.py
# begin "constant_in/2_shared.txt"
# keep " " around text
...
#experiment related for control samples
NEGCTL      = "Negative" #"no RNAi" #"Uninduced"
POSCTL      = "Positive" #"wt RNAi" #"Induced"
# (like) Negative control
...
LENGAP         = [INTR, INTR+COLLR]
# list of length-counters
...
SUBFIGS     = [ CHROMFIG, LENCNTS, LIBCNTS, REGCNTS, UNSELFIG ]
...
#EXP         = "ExpSessionName"
# Exp can be set by "coalispr init" with "12JEC" as the given name.
EXP         = "h99t"
CONFNAM     = "3_h99t.txt"
# Display name for experiment is set to species name (not directly used),
EXPNAM      = "C. neoformans"
# in program EXPNAM is displayed in italics by means of "$\it" and "$" via:
...
# Necessary setting to reduce size of dataframes; if too large, with many
# samples, program can exit with:
# `ICE default IO error handler doing an exit(), .. errno = 32`
MINGAP      = 30 #MININTRON
MAXGAP      = 400
# Set interval for placing tick-labels on x-axis
INTSTEP     = 10
# Set region to skip
#SKIPINT     = ""
SKIPINT     = 190, 370
...
#
SETBASE     = "/home/working/DATA_ANALYSIS_2/zenodo/Burke-2019/"
# SETBASE    = ""
...
# comparable short names of a sample, say a2 for a2_2, a2_1, a2_3ms0 samples.
...
# CONDITION column
# ****************
# These values reflect different grow or genetic conditions that could affect
# phenotype, i.e. the kind of RNA produced that would be sequenced.
# For example a genetic modification with huge impact:
# Mutant made in RNAi-null parental strain.
REPAIR      = "rep"
...
# annotates "chromosome" CHRXTRA;
# For extension of reference GTF
GTFXTRANAM  = "h99-xtra.gtf"
...
#LENGTHSFILE = ""
LENGTHSFILE = p / SOURCE / LENGTHSNAM
#DNAXTRA     = ""
DNAXTRA     = p / FASTA / DNAXTRNAM
LENXTRAFILE = ""
LENXTRAFILE = p / SOURCE / LENXTRFILNAM
