...
class Output:
    ...
    @staticmethod
    def GPT(user_prompt, system_prompt: Optional[str] = None, model: str = "gpt-4o-mini-2024-07-18", temperature: float = 0.15, max_tokens: int = 1024, response_format: Optional[BaseModel] = None, output_option: str = 'cont_prt_det'):
        """
